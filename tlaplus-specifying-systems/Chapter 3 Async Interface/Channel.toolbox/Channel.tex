...
\@x{ {\VARIABLE} chan}%
\@pvspace{8.0pt}%
 \@x{ TypeInvariant\@s{4.1} \.{\defeq}\@s{4.1} chan \.{\in} [ val \.{:} Data
 ,\,\@s{4.1} rdy \.{:} \{ 0 ,\, 1 \} ,\,\@s{4.1} ack \.{:} \{ 0 ,\, 1 \} ]}%
\@x{}\midbar\@xx{}%
\@x{ Init\@s{4.1} \.{\defeq}\@s{4.1} \.{\land} TypeInvariant}%
\@x{\@s{43.90} \.{\land} chan . ack \.{=} chan . rdy}%
\@pvspace{8.0pt}%
\@x{ Send ( d ) \.{\defeq}\@s{4.1} \.{\land} chan . rdy \.{=} chan . ack}%
 \@x{\@s{58.89} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . val
 \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
 \@x{ Rcv\@s{18.85} \.{\defeq}\@s{4.1} \.{\land} chan . rdy \.{\neq} chan .
 ack}%
 \@x{\@s{58.89} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@pvspace{8.0pt}%
 \@x{ Next\@s{4.1} \.{\defeq}\@s{4.1} ( \E\, d \.{\in} Data \.{:} Send ( d ) )
 \.{\lor} Rcv}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{5.56} \.{\defeq}\@s{4.10} Init \.{\land} {\Box} [ Next ]_{ chan}
 \.{\land} {\WF}_{ chan} ( Rcv )}%
\@y{\@s{0}%
 Adding liveness property
}%
\@xx{}%
\@x{}\midbar\@xx{}%
