...
\@x{}\moduleLeftDash\@xx{ {\MODULE} InternalMemory}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} MemoryInterface}%
\@x{ {\VARIABLES} mem ,\, ctl ,\, buf}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} memInt ,\, mem ,\, ctl ,\, buf {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ IInit \.{\defeq} \.{\land} mem \.{\in} [ Adr \.{\rightarrow} Val ]}%
 \@x{\@s{39.55} \.{\land} ctl\@s{10.21} \.{=} [ p \.{\in} Proc
 \.{\mapsto}\@w{rdy} ]}%
 \@x{\@s{39.55} \.{\land} buf\@s{6.56} \.{=} [ p \.{\in} Proc \.{\mapsto}
 NoVal ]}%
\@x{\@s{39.55} \.{\land} memInt \.{\in} InitMemInt}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq}}%
\@x{\@s{8.2} \.{\land} mem \.{\in} [ Adr \.{\rightarrow} Val ]}%
 \@x{\@s{8.2} \.{\land} ctl\@s{10.21} \.{\in} [ Proc \.{\rightarrow}
 \{\@w{rdy} ,\,\@w{busy} ,\,\@w{done} \} ]}%
 \@x{\@s{8.2} \.{\land} buf\@s{6.56} \.{\in} [ Proc \.{\rightarrow} MReq
 \.{\cup} Val \.{\cup} \{ NoVal \} ]}%
\@pvspace{8.0pt}%
\@x{ Req ( p ) \.{\defeq} \.{\land} ctl [ p ] \.{=}\@w{rdy}}%
\@x{\@s{48.76} \.{\land} \E\, req\@s{2.30} \.{\in}\@s{4.1} MReq \.{:}}%
\@x{\@s{67.09} \.{\land} Send ( p ,\, req ,\, memInt ,\, memInt \.{'} )}%
 \@x{\@s{67.09} \.{\land} buf \.{'} \.{=} [ buf {\EXCEPT} {\bang} [ p ] \.{=}
 req ]}%
 \@x{\@s{67.09} \.{\land} ctl \.{'}\@s{3.64} \.{=} [ ctl {\EXCEPT} {\bang} [ p
 ]\@s{3.64} \.{=}\@w{busy} ]}%
\@x{\@s{48.76} \.{\land} {\UNCHANGED} mem}%
\@pvspace{8.0pt}%
\@x{ Do ( p ) \.{\defeq}}%
\@x{\@s{13.29} \.{\land} ctl [ p ] \.{=}\@w{busy}}%
\@x{\@s{13.29} \.{\land} mem \.{'} \.{=} {\IF} buf [ p ] . op \.{=}\@w{Wr}}%
 \@x{\@s{70.46} \.{\THEN} [ mem {\EXCEPT} {\bang} [ buf [ p ] . adr ] \.{=}
 buf [ p ] . val ]}%
\@x{\@s{70.46} \.{\ELSE} mem}%
 \@x{\@s{13.29} \.{\land} buf \.{'}\@s{6.56} \.{=} [ buf {\EXCEPT} {\bang} [ p
 ] \.{=} {\IF} buf [ p ] . op \.{=}\@w{Wr}}%
\@x{\@s{163.57} \.{\THEN} NoVal}%
\@x{\@s{163.57} \.{\ELSE} mem [ buf [ p ] . adr ] ]}%
 \@x{\@s{13.29} \.{\land} ctl \.{'}\@s{10.21} \.{=} [ ctl {\EXCEPT} {\bang} [
 p ]\@s{3.64} \.{=}\@w{done} ]}%
\@x{\@s{13.29} \.{\land} {\UNCHANGED} memInt}%
\@pvspace{8.0pt}%
\@x{ Rsp ( p ) \.{\defeq} \.{\land} ctl [ p ] \.{=}\@w{done}}%
 \@x{\@s{49.53} \.{\land} Reply ( p ,\, buf [ p ] ,\, memInt ,\, memInt \.{'}
 )}%
 \@x{\@s{49.53} \.{\land} ctl \.{'} \.{=} [ ctl {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{rdy} ]}%
\@x{\@s{49.53} \.{\land} {\UNCHANGED} {\langle} mem ,\, buf {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ INext \.{\defeq} \E\, p \.{\in} Proc \.{:} Req ( p ) \.{\lor} Do ( p )
 \.{\lor} Rsp ( p )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ Liveness \.{\defeq} \A\, p \.{\in} Proc \.{:} {\WF}_{ vars} ( Do ( p ) )
 \.{\land} {\WF}_{ vars} ( Rsp ( p ) )}%
\@pvspace{8.0pt}%
 \@x{ ISpec \.{\defeq} IInit\@s{4.1} \.{\land}\@s{4.1} {\Box} [ INext ]_{
 vars}}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM} ISpec \.{\implies} {\Box} TypeInvariant}%
\@x{}\bottombar\@xx{}%
\end{document}
