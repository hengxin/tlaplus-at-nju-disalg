...
EXTENDS Paxos, TLC
-----------------------------------------------------------------------------
CONSTANTS a1, a2, a3  \* acceptors, a4, a5
CONSTANTS v1, v2      \* Values, v3

MCAcceptor == {a1, a2, a3}\*{a1, a2, a3, a4, a5}  \*{a1}   
MCValue    == {v1, v2} \* {v1, v2, v3} \*{v1} 
MCQuorum == {{a1, a2}, {a1, a3}, {a2, a3}} \*{{a1}} \*  {{a1, a2, a3}, {a1, a2, a4}, {a1, a2, a5}, {a1, a3, a4}, {a1, a3, a5}, {a1, a4, a5}, {a2, a3, a4}, {a2, a3, a5}, {a2, a4, a5}, {a3, a4, a5}}
...
\* Last modified Fri Apr 20 17:16:41 GMT+08:00 2018 by pure_
\* Created Mon Apr 09 18:10:06 GMT+08:00 2018 by pure_
