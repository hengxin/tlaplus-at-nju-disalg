...
VotesSafe == \A a \in Acceptor, b \in Ballot, v \in Value :
  ...
  (*********************************************************************)
  (* To satisfy CP(v, i), For any rounds i and j with j < i, if an     *)
  (* acceptor has vote for v in round i, then no value other than v has*)
  (* or might been chosen in round j.                                  *)  
  (*********************************************************************)
...
\* Last modified Fri Apr 20 08:42:12 GMT+08:00 2018 by pure_
\* Created Mon Apr 09 16:37:51 GMT+08:00 2018 by pure_
