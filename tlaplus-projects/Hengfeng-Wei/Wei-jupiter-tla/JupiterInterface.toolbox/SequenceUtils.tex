...
\setboolean{shading}{true}
 ...
 {\MODULE} SequenceUtils}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\end{lcom}%
 ...
 Sequences ,\, SetUtils ,\, FunctionUtils}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Prepend ( s ,\, e )
 \.{\defeq} {\langle} e {\rangle} \.{\circ} s}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} First ( seq ) \.{\defeq} seq
 [ 1 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Last ( seq ) \.{\defeq} seq
 [ Len ( seq ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} AllButFirst ( seq )
 \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} seq
 [ ( i \.{+} 1 ) ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} AllButLast ( seq )
 \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} seq
 [ i ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} DoesSeqPrefixSeq ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{8.2} \.{\land} Len ( seq1
 ) \.{\leq} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} 1 \.{\dotdot} Len ( seq1 ) \.{:} seq1 [ i ] \.{=} seq2 [ i ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} DoesSeqProperlyPrefixSeq (
 seq1 ,\, seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{8.2} \.{\land} Len ( seq1
 ) \.{<} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} 1 \.{\dotdot} Len ( seq1 ) \.{:} seq1 [ i ] \.{=} seq2 [ i ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} IsElementInSeq ( el ,\, seq
 ) \.{\defeq} \E\, i \.{\in} {\DOMAIN} seq \.{:} seq [ i ] \.{=} el}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} IsSequenceOfSetElements (
 seq ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{8.2} \.{\land} Len ( seq
 ) \.{=} Cardinality ( set )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{8.2} \.{\land} ( \A\, el
 \.{\in} set \.{:} IsElementInSeq ( el ,\, seq ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}
 IsSortedSequenceOfSetElements ( seq ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{8.2} \.{\land}
 IsSequenceOfSetElements ( seq ,\, set )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq ,\, j \.{\in} {\DOMAIN} seq \.{:} i \.{<} j
 \.{\implies} seq [ i ] \.{<} seq [ j ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} DeleteElement ( seq ,\,
 index ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{8.2} [ i \.{\in} 1
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} {\RECURSIVE} Retain ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} Retain ( seq ,\, R )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} {\IF} seq \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\THEN} {\langle}
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 h \.{\defeq} Head ( seq )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{51.81} \.{\IN} {\IF} h
 \.{\in} R}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{72.21} \.{\THEN}
 {\langle} h {\rangle} \.{\circ} Retain ( Tail ( seq ) ,\, R )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{72.21} \.{\ELSE} Retain (
 Tail ( seq ) ,\, R )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} SeqMap ( Op ( \_ ) ,\, seq
 ) \.{\defeq} [ x \.{\in} {\DOMAIN} seq \.{\mapsto} Op ( seq [ x ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} PermsWithin ( S )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}} PermutationKey ( n
 )\@s{1.00} \.{\defeq} \{ key \.{\in} [ 1 \.{\dotdot} n \.{\rightarrow} 1
 \.{\dotdot} n ] \.{:} Range ( key ) \.{=} 1 \.{\dotdot} n \}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} PermutationsOf ( T )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} {\RECURSIVE}
 FirstIndexOfElement ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} FirstIndexOfElement ( seq
 ,\, elem ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} {\IF} Head ( seq )
 \.{=} elem}%
\@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{16.4} \.{\THEN} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{16.4} \.{\ELSE} 1 \.{+}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}} {\RECURSIVE}
 FirstIndexOfElementSafe ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}} FirstIndexOfElementSafe (
 seq ,\, elem ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} FirstIndexOfElementSafeHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{40.89}
 FirstIndexOfElementSafeHelper ( seqh ,\, elemh ,\, fail ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{57.29} {\IF} seqh \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{57.29} \.{\THEN} 0 \.{-}
 fail}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{57.29} \.{\ELSE} {\IF}
 Head ( seqh ) \.{=} elemh}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{88.61} \.{\THEN} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{88.61} \.{\ELSE} 1 \.{+}
 FirstIndexOfElementSafeHelper ( Tail ( seqh ) ,\, elemh ,\, fail \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{20.5} \.{\IN}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}} Compatible ( seq1 ,\, seq2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{16.4} \.{\lor} seq1
 \.{=} seq2}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{16.4} \.{\lor} \.{\LET}
 commonElements \.{\defeq} Range ( seq1 ) \.{\cap} Range ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{27.51} \.{\IN} \A\, e1
 ,\, e2 \.{\in} commonElements \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{56.11} \.{\lor} e1 \.{=}
 e2}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{56.11} \.{\lor}
 FirstIndexOfElement ( seq1 ,\, e1 ) \.{<} FirstIndexOfElement ( seq1 ,\, e2
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{67.22} \.{\equiv}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}} {\RECURSIVE} LCS ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}} LCS ( seq1 ,\, seq2 )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{24.13} {\IF} seq1 \.{=}
 {\langle} {\rangle} \.{\lor} seq2 \.{=} {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{24.13} \.{\THEN} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{24.13} \.{\ELSE} {\IF}
 Last ( seq1 ) \.{=} Last ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{55.44} \.{\THEN} 1 \.{+}
 LCS ( AllButLast ( seq1 ) ,\, AllButLast ( seq2 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{55.44} \.{\ELSE}
 MaxOfSet ( \{ LCS ( AllButLast ( seq1 ) ,\, seq2 ) ,\, LCS ( seq1 ,\,
 AllButLast ( seq2 ) ) \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}} LCSCompatible ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 176\hspace{1em}}\@s{16.4} Compatible ( seq1
 ,\, seq2 ) \.{\equiv} LCS ( seq1 ,\, seq2 ) \.{=} Cardinality ( Range ( seq1
 ) \.{\cap} Range ( seq2 ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}} LCSCompatibleTest ( S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}}\@s{16.4} \A\, seq1 ,\, seq2
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 19:42:23 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
