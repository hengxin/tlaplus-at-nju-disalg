...
\setboolean{shading}{true}
 ...
 {\MODULE} SetUtils}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Copyright: https:\ensuremath{\.{\slsl}www.learntla.com}/libraries/sets/
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} TLC}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Pick ( S ) \.{\defeq}
 {\CHOOSE} s \.{\in} S \.{:} {\TRUE}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} {\RECURSIVE} SetReduceSafe (
 \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} SetReduceSafe ( Op ( \_ ,\,
 \_ ) ,\, S ,\, value ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} {\IF} S \.{=} \{
 \}}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\THEN} value}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 s \.{\defeq} Pick ( S )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{47.71} \.{\IN} {\IF} Op (
 s ,\, value ) \.{=} Op ( value ,\, s )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{68.11} \.{\THEN}
 SetReduceSafe ( Op ,\, S \.{\,\backslash\,} \{ s \} ,\, Op ( s ,\, value )
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{68.11} \.{\ELSE} Assert (
 {\FALSE} ,\,\@w{Op\ is\ not\ commutative.} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Sum ( S ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{23.82} \.{\LET} sum ( a
 ,\, b ) \.{\defeq} a \.{+} b}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{23.82} \.{\IN} SetReduce
 ( sum ,\, S ,\, 0 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} IsMin ( set ,\, min )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land} min
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land} ( \A\, x
 \.{\in} set \.{:} min \.{\leq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} IsMax ( set ,\, max )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} max
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} ( \A\, x
 \.{\in} set \.{:} max \.{\geq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} MinOfSet ( set )\@s{1.06}
 \.{\defeq} {\CHOOSE} min\@s{1.49} \.{\in} set \.{:} ( \A\, x \.{\in} set
 \.{:} min \.{\leq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} MaxOfSet ( set ) \.{\defeq}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 19:43:16 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
