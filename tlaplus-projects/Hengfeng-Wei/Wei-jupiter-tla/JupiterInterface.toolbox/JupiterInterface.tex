...
Interface of a family of \ensuremath{Jupiter} protocols.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} SequenceUtils ,\,
 OT}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Msg ,\,\@s{25.13}}%
\@y{\@s{0}%
 the set of messages
}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} aop ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{aop[r]}: the actual operation applied at replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} state ,\,\@s{7.06}}%
\@y{\@s{0}%
 \ensuremath{state[r]}: state (the list content) of replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
 incoming channel at the \ensuremath{Server
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
 a set of chars allowed to insert; this is for model checking
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Comm \.{\defeq} {\INSTANCE}
 CSComm}%
...
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} List \.{\defeq} Seq ( Char
 \.{\cup} Range ( InitState ) )\@s{42.53}}%
\@y{\@s{0}%
 all possible lists
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} MaxLen \.{\defeq}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} ClientNum \.{\defeq}
 Cardinality ( Client )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Priority \.{\defeq}
 {\CHOOSE} f \.{\in} [ Client \.{\rightarrow} 1 \.{\dotdot} ClientNum ] \.{:}
 Injective ( f )}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
\@y{\@s{0}%
 The positions (\ensuremath{pos}) are indexed from 1.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
 The set of all operations (now we don\mbox{'}t consider \ensuremath{Rd}
 operations).
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} SetNewAop ( r ,\, aopr )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} aop \.{'} \.{=} [
 aop {\EXCEPT} {\bang} [ r ] \.{=} aopr ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} ApplyNewAop ( r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT} {\bang} [ r ] \.{=} Apply ( aop \.{'} [ r ] ,\, @ ) ]}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} TypeOKInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} aop
 \.{\in} [ Replica \.{\rightarrow} Op \.{\cup} \{ Nop \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land} state
 \.{\in} [ Replica \.{\rightarrow} List ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} InitInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land} aop \.{=}
 ...
 {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} DoIns ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} generates and processes an
 \ensuremath{\@w{Ins}} operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{27.72} \.{\land} ins . ch
 \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} DoDel ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} generates and processes a
 \ensuremath{\@w{Del}} operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{27.72} \.{\land} del .
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} DoInt ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} generates an operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 DoIns ( DoOp ,\, c )\@s{2.51}}%
\@y{\@s{0}%
 \ensuremath{DoOp(c \.{\in} Client,\, op \.{\in} Op)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{27.51} \.{\lor} DoDel (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\land}
 ApplyNewAop ( c )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} RevInt ( ClientPerform ( \_
 ,\, \_ ) ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 ClientPerform ( c ,\, Head ( cincoming [ c ] ) )}%
\@y{\@s{0}%
 \ensuremath{ClientPerform(c \.{\in} Client,\, m \.{\in} Msg)
}}%
\@xx{}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} SRevInt ( ServerPerform ( \_
 ) ) \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} receives and processes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 Comm {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 ServerPerform ( Head ( sincoming ) )}%
\@y{\@s{0}%
 \ensuremath{ServerPerform(m \.{\in} Msg)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 ApplyNewAop ( Server )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 04 11:46:40 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
