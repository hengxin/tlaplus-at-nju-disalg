...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\CONSTANTS}}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Client
 ,\,\@s{21.66}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Char ,\,\@s{26.26}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{state[r]}: state (the list content) of replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
 incoming channel at the \ensuremath{Server
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
 a set of chars allowed to insert; this is for model checking
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Comm ( Msg ) \.{\defeq}
 {\INSTANCE} CSComm}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} List \.{\defeq} Seq ( Char
 \.{\cup} Range ( InitState ) )\@s{42.53}}%
\@y{\@s{0}%
 all possible lists/strings
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} MaxLen \.{\defeq}
 Cardinality ( Char ) \.{+} Len ( InitState )}%
\@y{\@s{0}%
 the \ensuremath{max} length of lists in any states;
}%
\@xx{}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} ClientNum \.{\defeq}
 Cardinality ( Client )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Priority \.{\defeq}
...
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} Range (
...
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} TypeOKInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} state
 \.{\in} [ Replica \.{\rightarrow} List ]}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} InitInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land}
 state\@s{2.11} \.{=} [ r \.{\in} Replica \.{\mapsto} InitState ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 20:56:30 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
