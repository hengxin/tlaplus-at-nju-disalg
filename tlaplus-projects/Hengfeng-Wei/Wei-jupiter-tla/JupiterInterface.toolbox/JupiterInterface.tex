...
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} TypeOKInt \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} InitInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} aop \.{=}
 [ r \.{\in} Replica \.{\mapsto} Nop ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land}
 state\@s{2.11} \.{=} [ r \.{\in} Replica \.{\mapsto} InitState ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} DoIns ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{27.72} \.{\land} ins . ch
 \.{\in} chins}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} DoDel ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{27.72} \.{\land} del .
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} DoInt ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} issues an operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 DoIns ( DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{27.51} \.{\lor} DoDel (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land}
 ApplyNewAop ( c )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} RevInt ( ClientPerformInt (
 \_ ,\, \_ ) ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} receives and processes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} CRev ( c )}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} SRevInt ( ServerPerformInt (
 \_ ) ) \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} receives and processes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 Comm {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 18:56:22 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
