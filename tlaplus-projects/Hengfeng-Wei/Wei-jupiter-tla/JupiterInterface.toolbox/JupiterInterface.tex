...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land} DoIns (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} DoDel (
 DoOp ,\, c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} CRevInt ( c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} receives a message from the
 \ensuremath{Server}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 31 20:19:23 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
