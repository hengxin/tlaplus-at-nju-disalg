...
\@xx{}%
 ...
 ApplyNewAop ( c )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} RevInt ( ClientPerformInt (
 \_ ,\, \_ ) ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@y{\@s{0}%
 \ensuremath{ClientPerformInt(c \.{\in} Client,\, m \.{\in} Msg)
}}%
\@xx{}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} SRevInt ( ServerPerformInt (
 \_ ) ) \.{\defeq}}%
\@y{\@s{0}%
...
\@y{\@s{0}%
 \ensuremath{ServerPerformInt(m \.{\in} Msg)
}}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 03 16:39:10 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
