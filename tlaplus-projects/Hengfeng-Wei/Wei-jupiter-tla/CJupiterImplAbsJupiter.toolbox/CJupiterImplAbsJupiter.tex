...
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 ...
 AbsJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{57.80} {\WITH} copss
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto} \{ e . cop \.{:} e \.{\in}
 css [ r ] . edge \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\THEOREM} Spec \.{\implies}
 AbsJ {\bang} Spec}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 22:44:49 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
