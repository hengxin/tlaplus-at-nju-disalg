...
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} AbsJ \.{\defeq} {\INSTANCE}
 AbsJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{57.80} {\WITH} copss
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto} \{ e . cop \.{:} e \.{\in}
 css [ r ] . edge \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\THEOREM} Spec \.{\implies}
 AbsJ {\bang} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 21:04:52 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
