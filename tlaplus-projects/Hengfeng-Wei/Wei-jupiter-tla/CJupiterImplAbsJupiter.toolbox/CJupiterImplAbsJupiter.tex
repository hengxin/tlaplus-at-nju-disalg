...
\setboolean{shading}{true}
 ...
 {\MODULE} CJupiterImplAbsJupiter}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
We show that \ensuremath{CJupiter} implements \ensuremath{AbsJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} CJupiter}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} AbsJ \.{\defeq} {\INSTANCE}
 AbsJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{57.80} {\WITH} ds
 \.{\leftarrow} cur ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{88.78} copss
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto} \{ e . cop \.{:} e \.{\in}
 css [ r ] . edge \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\THEOREM} Spec \.{\implies}
 AbsJ {\bang} Spec}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 14 21:26:52 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Dec} 14
 21:10:31 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
