...
\@xx{\@s{27.36} IsSorted2Partition ( n ,\, seq1 ,\, seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{8.2} \.{\land} seq1
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{8.2} \.{\land} seq2
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{8.2} \.{\land} n \.{=}
 Len ( seq1 ) \.{+} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq1 ,\, j \.{\in} {\DOMAIN} seq1 \.{:} i \.{<} j
 \.{\implies} seq1 [ i ] \.{<} seq1 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq2 ,\, j \.{\in} {\DOMAIN} seq2 \.{:} i \.{<} j
 \.{\implies} seq2 [ i ] \.{<} seq2 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
...
\@z{%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{8.2} \.{\land} indSeq1
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{8.2} \.{\land} indSeq2
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{8.2} \.{\land}
 IsSorted2Partition ( Len ( seq ) ,\, indSeq1 ,\, indSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq1 ) \.{=} Len ( subSeq1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq2 ) \.{=} Len ( subSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} indSeq1 \.{:} seq [ ( indSeq1 [ i ] ) ] \.{=} subSeq1 [ i
 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 03 15:22:02 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
