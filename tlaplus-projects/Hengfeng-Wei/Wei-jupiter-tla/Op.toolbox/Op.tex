...
\setboolean{shading}{true}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} Del1 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}} Del2 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} Del3 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} Del4 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Ins1\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 1 ,\, ch
 \.{\mapsto}\@w{a} ,\, pr\@s{0.36} \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} Ins2\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 2 ,\, ch
 \.{\mapsto}\@w{b} ,\, pr \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Ins3\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 3 ,\, ch
 \.{\mapsto}\@w{c} ,\, pr\@s{0.72} \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} Ops \.{\defeq} {\langle} Ins2
 ,\, Del3 ,\, Ins1 ,\, Del2 ,\, Ins3 ,\, Del1 {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 31 19:25:09 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
