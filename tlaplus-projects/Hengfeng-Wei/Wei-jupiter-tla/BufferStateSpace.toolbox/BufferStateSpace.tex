...
\@xx{}%
 ...
 {\langle} {\rangle} \.{\THEN} {\langle} op {\rangle}}%
\@y{\@s{0}%
 Maintain and return the intermediate transformed operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\ELSE} {\langle}
 op {\rangle} \.{\circ} xFormOpOps ( xform ,\, xform ( op ,\, Head ( ops ) )
 ,\, Tail ( ops ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} xFormOpsOp ( xform ( \_ ,\,
 \_ ) ,\, ops ,\, op ) \.{\defeq}}%
\@y{\@s{0}%
 Transform an operation sequence \ensuremath{ops} against \ensuremath{op}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\LET} opX
 \.{\defeq} xFormOpOps ( xform ,\, op ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\IN} [ i \.{\in}
 1 \.{\dotdot} Len ( ops ) \.{\mapsto} xform ( ops [ i ] ,\, opX [ i ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} xFormFull ( xform ( \_ ,\,
 \_ ) ,\, op ,\, ops ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} [ xop\@s{1.50}
 \.{\mapsto} Last ( xFormOpOps ( xform ,\, op ,\, ops ) ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} xops \.{\mapsto}
 xFormOpsOp ( xform ,\, ops ,\, op ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} xFormShift ( xform ( \_ ,\,
 \_ ) ,\, op ,\, ops ,\, shift ) \.{\defeq}}%
\@y{\@s{0}%
 shift of \ensuremath{ops
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} xFormFull ( xform
 ,\, op ,\, SubSeq ( ops ,\, shift \.{+} 1 ,\, Len ( ops ) ) )}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 17 10:30:18 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
