...
\setboolean{shading}{true}
 ...
 {\MODULE} BufferStateSpace}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The buffer (\ensuremath{i.e}., sequence) representation of state space used
 in \ensuremath{AJupiter}.
 This module defines generalized \ensuremath{OT} functions on operation
 sequences.
\end{cpar}%
\end{lcom}%
...
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\RECURSIVE} xFormOpOps ( \_
 ,\, \_ ,\, \_ )}%
\@y{\@s{0}%
 Transform \ensuremath{op} against an operation sequence \ensuremath{ops}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} xFormOpOps ( xform ( \_ ,\,
 \_ ) ,\, op ,\, ops ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\THEN} op}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\ELSE}
 xFormOpOps ( xform ,\, xform ( op ,\, Head ( ops ) ) ,\, Tail ( ops ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\RECURSIVE} xFormOpOpsX (
 \_ ,\, \_ ,\, \_ )}%
\@y{\@s{0}%
 Transform \ensuremath{op} against an operation sequence \ensuremath{ops}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} xFormOpOpsX ( xform ( \_ ,\,
 \_ ) ,\, op ,\, ops ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\THEN} {\langle}
 op {\rangle}}%
\@y{\@s{0}%
 Maintain and return the intermediate transformed operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\ELSE} {\langle}
 op {\rangle} \.{\circ} xFormOpOpsX ( xform ,\, xform ( op ,\, Head ( ops ) )
 ,\, Tail ( ops ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} xFormOpsOp ( xform ( \_ ,\,
 \_ ) ,\, ops ,\, op ) \.{\defeq}}%
\@y{\@s{0}%
 Transform an operation sequence \ensuremath{ops} against \ensuremath{op}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\LET} opX
 \.{\defeq} xFormOpOpsX ( xform ,\, op ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\IN} [ i \.{\in}
 1 \.{\dotdot} Len ( ops ) \.{\mapsto} xform ( ops [ i ] ,\, opX [ i ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} xFormShift ( xform ( \_ ,\,
 \_ ) ,\, op ,\, ops ,\, shift ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\LET} shiftedOps
 \.{\defeq} SubSeq ( ops ,\, shift ,\, Len ( ops ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\IN} [
 xop\@s{1.50} \.{\mapsto} xFormOpOps ( xform ,\, op ,\, shiftedOps ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{36.79} xops \.{\mapsto}
 xFormOpsOp ( xform ,\, shiftedOps ,\, op ) ]}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:34:37 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jan} 12 14:55:34
