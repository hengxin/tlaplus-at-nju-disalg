...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Oid\@s{1.13} \.{\defeq} [ c
 \.{:} Client ,\, seq \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 operation identifier
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Cop \.{\defeq} [ op \.{:} Op
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} COT ( lcop ,\, rcop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{27.19} [ lcop {\EXCEPT}
 {\bang} . op \.{=} Xform ( lcop . op ,\, rcop . op ) ,\, {\bang} . ctx \.{=}
 @ \.{\cup} \{ rcop . oid \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} UpdateDS ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} ds \.{'} \.{=} [ ds
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} cop ]}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} TypeOKCtx \.{\defeq}}%
...
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} RevCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, Head ( cincoming [ c ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} SRevCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 12:06:47 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
