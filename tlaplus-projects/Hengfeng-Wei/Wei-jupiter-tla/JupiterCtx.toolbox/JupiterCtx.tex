...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Oid\@s{1.13} \.{\defeq} [ c
 \.{:} Client ,\, seq \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 operation identifier
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Cop \.{\defeq} [ op \.{:} Op
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} COT ( lcop ,\, rcop )
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 12 20:11:40 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
