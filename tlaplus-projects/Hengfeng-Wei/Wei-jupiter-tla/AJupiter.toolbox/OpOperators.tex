...
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} Nop \.{\defeq} PickNone ( Nat
 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq}}%
\@y{\@s{0}%
 Apply an operation \ensuremath{op} on the list \ensuremath{l}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{16.4} {\CASE} op \.{=} Nop
 \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{20.5} {\Box}\@s{14.40} op
 . type \.{=}\@w{Rd} \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{20.5} {\Box}\@s{14.40} op
 . type \.{=}\@w{Del} \.{\rightarrow} DeleteElement ( l ,\, op . pos )}%
\@y{\@s{0}%
 \ensuremath{Last(l)} is deleted if \ensuremath{pos \.{>} Len(l)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{20.5} {\Box}\@s{14.40} op
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} {\RECURSIVE} ApplyOps ( \_
 ,\, \_ )}%
\@y{\@s{0}%
 Apply an operation sequence \ensuremath{ops} on the list \ensuremath{l}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} ApplyOps ( ops ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\THEN} l}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\ELSE} Apply (
 Last ( ops ) ,\, ApplyOps ( AllButLast ( ops ) ,\, l ) )}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 14:27:16 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
