...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Hagit} \ensuremath{Attiya} and others.
\end{cpar}%
\end{lcom}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} Msg \.{\defeq} [ c \.{:}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{37.42} [ ack \.{:} Int
 ,\, op \.{:} Op \.{\cup} \{ Nop \} ]}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer (of operations) at the client \ensuremath{c
 \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: the number of new messages have been received by the
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} sbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} srec ,\,\@s{14.49}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} state ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
 a set of chars to insert
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} vars \.{\defeq} {\langle}
 chins ,\, cbuf ,\, crec ,\, sbuf ,\, srec ,\, cincoming ,\, sincoming ,\,
 state {\rangle}}%
...
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 cbuf \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land} cbuf
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{26.06} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{26.06} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{26.06} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{26.06} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{27.72} \.{\land} chins
 \.{'} \.{=} chins \.{\,\backslash\,} \{ ins . ch \}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{27.72} \.{\land}
...
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{22.34} \.{\lor} DoIns (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{22.34} \.{\lor} DoDel (
 c )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{20.94} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{52.45} cBuf \.{\defeq}
 cbuf [ c ]\@s{4.1}}%
\@y{\@s{0}%
 the buffer at client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{52.45} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )\@s{4.1}}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{52.45} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{56.55} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xcBuf ]}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{56.55} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ c ] \.{=} Apply ( xop ,\, @ ) ]}%
\@y{\@s{0}%
 apply the transformed operation \ensuremath{xop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, sbuf ,\, srec {\rangle}}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{47.91} c\@s{3.77}
 \.{\defeq} m . c\@s{57.99}}%
\@y{\@s{0}%
 the client \ensuremath{c \.{\in} Client} that sends this message
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{47.91} cBuf \.{\defeq}
 sbuf [ c ]\@s{31.67}}%
\@y{\@s{0}%
 the buffer at the \ensuremath{Server} for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{47.91} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{47.91} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{52.01} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{117.66} \.{\THEN} srec [
 cl ] \.{+} 1}%
\@y{\@s{0}%
 receive one more operation from client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{117.66} \.{\ELSE} 0 ]}%
\@y{\@s{0}%
 reset \ensuremath{srec} for other clients than \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{52.01} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{117.66} \.{\THEN}
 xcBuf\@s{4.1}}%
\@y{\@s{0}%
 transformed buffer for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{117.66} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xop ) ]}%
\@y{\@s{0}%
 store transformed \ensuremath{xop} into other clients\mbox{'} bufs
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{52.01} \.{\land} state
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{52.01} \.{\land} comm
...
\@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Fairness: There is no requirement that the clients ever generate operations.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}} QC \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}\@s{20.37} comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} QC}%
\@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 18:35:18 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
