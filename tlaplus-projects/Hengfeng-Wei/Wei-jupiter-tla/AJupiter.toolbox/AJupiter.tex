...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Server\@s{16.74}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} cstate ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} sbuf ,\,\@s{10.65}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} srec ,\,\@s{12.84}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: the number of new messages have been \.{\dots}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4}
 sincoming\@s{10.72}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} cvars \.{\defeq} {\langle}
 cbuf ,\, crec ,\, cstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} svars\@s{0.51} \.{\defeq}
 {\langle} sbuf ,\, srec ,\, sstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} commvars \.{\defeq}
 {\langle} cincoming ,\, sincoming {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} vars \.{\defeq} cvars
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Msg \.{\defeq} [ c \.{:}
 Client ,\, ack \.{:} Nat ,\, op \.{:} Op ] \.{\cup}}%
\@y{\@s{0}%
 messages sent to the \ensuremath{Server} from a client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{37.42} [ ack \.{:} Nat
 ,\, op \.{:} Op ]}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} [ Client \.{\rightarrow} List ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} cincoming
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} CSend ( msg ) \.{\defeq}
 \.{\land} sincoming \.{'} \.{=} Append ( sincoming ,\, msg )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} broadcast a message \ensuremath{msg} to the Clients
 other than \ensuremath{c \.{\in} Client}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} SBoradcast ( c ,\, msg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{99.45} \.{\ELSE} Append
 ( cincoming [ cl ] ,\, msg ) ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}} Do ( c ,\, op ) \.{\defeq}
 \.{\land} {\TRUE}\@s{12.29}}%
\@y{\@s{0}%
 no pre-condition
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{62.08} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{62.08} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{62.08} \.{\land} CSend (
 [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op \.{\mapsto} op ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{62.08} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{62.08} \.{\land}
 {\UNCHANGED} svars}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Client \ensuremath{c \.{\in} Client} receives a message \ensuremath{msg} from
 the \ensuremath{Server}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} CRev ( c ,\, msg )
 \.{\defeq} \.{\land} cincoming [ c ] \.{\neq} {\langle} {\rangle}\@s{8.2}}%
\@y{\@s{0}%
 there are messages to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{69.22} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{69.22} \.{\land}
 \.{\LET} m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{80.33} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} SubSeq ( @ ,\, m . ack
 \.{+} 1 ,\, Len ( @ ) ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{100.73} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( m . op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{69.22} \.{\land}
 {\FALSE}}%
\@y{\@s{0}%
 \ensuremath{TODO}: (\ensuremath{buf}, \ensuremath{o}) \ensuremath{\.{=}
 xform(buf,\, o)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{69.22} \.{\land}
 {\UNCHANGED} ( svars \.{\circ} commvars )}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} Next \.{\defeq} {\FALSE}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 11:09:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
