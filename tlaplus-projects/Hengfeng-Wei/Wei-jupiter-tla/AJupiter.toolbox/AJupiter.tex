...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} State
 ,\,\@s{18.50}}%
\@y{\@s{0}%
 the initial state of each replica
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Cop\@s{29.33}}%
\@y{\@s{0}%
 \ensuremath{Cop[c]}: operations issued by the client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\land} State
 \.{\in} List}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land} Cop
 \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\VARIABLES}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} cop ,\,\@s{24.59}}%
\@y{\@s{0}%
 \ensuremath{cop[c]}: operations issued by the client \ensuremath{c \.{\in}
 Client
}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer (of operations) at the client \ensuremath{c
 \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: the number of new messages have been received by the
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
 since the last time a message was sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} cstate ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} sbuf ,\,\@s{10.65}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} srec ,\,\@s{12.84}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: the number of new messages have been \.{\dots}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} cVars \.{\defeq} {\langle}
 cop ,\, cbuf ,\, crec ,\, cstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} sVars\@s{0.51} \.{\defeq}
 {\langle} sbuf ,\, srec ,\, sstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} vars \.{\defeq} cVars
 \.{\circ} sVars \.{\circ} comm {\bang} vars}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} cop
 \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} cbuf
 ...
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} List}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} cstate
 \.{=} [ c \.{\in} Client \.{\mapsto} State ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the server replica:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{=} State}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For communication between the server and the clients:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} Init}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{22.34} \.{\land} cop [ c
 ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{22.34} \.{\land} \.{\LET}
 op \.{\defeq} Head ( cop [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{37.55} \.{\IN} \.{\land}
 PrintT ( c \.{\circ}\@w{:\ Do\ } \.{\circ} ToString ( op ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{57.95} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{57.95} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{57.95} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{22.34} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{22.34} \.{\land} cop
 \.{'} \.{=} [ cop {\EXCEPT} {\bang} [ c ] \.{=} Tail ( @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} sVars}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@y{%
 \ensuremath{CRev(c) \.{\defeq}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} comm{\bang}CRev(c)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} crec\.{'} \.{=}} [\ensuremath{crec}
 \ensuremath{{\EXCEPT} {\bang}[c] \.{=} @ \.{+} 1}]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} \.{\LET} m \.{\defeq} Head(cincoming[c])
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}}%
\@y{\@s{25.0}%
 \ensuremath{cBuf \.{\defeq} cbuf[c] \.{\,\backslash\,}}* the buffer at
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}}%
\@y{\@s{25.0}%
 \ensuremath{cShiftedBuf \.{\defeq} SubSeq(cBuf,\, m.ack \.{+} 1,\,
 Len(cBuf)) \.{\,\backslash\,}}* buffer shifted
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}}%
\@y{\@s{25.0}%
 \ensuremath{xop \.{\defeq} XformOpOps(m.op,\, cShiftedBuf)
 \.{\,\backslash\,}}* transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}}%
\@y{\@s{25.0}%
 \ensuremath{xcBuf \.{\defeq} XformOpsOp(cShiftedBuf,\, m.op)
 \.{\,\backslash\,}}* transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{\.{\IN} \.{\land} cbuf\.{'} \.{=}} [\ensuremath{cbuf}
 \ensuremath{{\EXCEPT} {\bang}[c] \.{=} xcBuf}]
}%
\@xx{}%
...
\@y{\@s{7.5}%
 \ensuremath{\.{\land} {\UNCHANGED}} (\ensuremath{sVars \.{\circ}
 {\langle}cop{\rangle}})
}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 m \.{\defeq} Head ( sincoming )}%
\@y{\@s{0}%
 the message to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{47.91} c\@s{3.77}
 \.{\defeq} m . c\@s{57.99}}%
\@y{\@s{0}%
 the client \ensuremath{c \.{\in} Client} that sends this message
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{47.91} cBuf \.{\defeq}
 sbuf [ c ]\@s{31.67}}%
\@y{\@s{0}%
 the buffer at the \ensuremath{Server} for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{47.91} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{47.91} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{52.01} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{117.66} \.{\THEN} srec [
 cl ] \.{+} 1}%
\@y{\@s{0}%
 receive one more operation from client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{117.66} \.{\ELSE} 0 ]}%
\@y{\@s{0}%
 reset \ensuremath{srec} for other clients than \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{52.01} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{117.66} \.{\THEN}
 xcBuf\@s{4.1}}%
\@y{\@s{0}%
 transformed buffer for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{117.66} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xop ) ]}%
\@y{\@s{0}%
 store transformed \ensuremath{xop} into other clients\mbox{'} bufs
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{52.01} \.{\land} sstate
 \.{'} \.{=} Apply ( xop ,\, sstate )\@s{4.1}}%
\@y{\@s{0}%
 apply the transformed operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{52.01} \.{\land} comm
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}.
\end{cpar}%
...
\@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 03 13:57:27 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
