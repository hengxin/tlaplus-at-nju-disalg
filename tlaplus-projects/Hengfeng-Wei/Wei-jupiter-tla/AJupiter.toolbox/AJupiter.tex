...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer for locally generated operations at client
 \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: number of remote operations received by client
 \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
 since the last time a local operation was generated
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} sbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer for transformed remote operations
 \ensuremath{w.r.t} client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} srec\@s{20.60}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: number of locally generated operations by client
 \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{82.75}}%
\@y{\@s{0}%
 since the last time a remote operation was transformed at the
 \ensuremath{Server
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} vars \.{\defeq} {\langle}
 intVars ,\, cbuf ,\, crec ,\, sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} AJMsg \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} [ c \.{:} Client
 ,\, ack \.{:} Nat ,\, op \.{:} Op \.{\cup} \{ Nop \} ] \.{\cup}}%
\@y{\@s{0}%
 messages sent to the \ensuremath{Server} from client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} [ ack \.{:} Nat ,\,
 op \.{:} Op \.{\cup} \{ Nop \} ]}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} cbuf
...
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} ClientPerform ( c ,\, m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\LET} cBuf
 \.{\defeq} cbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{36.79} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{36.79} xop \.{\defeq}
 XformOpOps ( Xform ,\, m . op ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{40.89} xcBuf \.{\defeq}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{40.89} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} @ \.{+} 1
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( c ,\, xop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} ServerPerform ( m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\LET} c
 \.{\defeq} m . c}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{36.79} cBuf \.{\defeq}
 sbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{36.79} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{36.79} xop \.{\defeq}
 XformOpOps ( Xform ,\, m . op ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} xcBuf \.{\defeq}
 XformOpsOp ( Xform ,\, cShiftedBuf ,\, m . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 \.{\land} srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{110.65} {\IF} cl \.{=} c
 \.{\THEN} srec [ cl ] \.{+} 1 \.{\ELSE} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{40.89} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{106.55} {\IF} cl \.{=} c
 \.{\THEN} xcBuf \.{\ELSE} Append ( sbuf [ cl ] ,\, xop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xop )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{40.89} \.{\land} Comm
...
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{26.06} \.{\land}
 SetNewAop ( c ,\, op )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{26.06} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{26.06} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{26.06} \.{\land} Comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
...
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} Spec \.{\defeq} Init
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} QC}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 21:37:02 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
