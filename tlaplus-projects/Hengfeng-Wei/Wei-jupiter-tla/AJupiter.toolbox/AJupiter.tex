...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} OT ,\, TLC}%
...
\@y{\@s{7.5}%
 \ensuremath{Cop\@s{22.5}\.{\,\backslash\,}\.{*} Cop[c]}: operations issued
 by the client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\end{lcom}%
 ...
 opset \.{\in} {\SUBSET} Op \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{94.09} \A\, op1 ,\, op2
 \.{\in} opset \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{105.42} ( op1 . type
 \.{=}\@w{Ins} \.{\land} op2 . type \.{=}\@w{Ins} ) \.{\implies} op1 . ch
 \.{\neq} op2 . ch \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} {\VARIABLES}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
...
\@y{\@s{7.5}%
 cop,\@s{17.5}\ensuremath{\.{\,\backslash\,}\.{*} cop[c]}: operations issued
 by the client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} cop ,\,\@s{17.11}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer (of operations) at the client \ensuremath{c
 \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: the number of new messages have been received by the
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
 since the last time a message was sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} cstate ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} sbuf ,\,\@s{10.65}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} srec ,\,\@s{12.84}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: the number of new messages have been \.{\dots}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} cVars \.{\defeq} {\langle}
 cop ,\, cbuf ,\, crec ,\, cstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} sVars\@s{0.51} \.{\defeq}
 {\langle} sbuf ,\, srec ,\, sstate {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{FIXME}: subscript error (Don\mbox{'}t know why
 yet\ensuremath{{\bang})
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}}%
\@y{%
 \ensuremath{vars \.{\defeq} cVars \.{\circ} sVars \.{\circ}
 {\langle}cincoming,\, sincoming{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} jVars \.{\defeq} {\langle}
 cbuf ,\, crec ,\, cstate ,\, sbuf ,\, srec ,\, sstate ,\, cincoming ,\,
 sincoming {\rangle}\@s{8.2}}%
\@y{\@s{0}%
 all variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} vars \.{\defeq} {\langle}
 cop ,\, cbuf ,\, crec ,\, cstate ,\, sbuf ,\, srec ,\, sstate ,\, cincoming
 ,\, sincoming {\rangle}\@s{8.2}}%
\@y{\@s{0}%
 all variables
}%
...
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} TypeOK \.{\defeq}}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land} cop
 \.{\in} {\SUBSET} Op}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} List}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} Init \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} cop \.{=} Cop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\land} cop
 \.{\in} OpToIssue}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{=} InitState}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For communication between the server and the clients:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} Init}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} LegalizeOp ( op ,\, c )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \.{\LET} len
 \.{\defeq} Len ( cstate [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\IN} {\CASE} op
 . type \.{=}\@w{Del} \.{\rightarrow}}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{62.77} {\IF} len \.{=} 0
 \.{\THEN} Nop \.{\ELSE} [ op {\EXCEPT} {\bang} . pos \.{=} Min ( @ ,\, len )
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{40.89} {\Box}\@s{14.40}
 op . type \.{=}\@w{Ins} \.{\rightarrow}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{62.77} [ op {\EXCEPT}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \.{\land} cop
 \.{\neq} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 o \.{\defeq} {\CHOOSE} x \.{\in} cop \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{39.81} op\@s{2.98}
 \.{\defeq} LegalizeOp ( o ,\, c )\@s{4.1}}%
\@y{\@s{0}%
 preprocess an illegal operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{31.61} \.{\IN} \.{\lor}
 \.{\land} op \.{=} Nop}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{63.12} \.{\land} cop
 \.{'} \.{=} cop \.{\,\backslash\,} \{ o \}\@s{8.2}}%
\@y{\@s{0}%
 consume one operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{63.12} \.{\land}
 {\UNCHANGED} jVars}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{52.01} \.{\lor}
 \.{\land} op \.{\neq} Nop}%
\@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{52.01}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} PrintT(c \.{\circ} \@w{: Do } \.{\circ} ToString(op))
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{64.31} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{64.31} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{64.31} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{64.31} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{64.31} \.{\land} cop
 \.{'} \.{=} cop \.{\,\backslash\,} \{ o \}\@s{8.2}}%
\@y{\@s{0}%
 consume one operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{64.31} \.{\land}
 {\UNCHANGED} sVars}%
\@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}}%
\@y{\@s{7.5}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{20.94} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{52.45} cBuf \.{\defeq}
 cbuf [ c ]\@s{4.1}}%
\@y{\@s{0}%
 the buffer at client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{52.45} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )\@s{4.1}}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{52.45} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{56.55} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xcBuf ]}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{56.55} \.{\land} cstate
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{20.94} \.{\land}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 m \.{\defeq} Head ( sincoming )}%
\@y{\@s{0}%
 the message to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{47.91} c\@s{3.77}
 \.{\defeq} m . c\@s{57.99}}%
\@y{\@s{0}%
 the client \ensuremath{c \.{\in} Client} that sends this message
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{47.91} cBuf \.{\defeq}
 sbuf [ c ]\@s{31.67}}%
\@y{\@s{0}%
 the buffer at the \ensuremath{Server} for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{47.91} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{47.91} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{52.01} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{117.66} \.{\THEN} srec [
 cl ] \.{+} 1}%
\@y{\@s{0}%
 receive one more operation from client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{117.66} \.{\ELSE} 0 ]}%
\@y{\@s{0}%
 reset \ensuremath{srec} for other clients than \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{52.01} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{117.66} {\IF} cl \.{=}
 c}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{117.66} \.{\THEN}
 xcBuf\@s{4.1}}%
\@y{\@s{0}%
 transformed buffer for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{117.66} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xop ) ]}%
\@y{\@s{0}%
 store transformed \ensuremath{xop} into other clients\mbox{'} bufs
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{52.01} \.{\land} sstate
 \.{'} \.{=} Apply ( xop ,\, sstate )\@s{4.1}}%
\@y{\@s{0}%
 apply the transformed operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{52.01} \.{\land} comm
 {\bang} SSend ( c ,\, srec ,\, xop )}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cVars}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 180\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}} QConvergence \.{\defeq}
 \forall\, c \.{\in} Client \.{:} cstate [ c ] \.{=} sstate}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}} QC \.{\defeq} comm {\bang}
 EmptyChannel \.{\implies} QConvergence}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} QC}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 216\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*} Last} modified Sun \ensuremath{Jul} 08
 11:30:24 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
