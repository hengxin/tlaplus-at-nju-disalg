...
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xFormShift ( OT ,\, m . op ,\, cbuf [ c ] ,\, m . ack \.{+} 1
 )\@s{3.58}}%
\@y{\@s{0}%
 [\ensuremath{xop}, \ensuremath{xops}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xform . xops ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{36.79} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} @ \.{+} 1
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( c ,\, xform . xop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} ServerPerform ( m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\LET}\@s{16.4}
 c\@s{8.51} \.{\defeq} m . c}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{40.89} xform \.{\defeq}
 xFormShift ( OT ,\, m . op ,\, sbuf [ c ] ,\, m . ack \.{+} 1 )}%
\@y{\@s{0}%
 [\ensuremath{xop}, \ensuremath{xops}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{49.09} xop\@s{2.28}
 \.{\defeq} xform . xop}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{40.89} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{106.55} {\IF} cl \.{=} c
 \.{\THEN} xform . xops \.{\ELSE} Append ( sbuf [ cl ] ,\, xop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xop )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} \.{\land} Comm
 {\bang} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto} [ ack \.{\mapsto} srec
 [ cl ] ,\, op \.{\mapsto} xop ] ] )}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{26.06} \.{\land}
 SetNewAop ( c ,\, op )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{26.06} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{26.06} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{26.06} \.{\land} Comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Do ( c ) \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
...
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} Spec \.{\defeq} Init
...
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} QC \.{\defeq}}%
\@y{\@s{0}%
 Quiescent Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{20.37} Comm {\bang}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:02:28 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
