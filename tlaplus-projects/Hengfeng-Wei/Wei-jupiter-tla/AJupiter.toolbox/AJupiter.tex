...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} vars \.{\defeq} {\langle}
...
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Msg ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{26.06} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{26.06} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{26.06} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{26.06} \.{\land} Comm (
 Msg ) {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\,
 op \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 ...
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{27.72} \.{\land} chins
 \.{'} \.{=} chins \.{\,\backslash\,} \{ ins . ch \}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{22.34} \.{\lor} DoIns ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{22.34} \.{\lor} DoDel ( c
 )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Msg ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{20.94} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{20.94} \.{\land} \.{\LET}
 m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{52.45} cBuf \.{\defeq}
 cbuf [ c ]\@s{4.1}}%
\@y{\@s{0}%
 the buffer at client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{52.45} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )\@s{4.1}}%
\@y{\@s{0}%
 buffer shifted
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{52.45} xop \.{\defeq}
 XformOpOps ( m . op ,\, cShiftedBuf )}%
\@y{\@s{0}%
 transform \ensuremath{op} vs. shifted buffer
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{56.55} xcBuf \.{\defeq}
 XformOpsOp ( cShiftedBuf ,\, m . op )}%
\@y{\@s{0}%
 transform shifted buffer vs. \ensuremath{op
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xcBuf ]}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{56.55} \.{\land} state
...
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{117.66} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{117.66} \.{\THEN} srec [
 cl ] \.{+} 1}%
\@y{\@s{0}%
 receive one more operation from client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{117.66} \.{\ELSE} 0 ]}%
\@y{\@s{0}%
 reset \ensuremath{srec} for other clients than \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{52.01} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{117.66} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{117.66} \.{\THEN}
 xcBuf\@s{4.1}}%
\@y{\@s{0}%
 transformed buffer for client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{117.66} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xop ) ]}%
\@y{\@s{0}%
 store transformed \ensuremath{xop} into other clients\mbox{'} bufs
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{52.01} \.{\land} state
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{52.01} \.{\land} Comm (
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}} QC \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{20.37} Comm ( Msg )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} QC}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 21:10:51 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
