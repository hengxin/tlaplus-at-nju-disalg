...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} list ,\,\@s{11.41}}%
\@y{\@s{0}%
 all list states across the system
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} chins\@s{8.20}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} eVars \.{\defeq} {\langle}
 chins {\rangle}\@s{105.22}}%
\@y{\@s{0}%
 variables for the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} cVars \.{\defeq} {\langle}
 cbuf ,\, crec ,\, cstate {\rangle}\@s{53.20}}%
\@y{\@s{0}%
 variables for the clients
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} ecVars \.{\defeq} {\langle}
 eVars ,\, cVars {\rangle}\@s{67.32}}%
\@y{\@s{0}%
 variables for the clients and the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} sVars \.{\defeq} {\langle}
 sbuf ,\, srec ,\, sstate {\rangle}\@s{55.24}}%
\@y{\@s{0}%
 variables for the server
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} commVars \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\land} cbuf
 ...
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Int ]}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} List}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{16.4} \.{\land} list
 \.{\in} {\SUBSET} List}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\in} {\SUBSET} Char}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} list
 \.{=} \{ InitState \}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{26.06} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{26.06} \.{\land} list
 \.{'}\@s{5.77} \.{=} list \.{\cup} \{ cstate \.{'} [ c ] \}}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{26.06} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{26.06} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{26.06} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( cstate [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{27.72} \.{\land} ins .
 ch \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{27.72} \.{\land} chins
 \.{'}\@s{0.73} \.{=} chins \.{\,\backslash\,} \{ ins . ch \}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} sVars}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{27.72} \.{\land} del .
 pos \.{\in} 1 \.{\dotdot} Len ( cstate [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{22.34} \.{\lor} DoIns (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{22.34} \.{\lor} DoDel (
 c )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 223\hspace{1em}} Termination \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 224\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} EmptyChannel}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 229\hspace{1em}} WLSpec \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 230\hspace{1em}}\@s{16.4} \.{\land}\@s{8.22}
 Termination \.{\implies} \A\, l1 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 231\hspace{1em}}\@s{114.56} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 232\hspace{1em}}\@s{114.56} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 233\hspace{1em}}\@s{114.56} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 235\hspace{1em}} {\THEOREM} Spec
 \.{\implies} WLSpec}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 239\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 19:34:29 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
