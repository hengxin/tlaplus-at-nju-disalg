...
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} List \.{\defeq} Seq ( Char
 )\@s{8.2}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{32.29} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} Nat \.{\,\backslash\,} \{ 0 \} ] \.{\cup}}%
\@y{\@s{0}%
 a deletion specifies a position (from 1)
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{32.29} [ type \.{:}
 \{\@w{Ins} \} ,\, pos\@s{2.27} \.{:} Nat \.{\,\backslash\,} \{ 0 \} ,\, ch
 \.{:} Char ,\, pr \.{:} Nat ]}%
\@y{\@s{0}%
 an insertion specifies a position (from 1), a character, and a priority
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Nop \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Op\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} Del1 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Del2 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Del3 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Del4 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Ins1\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 1 ,\, ch
 \.{\mapsto}\@w{a} ,\, pr\@s{0.36} \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Ins2\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 2 ,\, ch
 \.{\mapsto}\@w{b} ,\, pr \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Ins3\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 3 ,\, ch
 \.{\mapsto}\@w{c} ,\, pr\@s{0.72} \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Ops \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\LET}
 len\@s{1.07} \.{\defeq} Len ( l )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{36.79} pos \.{\defeq} op
 . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\IN} {\CASE} op
 . type \.{=}\@w{Del} \.{\rightarrow} SubSeq ( l ,\, 1 ,\, pos \.{-} 1 )
 \.{\circ} SubSeq ( l ,\, pos \.{+} 1 ,\, len )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{40.89} {\Box}\@s{14.40}
 op . type \.{=}\@w{Ins}\@s{2.27} \.{\rightarrow} Append ( SubSeq ( l ,\, 1
 ,\, pos \.{-} 1 ) ,\, op . ch ) \.{\circ} SubSeq ( l ,\, pos ,\, len )}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 16:34:55 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
