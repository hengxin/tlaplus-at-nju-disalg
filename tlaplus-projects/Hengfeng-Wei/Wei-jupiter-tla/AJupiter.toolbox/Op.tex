...
\@y{%
 \ensuremath{LegalizeOp(op,\, l) \.{\defeq} {\CASE} op.type \.{=} \@w{Del}
 \.{\rightarrow}} [\ensuremath{op} \ensuremath{{\EXCEPT} {\bang}.pos \.{=}
 Min(@,\, Len(l))}]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}}%
\@y{\@s{52.5}%
 \ensuremath{{\Box} op.type \.{=} \@w{Ins} \.{\rightarrow}} [\ensuremath{op}
 \ensuremath{{\EXCEPT} {\bang}.pos \.{=} Min(@,\, Len(l) \.{+} 1)}]
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:11:21 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
