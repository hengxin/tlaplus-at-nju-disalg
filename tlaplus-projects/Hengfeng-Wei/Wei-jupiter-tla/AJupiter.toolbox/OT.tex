...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} XformII ( lins ,\, rins )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} {\IF} lins . pos
 \.{<} rins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\THEN} lins}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 lins . pos \.{>} rins . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{47.71} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{47.71} \.{\ELSE} {\IF}
 lins . ch \.{=} rins . ch}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{79.02} \.{\THEN} Nop}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{79.02} \.{\ELSE} {\IF}
 lins . pr \.{>} rins . pr}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{110.33} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{110.33} \.{\ELSE} lins}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} XformID ( ins ,\, del )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} {\IF} ins . pos
 \.{\leq} del . pos}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\THEN} ins}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\ELSE} [ ins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} XformDI ( del ,\, ins )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} {\IF} del . pos
 \.{<} ins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\THEN} del}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\ELSE} [ del
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} XformDD ( ldel ,\, rdel )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} {\IF} ldel . pos
 \.{<} rdel . pos}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\THEN} ldel}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 ldel . pos \.{>} rdel . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{47.71} \.{\THEN} [ ldel
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{47.71} \.{\ELSE} Nop}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} Xform ( lop ,\, rop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} {\CASE} lop \.{=}
 Nop \.{\lor} rop \.{=} Nop \.{\rightarrow} lop}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{28.69} {\Box}\@s{4.1} lop
 . type \.{=}\@w{Ins}\@s{2.27} \.{\land} rop . type \.{=}\@w{Ins}\@s{2.27}
 \.{\rightarrow} XformII ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
 lop . type \.{=}\@w{Ins}\@s{2.27} \.{\land} rop . type \.{=}\@w{Del}
 \.{\rightarrow} XformID ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
 lop . type \.{=}\@w{Del} \.{\land} rop . type \.{=}\@w{Ins}\@s{2.27}
 \.{\rightarrow} XformDI ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} {\RECURSIVE} XformOpOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} XformOpOps ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{32.65} \.{\THEN} op}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} {\RECURSIVE} XformOpOpsX (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} XformOpOpsX ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{32.65} \.{\THEN}
 {\langle} op {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} XformOpsOp ( ops ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{16.4} \.{\LET} opX
 \.{\defeq} XformOpOpsX ( op ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\IN} [ i \.{\in}
 1 \.{\dotdot} Len ( ops ) \.{\mapsto} Xform ( ops [ i ] ,\, opX [ i ] ) ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}} {\RECURSIVE} XformOpsOps (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} XformOpsOps ( ops1 ,\, ops2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} {\IF} ops2 \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\THEN} ops1}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{16.4} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} CP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{19.96} \A\, l \.{\in}
 List ,\, op1 \.{\in} Op ,\, op2 \.{\in} Op \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{31.28}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} PrintT(ToString(l) \.{\circ} \@w{, } \.{\circ}
 ToString(op1) \.{\circ} \@w{, } \.{\circ} ToString(op2))
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{51.78}}%
\@y{\@s{0}%
 It is not allowed to delete elements from an empty list.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{31.28} \.{\land}
 \.{\lor} ( l \.{=} {\langle} {\rangle} \.{\land} ( op1 . type \.{=}\@w{Del}
 \.{\lor} op2 . type \.{=}\@w{Del} ) )}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Priorities of these two insertions cannot be the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op2 . type \.{=}\@w{Ins} \.{\land} op1 . pr
 \.{=} op2 . pr )}%
\@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Position of an insertion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op1 . pos \.{>} Len ( l ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{42.39} \.{\lor} ( op2 .
 type \.{=}\@w{Ins} \.{\land} op2 . pos \.{>} Len ( l ) \.{+} 1 )}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Position of a deletion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Del} \.{\land} op1 . pos \.{>} Len ( l ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{42.39} \.{\lor} ( op2 .
 type \.{=}\@w{Del} \.{\land} op2 . pos \.{>} Len ( l ) )}%
\@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 The \ensuremath{CP1} itself.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{42.39} \.{\lor} ApplyOps
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}} GCP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{16.4} \A\, l \.{\in}
 List ,\, ops1 \.{\in} SeqMaxLen ( Op ,\, 1 ) ,\, ops2 \.{\in} SeqMaxLen ( Op
 ,\, 1 ) \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{27.72}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor}} (\ensuremath{Head(ops1).type \.{=} \@w{Del} \.{\lor}
 Head(ops2).type \.{=} \@w{Del}})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{27.72} \.{\lor} ApplyOps
 ( ops1 \.{\circ} XformOpsOps ( ops2 ,\, ops1 ) ,\, l ) \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{38.83} ApplyOps ( ops2
 \.{\circ} XformOpsOps ( ops1 ,\, ops2 ) ,\, l )}%
\@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 06 15:14:55 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
