...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} Naturals ,\, Op}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\VARIABLES}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
Messages between the \ensuremath{Server} and the Clients.
 ...
 \ensuremath{TODO}: Abstraction from the concrete representation of messages.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Msg \.{\defeq} [ c \.{:}
 Client ,\, ack \.{:} Nat ,\, op \.{:} Op \.{\cup} \{ Nop \} ] \.{\cup}}%
\@y{\@s{0}%
 messages sent to the \ensuremath{Server} from a client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{37.42} [ ack \.{:} Nat
 ,\, op \.{:} Op \.{\cup} \{ Nop \} ]}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 cincoming \.{\in} [ Client \.{\rightarrow} Seq ( Msg ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{56.14} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Init \.{\defeq} \.{\land}
 cincoming \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{35.70} \.{\land}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} CSend ( msg ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Append ( sincoming ,\, msg )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cincoming}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A client receives a message from the \ensuremath{Server}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} CRev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{24.21} \.{\land}
 cincoming [ c ] \.{\neq} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 there are messages to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{24.21} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{24.21} \.{\land}
 {\UNCHANGED} sincoming}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{SRev} and \ensuremath{SSend} below will be used together in one
 subaction.
 Therefore, there are no \ensuremath{{\UNCHANGED}} sub-formulas
 in their definitions.
\end{cpar}%
\end{lcom}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The \ensuremath{Server} receives a message from some clinet \ensuremath{c
 \.{\in} Client}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}\@s{12.29}}%
\@y{\@s{0}%
 there are messages for the \ensuremath{Server} to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@y{\@s{0}%
 consume a message
}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} broadcasts messages to the Clients
 other than \ensuremath{c \.{\in} Client}.
 The ``\ensuremath{ack}'' parts of the messages [\ensuremath{ack}:
 \ensuremath{Nat}, \ensuremath{op}: \ensuremath{Op}] broadcast
 are determined by the parameter ``\ensuremath{acks}''.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} SSend ( c ,\, acks ,\, xop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{99.45} \.{\ELSE} Append (
 cincoming [ cl ] ,\, [ ack \.{\mapsto} acks [ cl ] ,\, op \.{\mapsto} xop ]
 ) ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} EmptyChannel \.{\defeq}
 Init}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 15:53:20 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
