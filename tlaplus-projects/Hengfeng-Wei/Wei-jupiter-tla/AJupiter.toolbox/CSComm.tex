...
\end{lcom}%
 ...
 Naturals ,\, AdditionalSequenceOperators}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Msg}%
...
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} TypeOK \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land} cincoming
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} CSend ( msg ) \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} CRev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{24.21} \.{\land}
 cincoming [ c ] \.{\neq} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 there are messages to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{24.21} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{24.21} \.{\land}
 {\UNCHANGED} sincoming}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}\@s{12.29}}%
\@y{\@s{0}%
 there are messages for the \ensuremath{Server} to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@y{\@s{0}%
 consume a message
}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The \ensuremath{Server} sents a message to each client other than
 \ensuremath{c \.{\in} Client}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} SSend ( c ,\, cmsg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{99.45} \.{\ELSE} Append (
 cincoming [ cl ] ,\, cmsg [ cl ] ) ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} broadcasts the same message to all the Clients
 other than \ensuremath{c \.{\in} Client}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} SSendSame ( c ,\, msg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} SSend ( c
 ,\, [ cl \.{\in} Client \.{\mapsto} msg ] )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} EmptyChannel \.{\defeq}
 Init}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 13:31:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
