...
\ensuremath{AJupiter} with a history of all list states across the system.
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} AJupiter}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Termination \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} EmptyChannel}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} WLSpec \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}\@s{8.22}
 Termination \.{\implies} \A\, l1 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{114.56} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{114.56} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{114.56} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} {\THEOREM} SpecH
 \.{\implies} WLSpec}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 30 21:44:27 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
