...
\@pvspace{8.0pt}%
 ...
 Sequences ,\, TLC}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} PosInt \.{\defeq} Nat
 \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\CONSTANT} Nil}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} NilSet \.{\defeq} \{ Nil \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} NilOr ( set ) \.{\defeq} \{
 Nil \} \.{\cup} set}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} SetHasMinElement ( set ,\,
 min ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{8.2} \.{\land} min
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{8.2} \.{\land} ( \A\, el
 \.{\in} set \.{:} min \.{\leq} el )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} SetHasMaxElement ( set ,\,
 max ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{8.2} \.{\land} max
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{8.2} \.{\land} ( \A\, el
 \.{\in} set \.{:} max \.{\geq} el )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} MinElement ( set )\@s{1.06}
 \.{\defeq} {\CHOOSE} min\@s{1.49} \.{\in} set \.{:} ( \A\, el \.{\in} set
 \.{:} min \.{\leq} el )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} MaxElement ( set )
 \.{\defeq} {\CHOOSE} max \.{\in} set \.{:} ( \A\, el \.{\in} set \.{:} max
 \.{\geq} el )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 06 13:15:21 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
