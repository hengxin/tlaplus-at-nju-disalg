...
\setboolean{shading}{true}
 ...
 {\MODULE} XJupiterSS}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Note: This spec has been deprecated.
 It has done a simple task in a rather complicated \ensuremath{way.done
} See the \ensuremath{CSSync} property defined in \ensuremath{XJupiter}.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Specification of \ensuremath{XJupiter} with properties about \ensuremath{2D}
 state spaces.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\EXTENDS} XJupiter}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} roid\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{roid[r]}: the set of operations, represented by their oids,
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{46.72}}%
\@y{\@s{0}%
 that have been processed by replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} varsSS \.{\defeq} {\langle}
 vars ,\, roid {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} TypeOKSS \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} roid
 \.{\subseteq} Oid}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} InitSS \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}\@s{0.79}
 Init}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land}\@s{0.79}
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} DoSS ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{25.10} \.{\land} Do ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{25.10} \.{\land} roid
 \.{'} \.{=} [ roid {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\cup} \{ [ c
 \.{\mapsto} c ,\, seq \.{\mapsto} cseq \.{'} [ c ] ] \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} RevSS ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} Rev ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} roid {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} SRevSS \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land}\@s{6.53}
 SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}\@s{6.53}
 \.{\LET} cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{38.14} \.{\IN} roid \.{'}
 \.{=} [ roid {\EXCEPT} {\bang} [ Server ] \.{=} @ \.{\cup} \{ cop . oid \}
 ]}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} NextSS \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\lor}\@s{4.92}
 \E\, c \.{\in} Client \.{:} DoSS ( c ) \.{\lor} RevSS ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\lor}\@s{4.92}
 SRevSS}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{SpecSS}. (\ensuremath{TODO}: Check the fairness condition.)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} SpecSS \.{\defeq} InitSS
 \.{\land} {\Box} [ NextSS ]_{ varsSS} \.{\land} {\WF}_{ vars} ( NextSS )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 11 18:00:45 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Oct} 11
 17:38:47 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
