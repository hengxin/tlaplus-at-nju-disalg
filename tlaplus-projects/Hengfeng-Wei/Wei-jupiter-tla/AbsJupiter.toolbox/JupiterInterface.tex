...
This module declares the parameters and defines the operators that describe
 the interface of a family of \ensuremath{Jupiter} specs.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} SequenceUtils ,\,
 OT}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Msg ,\,\@s{25.13}}%
\@y{\@s{0}%
 the set of messages
}%
\@xx{}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} {\ASSUME}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 Range ( InitState ) \.{\cap} Char \.{=} \{ \}\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} aop ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{op[r]}: the actual operation applied at replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} state ,\,\@s{7.06}}%
\@y{\@s{0}%
 \ensuremath{state[r]}: state (the list content) of replica \ensuremath{r
 \.{\in} Replica
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
 incoming channel at the \ensuremath{Server
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
 a set of chars allowed to insert; this is for model checking
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} intVars \.{\defeq} {\langle}
 aop ,\, state ,\, cincoming ,\, sincoming ,\, chins {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} List \.{\defeq} Seq ( Char
 \.{\cup} Range ( InitState ) )\@s{42.53}}%
\@y{\@s{0}%
 all possible lists
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} MaxLen \.{\defeq}
 Cardinality ( Char ) \.{+} Len ( InitState )}%
\@y{\@s{0}%
 the max length of lists in any state
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} ClientNum \.{\defeq}
 Cardinality ( Client )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Priority \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} SetNewAop ( r ,\, aopr )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} aop \.{'} \.{=} [
 aop {\EXCEPT} {\bang} [ r ] \.{=} aopr ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} ApplyNewAop ( r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT} {\bang} [ r ] \.{=} Apply ( aop \.{'} [ r ] ,\, @ ) ]}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} TypeOKInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} aop
 \.{\in} [ Replica \.{\rightarrow} Op \.{\cup} \{ Nop \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land} state
 \.{\in} [ Replica \.{\rightarrow} List ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} InitInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} aop \.{=}
 [ r \.{\in} Replica \.{\mapsto} Nop ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} state
 \.{=} [ r \.{\in} Replica \.{\mapsto} InitState ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} DoIns ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} generates an \ensuremath{\@w{Ins}}
 operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{27.72} \.{\land} ins . ch
 \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} DoDel ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} generates a \ensuremath{\@w{Del}}
 operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{27.72} \.{\land} del .
 pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} DoInt ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} issues an operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 DoIns ( DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{27.51} \.{\lor} DoDel (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\land}
 ApplyNewAop ( c )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} RevInt ( ClientPerformInt (
 \_ ,\, \_ ) ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} receives and processes a message.
}%
\@xx{}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} SRevInt ( ServerPerformInt (
 \_ ) ) \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} receives and processes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 Comm {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 ServerPerformInt ( Head ( sincoming ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 ApplyNewAop ( Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\land}\@s{7.84}
 {\UNCHANGED} chins}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 19:01:18 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Dec} 04
 19:01:01 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
