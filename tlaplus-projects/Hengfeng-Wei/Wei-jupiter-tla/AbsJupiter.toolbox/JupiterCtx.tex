...
\@xx{}%
 ...
 @ \.{\cup} \{ rcop . oid \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} UpdateDS ( r ,\, oid )
 \.{\defeq}}%
\@y{\@s{0}%
 update \ensuremath{ds} to include new \ensuremath{oid \.{\in} Oid
}}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, [ c \.{\mapsto} c ,\, seq \.{\mapsto} cseq \.{'} [ c ] ] )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 28 11:02:31 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
