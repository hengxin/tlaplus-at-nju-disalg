...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} COT ( lcop ,\, rcop )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{OT} of two \ensuremath{Cop(s)}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{27.19} [ lcop {\EXCEPT}
 {\bang} . op \.{=} Xform ( lcop . op ,\, rcop . op ) ,\, {\bang} . ctx \.{=}
 @ \.{\cup} \{ rcop . oid \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} UpdateDS ( r ,\, cop )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} ds \.{'} \.{=} [ ds
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ cop . oid \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} TypeOKCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} ds
 \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} InitCtx \.{\defeq}}%
 ...
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} RevCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, Head ( cincoming [ c ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} SRevCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 22:21:38 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
