...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} SystemModel}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{:} Injective ( f )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} MaxLen \.{\defeq} Cardinality
 ( Char ) \.{+} Len ( InitState )}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
\@y{\@s{0}%
 The positions (\ensuremath{pos}) are indexed from 1.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
 type \.{:} \{\@w{Ins} \} ,\, pos\@s{2.27} \.{:} 1 \.{\dotdot} ( MaxLen \.{+}
 1 ) ,\, ch \.{:} Char ,\, pr \.{:} Range ( Priority ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Nop \.{\defeq} PickNone ( Op
 )}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq}}%
\@y{\@s{0}%
 Apply operation \ensuremath{op} on list \ensuremath{l}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} {\CASE} op \.{=}
 Nop \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{24.59} {\Box}\@s{10.30}
 op . type \.{=}\@w{Rd} \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{24.59} {\Box}\@s{10.30}
 op . type \.{=}\@w{Del} \.{\rightarrow} DeleteElement ( l ,\, op . pos )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{24.59} {\Box}\@s{10.30}
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{265.34}}%
\@y{\@s{0}%
 if \ensuremath{op.pos \.{=} Len(l) \.{+} 1
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 14 17:25:29 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
