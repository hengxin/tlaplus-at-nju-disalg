...
\setboolean{shading}{true}
 ...
 {\MODULE} Order}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
See https:\ensuremath{\.{\slsl}github.com}/jameshfisher/tlaplus/blob/master/examples/\ensuremath{TransitiveClosure}/\ensuremath{TransitiveClosure.tla
}%
\end{cpar}%
\end{lcom}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Domain of relation \ensuremath{R}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Dom ( R ) \.{\defeq} \{ a
 \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Support of relation \ensuremath{R}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Support ( R ) \.{\defeq} \{
 r [ 1 ] \.{:} r \.{\in} R \} \.{\cup} \{ r [ 2 ] \.{:} r \.{\in} R \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Inverse of relation \ensuremath{R}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} Inverse ( R ) \.{\defeq} \{
 {\langle} b ,\, a {\rangle} \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} LT ( R ,\, a ) \.{\defeq} \{
 \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Is \ensuremath{R} a reflexive relation on set \ensuremath{S}\.{?}
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Reflexive ( S ,\, R )
 \.{\defeq} \forall\, a \.{\in} S \.{:} {\langle} a ,\, a {\rangle} \.{\in}
 R}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Is \ensuremath{R} a transitive relation (on its support set)\.{?}
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Transitive ( R ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\LET} S
 \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\IN} \forall\, a
 ,\, b ,\, c \.{\in} S \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{53.19} ( {\langle} a ,\,
 b {\rangle} \.{\in} R \.{\land} {\langle} b ,\, c {\rangle} \.{\in} R )
 \.{\implies} {\langle} a ,\, c {\rangle} \.{\in} R}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Composition of two relations \ensuremath{R} and \ensuremath{T}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} R \.{\stst} T \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{15.88} \.{\LET}
 SR\@s{4.90} \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{40.38} ST \.{\defeq}
 Support ( T )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{15.88} \.{\IN}\@s{4.09}
 \{ {\langle} r ,\, t {\rangle} \.{\in} SR \.{\times} ST \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{54.56} \E\, s \.{\in} SR
 \.{\cap} ST \.{:} ( {\langle} r ,\, s {\rangle} \.{\in} R ) \.{\land} (
 {\langle} s ,\, t {\rangle} \.{\in} T ) \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Transitive closure of relation \ensuremath{R}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} {\RECURSIVE} TC ( \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} TC ( R ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{27.33} \.{\LET} RR
 \.{\defeq} R \.{\stst} R}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{27.33} \.{\IN} {\IF} RR
 \.{\subseteq} R \.{\THEN} R \.{\ELSE} TC ( R \.{\cup} RR )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 25 17:21:26 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
