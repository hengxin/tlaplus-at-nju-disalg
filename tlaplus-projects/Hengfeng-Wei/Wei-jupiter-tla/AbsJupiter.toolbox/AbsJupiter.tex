...
Abstract \ensuremath{Jupiter
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} Naturals ,\, Order
 ,\, AdditionalSequenceOperators}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Client ,\,\@s{1.66}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} O ,\,\@s{20.32}}%
\@y{\@s{0}%
 the set of original operations
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} co ,\,\@s{19.10}}%
\@y{\@s{0}%
 the client order in which each client generates its operations
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} so ,\,\@s{19.10}}%
\@y{\@s{0}%
 the server order in which the server processes operations
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} hb\@s{24.70}}%
\@y{\@s{0}%
 the happened-before relation
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
\@y{\@s{0}%
 all replicas
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} sigma \.{\defeq} [ O
 \.{\mapsto} O ,\, co \.{\mapsto} co ,\, so \.{\mapsto} so ,\, hb \.{\mapsto}
 hb ]}%
\@y{\@s{0}%
 the schedule
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} O
 \.{\subseteq} Client \.{\times} Nat\@s{37.17}}%
\@y{\@s{0}%
 \ensuremath{oid \.{=}} (\ensuremath{c}, \ensuremath{n})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} co
 \.{\in} [ Client \.{\rightarrow} Seq ( O ) ]\@s{12.30}}%
\@y{\@s{0}%
 strict total order (for each client) represented by sequence
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} so
 \.{\in} Seq ( O )\@s{28.7}}%
\@y{\@s{0}%
 strict total order represented by sequence
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land} hb
 \.{\subseteq} O \.{\times} O\@s{30.33}}%
\@y{\@s{0}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The restriction of \ensuremath{co} to operations generated by \ensuremath{c
 \.{\in} Client}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{R \.{\,|\,} c \.{\defeq} \{{\langle}o1,\, o2{\rangle} \.{\in}
 R\.{:} o1.c \.{=} c \.{\land} o2.c \.{=} c\}
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Res ( csched ,\, oset )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{20.18} [ O \.{\mapsto}
 oset ,\, co \.{\mapsto} Retain ( csched . co ,\, oset ) ,\, so \.{\mapsto}
 Retain ( csched . so ,\, oset ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{22.95} hb \.{\mapsto}
 csched . hb \.{\,|\,} oset ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Determine the \ensuremath{eo} order at client \ensuremath{c
}%
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} {\RECURSIVE} EOR ( \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} EOR ( csigma ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{26.02} {\IF} PrintT (
 csigma ) \.{\land} csigma . co \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{26.02} \.{\THEN} csigma .
 so}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{26.02} \.{\ELSE}
 \.{\LET}\@s{4.1} o\@s{9.19} \.{\defeq} Head ( csigma . co )}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{81.83} hbo \.{\defeq} LT
 ( hb ,\, o )\@s{12.29}}%
\@y{\@s{0}%
 the set of operation happened-before \ensuremath{o
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{61.43} \.{\IN} Retain (
 csigma . so ,\, hbo )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{94.13} \.{\circ}\@s{7.52}
 {\langle} o {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{94.13} \.{\circ}\@s{7.52}
 EOR ( Res ( csigma ,\, csigma . O \.{\,\backslash\,} \{ hbo ,\, o \} ) )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{eo}: execution order, a function mapping each replica
 \ensuremath{r \.{\in} Replica} to
 the order in which the operations are processed at each \ensuremath{r}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} eo \.{\defeq} [ r \.{\in}
 Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{35.59} {\IF} r \.{=}
 Server}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{35.59} \.{\THEN} so}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{35.59} \.{\ELSE} EOR ( [
 sigma {\EXCEPT} {\bang} . co \.{=} @ [ r ] ] ) ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 25 20:09:17 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Aug} 20
 20:23:41 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
