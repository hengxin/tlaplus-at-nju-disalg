...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ )\@s{8.2}}%
\@y{\@s{0}%
 Transform cop at replica \ensuremath{r \.{\in} Replica}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} xForm ( r ,\, cop )
 \.{\defeq}\@s{30.83}}%
\@y{\@s{0}%
 Return the transformed cop and the state space \ensuremath{copss[r]} after
 transformation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\LET} ctxDiff
...
\@xx{}%
 ...
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{40.89} xFormHelper ( coph
 ,\, ctxDiffh ,\, copssr ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{57.29} {\IF} ctxDiffh
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{159.36} \A\, opprime
 \.{\in} ctxDiffh \.{\,\backslash\,} \{ op \} \.{:} tb ( op ,\, opprime ,\,
 serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{109.01} fcophDict
 \.{\defeq} \{ op \.{\in} copssr \.{:} op . oid \.{=} foph \.{\land} op . ctx
 \.{=} coph . ctx \}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{109.01} fcoph\@s{1.57}
 \.{\defeq} {\CHOOSE} op \.{\in} fcophDict \.{:} {\TRUE}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: \ensuremath{Cardinality(fophDict) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{109.01} xcoph \.{\defeq}
 COT ( coph ,\, fcoph )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{100.91} xfcoph\@s{5.03}
 \.{\defeq} COT ( fcoph ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.1}
 xFormHelper ( xcoph ,\, ctxDiffh \.{\,\backslash\,} \{ foph \} ,\, copssr
 \.{\cup} \{ xcoph ,\, xfcoph \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( cop ,\, ctxDiff ,\, copss [ r ] \.{\cup} \{ cop \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( r ,\, cop )\@s{4.1}}%
\@y{\@s{0}%
 [\ensuremath{xcop}, \ensuremath{xcopss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 copss \.{'} \.{=} [ copss {\EXCEPT} {\bang} [ r ] \.{=} xform . xcopss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( r ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq} Perform ( c ,\, cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} Comm
 {\bang} SSendSame ( ClientOf ( cop ) ,\, cop )}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{26.06} \.{\IN} \.{\land}
 ClientPerform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{46.46} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
...
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} SRev \.{\defeq}}%
 ...
 ServerPerform )}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:28:25 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
