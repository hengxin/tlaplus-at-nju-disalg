...
\@xx{}%
 ...
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{57.58} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} chins}%
...
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} SRev \.{\defeq}}%
 ...
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 Perform ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{52.01} \.{\land} Comm (
 Cop ) {\bang} SSendSame ( cop . oid . c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
...
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}} Spec \.{\defeq} Init
...
\@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} Comm ( Cop )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( copss ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} {\THEOREM} Spec
 \.{\implies} Compactness}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 22:10:07 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
