...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} {\RECURSIVE} EOR ( \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} EOR ( csigma ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{26.02} {\IF} csigma . co
 \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{26.02} \.{\THEN} csigma .
 so}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{26.02} \.{\ELSE} \.{\LET}
 o \.{\defeq} Head ( csigma . co )}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{61.43} \.{\IN} {\FALSE}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} eo \.{\defeq} [ r \.{\in}
 Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{35.59} {\IF} r \.{=}
 Server}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{35.59} \.{\THEN} so}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{35.59} \.{\ELSE} EOR ( [
 sigma {\EXCEPT} {\bang} . co \.{=} co [ r ] ] ) ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 25 17:05:12 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
