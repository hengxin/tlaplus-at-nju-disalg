...
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 ...
 Cop ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} copss
 \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\LET} ctxDiff
 \.{\defeq} ds [ r ] \.{\,\backslash\,} cop . ctx\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: \ensuremath{cop.ctx \.{\subseteq} ds[r]
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{40.89} xFormHelper ( coph
 ,\, ctxDiffh ,\, copssr ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 \mbox{'}h\mbox{'} stands for ``helper''
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{57.29} {\IF} ctxDiffh
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{57.29} \.{\THEN}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{159.36} \A\, opprime
 \.{\in} ctxDiffh \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{170.68} opprime \.{\neq}
 op \.{\implies} tb ( op ,\, opprime ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{109.01} fcophDict
 \.{\defeq} \{ op \.{\in} copssr \.{:} op . oid \.{=} foph \.{\land} op . ctx
 \.{=} coph . ctx \}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{109.01} fcoph\@s{2.00}
 \.{\defeq} {\CHOOSE} op \.{\in} fcophDict \.{:} {\TRUE}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: \ensuremath{Cardinality(fophDict) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{109.01} cophx \.{\defeq}
 COT ( coph ,\, fcoph )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{113.11} fcophx \.{\defeq}
 COT ( fcoph ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{92.71} \.{\IN}
 xFormHelper ( cophx ,\, ctxDiffh \.{\,\backslash\,} \{ foph \} ,\, copssr
 \.{\cup} \{ cophx ,\, fcophx \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{20.5} \.{\IN} xFormHelper
 ( cop ,\, ctxDiff ,\, copss [ r ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Perform ( cop ,\, r )
 \.{\defeq}}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{40.89} xcopssr \.{\defeq}
 xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{20.5} \.{\IN} \.{\land}
 state \.{'}\@s{2.11} \.{=} [ state {\EXCEPT} {\bang} [ r ]\@s{2.11} \.{=}
 Apply ( xcop . op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} \.{\land} copss
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{26.06} \.{\land} \.{\LET}
 cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{37.18} \.{\IN} \.{\land}
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 ...
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 Perform ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{52.01} \.{\land} Comm (
 Cop ) {\bang} SSendSame ( cop . oid . c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} Spec \.{\defeq} Init
...
\@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{16.4} Comm ( Cop )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( copss ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} {\THEOREM} Spec
 \.{\implies} Compactness}%
\@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 28 10:57:04 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
