...
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} cseq ,\,\@s{8.2}}%
\@y{\@s{0}%
 \ensuremath{cseq[c]}: local sequence number at client \ensuremath{c \.{\in}}
 client
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} ds ,\,\@s{16.44}}%
\@y{\@s{0}%
 \ensuremath{ds[r]}: document state at replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} copss\@s{9.26}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 intVars ,\, serialVars ,\, cseq ,\, ds ,\, copss {\rangle}}%
...
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
 ...
 Cop ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} ds \.{=}
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} copss
 \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\LET} ctxDiff
...
\@xx{}%
 ...
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{40.89} xFormHelper ( coph
 ,\, ctxDiffh ,\, copssr ) \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 \mbox{'}h\mbox{'} stands for ``helper''
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{57.29} {\IF} ctxDiffh
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{57.29} \.{\THEN}
 {\langle} coph ,\, copssr \.{\cup} \{ coph \} {\rangle}}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{159.36} \A\, opprime
 \.{\in} ctxDiffh \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{170.68} opprime \.{\neq}
 op \.{\implies} tb ( op ,\, opprime ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{109.01} fcophDict
 \.{\defeq} \{ op \.{\in} copssr \.{:} op . oid \.{=} foph \.{\land} op . ctx
 \.{=} coph . ctx \}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{109.01} fcoph\@s{2.00}
 \.{\defeq} {\CHOOSE} op \.{\in} fcophDict \.{:} {\TRUE}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}}: \ensuremath{Cardinality(fophDict) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{109.01} cophx \.{\defeq}
 COT ( coph ,\, fcoph )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{113.11} fcophx \.{\defeq}
 COT ( fcoph ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{92.71} \.{\IN}
 xFormHelper ( cophx ,\, ctxDiffh \.{\,\backslash\,} \{ foph \} ,\, copssr
 \.{\cup} \{ cophx ,\, fcophx \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{20.5} \.{\IN} xFormHelper
 ( cop ,\, ctxDiff ,\, copss [ r ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} Perform ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, r )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{{\langle}xcop,\, xcopss{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{40.89} xcopssr \.{\defeq}
 xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{20.5} \.{\IN} \.{\land}
 state \.{'} \.{=} [ state {\EXCEPT} {\bang} [ r ] \.{=} Apply ( xcop . op
 ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{40.89} \.{\land} ds \.{'}
 \.{=} [ ds {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ cop . oid \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} \.{\land} copss
 \.{'} \.{=} [ copss {\EXCEPT} {\bang} [ r ] \.{=} xcopssr ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{26.06} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{26.06} \.{\land} \.{\LET}
 cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{37.18} \.{\IN} \.{\land}
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
...
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
...
\@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} Comm ( Cop )
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 08
 17:34:44 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
