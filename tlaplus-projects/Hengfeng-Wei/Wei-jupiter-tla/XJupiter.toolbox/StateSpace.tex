...
\setboolean{shading}{true}
 ...
 {\MODULE} StateSpace}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\@xx{}%
 ...
 cop \.{:} Cop ]}%
\@y{\@s{0}%
 Each edge is labeled with a \ensuremath{Cop} operation.
}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
\@y{\@s{0}%
 Locate the (unique) node in state space \ensuremath{ss} that matches the
 context of cop.
}%
\@xx{}%
...
\@y{%
 \ensuremath{{\RECURSIVE}} \ensuremath{ExtractCopSeq(\_,\, \_,\, \_,\, \_)
 \.{\,\backslash\,}}* Extract a \ensuremath{Cop} sequence starting with
 \ensuremath{u} in \ensuremath{ss} at replica \ensuremath{r}.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}%
\@y{%
 \ensuremath{ExtractCopSeq(NextEdge(\_,\, \_,\, \_),\, r,\, u,\, ss)
 \.{\defeq}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{{\IF}} \ensuremath{u \.{=} ds[r] \.{\THEN} {\langle}{\rangle}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\ELSE} \.{\LET} e \.{\defeq} NextEdge(r,\, u,\, ss)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}}%
\@y{\@s{20.0}%
 \ensuremath{\.{\IN} {\langle}e.cop{\rangle} \.{\circ}
 ExtractCopSeq(NextEdge,\, r,\, e.to,\, ss)
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} xForm ( NextEdge ( \_ ,\, \_
 ,\, \_ ) ,\, r ,\, cop ,\, ss ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{57.29} {\IF} uh \.{=} ds
 [ r ] \.{\THEN} [ xcop \.{\mapsto} coph ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{148.99} xss \.{\mapsto}
 xss ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{148.99} lss\@s{2.08}
 \.{\mapsto} [ node \.{\mapsto} \{ vh \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{180.96} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto} vh ,\, cop
 \.{\mapsto} coph ] \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 e \.{\defeq} NextEdge ( r ,\, uh ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{109.01} copprime
 \.{\defeq} e . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{109.01} uprime \.{\defeq}
 e . to}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{109.01} vprime\@s{0.76}
 \.{\defeq} vh \.{\cup} \{ copprime . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{109.01}
 coph2copprime\@s{4.10} \.{\defeq} COT ( coph ,\, copprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{113.11} copprime2coph
 \.{\defeq} COT ( copprime ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.09}
 xFormHelper ( uprime ,\, vprime ,\, coph2copprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{125.41} xss \.{\oplus} [
 node \.{\mapsto} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{154.04} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\, cop
 \.{\mapsto} copprime2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{195.28} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto}
 coph2copprime ] \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
...
\@y{%
 \ensuremath{xFormCopCopsSS(cop,\, cops) \.{\defeq} \.{\,\backslash\,}}*
 Transform cop against cops (a sequence of \ensuremath{Cop}) on state space.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\LET} {\RECURSIVE}} \ensuremath{xFormCopCopsSSHelper(\_,\,
 \_,\, \_)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{xFormCopCopsSSHelper(coph,\, copsh,\, xss) \.{\defeq}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}}%
\@y{\@s{27.5}%
 \ensuremath{\.{\LET} u \.{\defeq} coph.ctx
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}}%
\@y{\@s{37.5}%
 \ensuremath{v \.{\defeq} u \.{\cup} \{coph.oid\}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}}%
\@y{\@s{30.0}%
 \ensuremath{uvSS \.{\defeq}} [\ensuremath{node \.{\mapsto} \{u,\, v\}},
 \ensuremath{edge \.{\mapsto} \{[from \.{\mapsto} u,\, to \.{\mapsto} v,\,
 cop \.{\mapsto} coph]\}}]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}}%
\@y{\@s{30.0}%
 \ensuremath{\.{\IN} {\IF}} \ensuremath{copsh \.{=} {\langle}{\rangle}
 \.{\THEN}} [\ensuremath{xcop \.{\mapsto} coph}, \ensuremath{xss \.{\mapsto}
 xss \.{\oplus} uvSS}, \ensuremath{lss \.{\mapsto} uvSS}]
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}}%
\@y{\@s{37.5}%
 \ensuremath{\.{\ELSE} \.{\LET} copprimeh \.{\defeq} Head(copsh)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}}%
\@y{\@s{67.5}%
 \ensuremath{uprime \.{\defeq} u \.{\cup} \{copprimeh.oid\}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}}%
\@y{\@s{67.5}%
 \ensuremath{vprime \.{\defeq} u \.{\cup} \{coph.oid,\, copprimeh.oid\}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}}%
\@y{\@s{60.0}%
 \ensuremath{coph2copprimeh \.{\defeq} COT(coph,\, copprimeh)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}}%
\@y{\@s{60.0}%
 \ensuremath{copprimeh2coph \.{\defeq} COT(copprimeh,\, coph)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}%
\@y{\@s{52.5}%
 \ensuremath{\.{\IN} xFormCopCopsSSHelper(coph2copprimeh,\, Tail(copsh),\,
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}}%
\@y{\@s{67.5}%
 \ensuremath{xss \.{\oplus}} [\ensuremath{node \.{\mapsto} \{u,\, v\}},
}%
\@xx{}%
...
\@y{\@s{115.0}%
 [\ensuremath{from \.{\mapsto} u}, \ensuremath{to \.{\mapsto} uprime},
 \ensuremath{cop \.{\mapsto} copprimeh}],
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}}%
\@y{\@s{115.0}%
 [\ensuremath{from \.{\mapsto} v}, \ensuremath{to \.{\mapsto} vprime},
 \ensuremath{cop \.{\mapsto} copprimeh2coph}]\ensuremath{\}}])
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\IN} xFormCopCopsSSHelper(cop,\, cops,\, EmptySS)
}}%
\@xx{}%
...
\@y{%
 \ensuremath{xFormSS(cop,\, copprime) \.{\defeq} \.{\,\backslash\,}}*
 Transform cop against \ensuremath{copprime} on state space.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\LET} u \.{\defeq} cop.ctx\@s{15.0}\.{\,\backslash\,}}*
...
\@y{\@s{17.5}%
 \ensuremath{uprime \.{\defeq} u \.{\cup} \{copprime.oid\}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{vprime \.{\defeq} u \.{\cup} \{cop.oid,\, copprime.oid\}
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{cop2copprime \.{\defeq} COT(cop,\, copprime)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}}%
\@y{\@s{17.5}%
 \ensuremath{copprime2cop \.{\defeq} COT(copprime,\, cop)
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\IN}} [\ensuremath{node \.{\mapsto} \{u,\, v,\, uprime,\,
 vprime\}},
}%
\@xx{}%
...
\@y{\@s{45.0}%
 [\ensuremath{from \.{\mapsto} u}, \ensuremath{to \.{\mapsto} uprime},
 \ensuremath{cop \.{\mapsto} copprime}],
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}}%
\@y{\@s{45.0}%
 [\ensuremath{from \.{\mapsto} v}, \ensuremath{to \.{\mapsto} vprime},
 \ensuremath{cop \.{\mapsto} copprime2cop}],
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}}%
\@y{\@s{45.0}%
 [\ensuremath{from \.{\mapsto} uprime}, \ensuremath{to \.{\mapsto} vprime},
 \ensuremath{cop \.{\mapsto} cop2copprime}]\ensuremath{\}}]
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 09 15:31:43 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
