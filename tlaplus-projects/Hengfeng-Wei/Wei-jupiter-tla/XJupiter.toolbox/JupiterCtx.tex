...
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} ds \.{'}
 \.{=} [ ds {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\cup} \{ [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] \} ]}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 28 10:52:54 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
