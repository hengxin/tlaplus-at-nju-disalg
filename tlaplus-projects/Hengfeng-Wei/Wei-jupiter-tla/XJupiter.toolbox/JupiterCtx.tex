...
Definitions and operators for context-based \ensuremath{Jupiter} protocols,
 including \ensuremath{AbsJupiter}, \ensuremath{CJupiter}, and
 \ensuremath{XJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} JupiterInterface}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} cseq ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{cseq[c]}: local sequence number at client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} ds\@s{18.45}}%
\@y{\@s{0}%
 \ensuremath{ds[r]}: document state (a set of \ensuremath{Oids}) of replica
 \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} ctxVars \.{\defeq} {\langle}
 cseq ,\, ds {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Oid\@s{1.13} \.{\defeq} [ c
 \.{:} Client ,\, seq \.{:} Nat ]\@s{4.1}}%
\@y{\@s{0}%
 operation identifier
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Cop \.{\defeq} [ op \.{:} Op
 \.{\cup} \{ Nop \} ,\, oid \.{:} Oid ,\, ctx \.{:} {\SUBSET} Oid ]}%
\@y{\@s{0}%
 contexted-based \ensuremath{op
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} ClientOf ( cop ) \.{\defeq}
 cop . oid . c}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} COT ( lcop ,\, rcop )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{OT} of two \ensuremath{Cop(s)}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{27.19} [ lcop {\EXCEPT}
 {\bang} . op \.{=} Xform ( lcop . op ,\, rcop . op ) ,\, {\bang} . ctx \.{=}
 @ \.{\cup} \{ rcop . oid \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} UpdateDS ( r ,\, cop )
 \.{\defeq}}%
\@y{\@s{0}%
 update \ensuremath{ds} to include new \ensuremath{Cop} (in terms of
 \ensuremath{oid})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} ds \.{'} \.{=} [ ds
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ cop . oid \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} TypeOKCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land} ds
 \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} InitCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} ds \.{=}
 [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} DoCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{\.{\land}} don\mbox{'}t know the generated cop; no way to update
 \ensuremath{ds
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} RevCtx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( c ,\, Head ( cincoming [ c ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cseq}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} SRevCtx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land} UpdateDS
 ( Server ,\, Head ( sincoming ) )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 19 18:05:26 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
