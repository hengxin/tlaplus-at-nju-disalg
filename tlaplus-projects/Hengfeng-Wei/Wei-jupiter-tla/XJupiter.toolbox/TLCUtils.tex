...
\setboolean{shading}{true}
 ...
 {\MODULE} TLCUtils}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Utilities to the \ensuremath{TLC} standard module.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS} Naturals ,\, TLC}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Help to count how many times \ensuremath{TLC} evaluates an expression.
 It also prints the counter with user-specified description whenever it
 divides multiplier.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{{\ASSUME}} (\ensuremath{TLCSet(i,\,
 {\langle}\mbox{``}Description\mbox{''},\, 0{\rangle})})
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} TLCCnt ( i ,\, multiplier )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} TLCSet (
 i ,\, [ TLCGet ( i ) {\EXCEPT} {\bang} [ 2 ] \.{=} @ \.{+} 1 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} ( TLCGet
 ( i ) [ 2 ] \.{\%} multiplier \.{=} 0 ) \.{\implies} PrintT ( TLCGet ( i )
 )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 11 20:16:31 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Oct} 11
 19:50:44 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
