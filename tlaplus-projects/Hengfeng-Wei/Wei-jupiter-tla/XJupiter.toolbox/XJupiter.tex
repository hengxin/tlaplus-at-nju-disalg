...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS} JupiterInterface}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Local \.{\defeq} 0}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} Remote \.{\defeq} 1}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Oid\@s{1.13} \.{\defeq} [ c
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} COT ( lcop ,\, rcop )
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} cseq ,\,\@s{8.2}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} state ,\,\@s{5.26}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 chins ,\, cseq ,\, cur ,\, cincoming ,\, sincoming ,\, c2ss ,\, s2ss ,\,
 state {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} comm \.{\defeq} {\INSTANCE}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} IsSS ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{20.38} \.{\land} G \.{=}
 [ node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{20.38} \.{\land} G . node
 \.{\subseteq} ( {\SUBSET} Oid )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{20.38} \.{\land} G .
 edge\@s{1.53} \.{\subseteq} [ from \.{:} G . node ,\, to \.{:} G . node ,\,
 cop \.{:} Cop ,\, lr \.{:} \{ Local ,\, Remote \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} EmptySS \.{\defeq} [ node
 \.{\mapsto} \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} ss1 \.{\oplus} ss2
 \.{\defeq} [ node \.{\mapsto} ss1 . node \.{\cup} ss2 . node ,\, edge
 \.{\mapsto} ss1 . edge \.{\cup} ss2 . edge ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} TypeOK \.{\defeq}}%
\begin{lcom}{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} \.{\land} cseq
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land} \A\, c
 \.{\in} Client \.{:} IsSS ( c2ss [ c ] ) \.{\land} IsSS ( s2ss [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land} cur
 \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{16.4} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} Init \.{\defeq}}%
\begin{lcom}{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\land} cseq
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} c2ss
 \.{=} [ c\@s{0.12} \.{\in} Client \.{\mapsto} EmptySS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land}
 s2ss\@s{0.25} \.{=} [ c\@s{0.12} \.{\in} Client \.{\mapsto} EmptySS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} Init}%
\begin{lcom}{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} Locate ( cop ,\, ss )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} xForm ( cop ,\, ss ,\,
 current ,\, d ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4} \.{\LET} u
 \.{\defeq} Locate ( cop ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{36.79}}%
\@y{\@s{0}%
 \mbox{'}h\mbox{'} stands for ``helper''; \ensuremath{xss}:
 \ensuremath{eXtra} \ensuremath{ss} created during transformation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{36.79} xFormHelper ( uh
 ,\, vh ,\, coph ,\, xss ,\, xcoph ,\, xcurh ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{53.19} {\IF} uh \.{=}
 current}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{53.19} \.{\THEN}
 {\langle} xss ,\, xcoph ,\, xcurh {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{53.19} \.{\ELSE}
 \.{\LET} e \.{\defeq} {\CHOOSE} e \.{\in} ss . edge \.{:} e . from \.{=} uh
 \.{\land} e . lr \.{=} d}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{104.91} uprime
 \.{\defeq} e . to}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{104.91} copprime
 \.{\defeq} e . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{104.91} coph2copprime
 \.{\defeq} COT ( coph ,\, copprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{104.91} copprime2coph
 \.{\defeq} COT ( copprime ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{109.01} vprime
 \.{\defeq} vh \.{\cup} \{ copprime . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{88.61} \.{\IN}
 xFormHelper ( uprime ,\, vprime ,\, coph2copprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{121.31} [ node
 \.{\mapsto} xss . node \.{\cup} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{124.08} edge\@s{1.53}
 \.{\mapsto} xss . edge\@s{1.53} \.{\cup} \{ [ from \.{\mapsto} vh ,\, to
 \.{\mapsto} vprime ,\, cop \.{\mapsto} copprime2coph ,\, lr \.{\mapsto} d ]
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{168.52} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto}
 coph2copprime ,\, lr \.{\mapsto} 1 \.{-} d ] \} ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{157.07} coph2copprime
 ,\, vprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{16.4} \.{\IN}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}} ClientPerform ( cop ,\, c
 ,\, d ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, c2ss [ c ] ,\, cur [ c ] ,\, d )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop,\, xcur{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{44.99} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{40.89} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{40.89} xcur\@s{1.97}
 \.{\defeq} xform [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{36.79} \.{\land} cur
 \.{'} \.{=} [ cur {\EXCEPT} {\bang} [ c ] \.{=} xcur ]}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 ...
 [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{41.28} \.{\IN} \.{\land}
 ClientPerform ( cop ,\, c ,\, Remote )}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{61.68} \.{\land} comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 \{ op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 176\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 \{ op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] )
 \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 177\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} chins {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 180\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}}\@s{22.34} \.{\land}
 \.{\lor} DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 182\hspace{1em}}\@s{33.45} \.{\lor} DoDel (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 183\hspace{1em}}\@s{22.34} \.{\land}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 188\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
\@y{\@s{0}%
 the received (transformed) operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}}\@s{36.15} \.{\IN}
 ClientPerform ( cop ,\, c ,\, Local )}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, cseq ,\, s2ss {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} performs operation cop.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{16.4} \.{\LET}
 c\@s{0.41} \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}\@s{20.5} scur\@s{2.52}
 \.{\defeq} cur [ Server ]}%
 \@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( cop ,\, s2ss [ c ] ,\, scur ,\, Remote )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop,\, xcur{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}}\@s{24.59} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}}\@s{20.5} xcur\@s{1.97}
 \.{\defeq} xform [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}\@s{89.83} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 205\hspace{1em}}\@s{89.83} \.{\THEN} s2ss [
 cl ] \.{\oplus} xss}%
 \@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}\@s{89.83} \.{\ELSE} s2ss [
 cl ] \.{\oplus} [ node \.{\mapsto} \{ xcur \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 207\hspace{1em}}\@s{168.79} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} scur ,\, to \.{\mapsto} xcur ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 208\hspace{1em}}\@s{216.91} cop\@s{1.78}
 \.{\mapsto} xcop ,\, lr\@s{0.98} \.{\mapsto} Remote ] \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 209\hspace{1em}}\@s{82.95} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 210\hspace{1em}}\@s{36.79} \.{\land} cur
 \.{'} \.{=} [ cur {\EXCEPT} {\bang} [ Server ] \.{=} xcur ]}%
 \@x{\makebox[0pt][r]{\scriptsize 211\hspace{1em}}\@s{36.79} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ Server ] \.{=} Apply ( xcop . op ,\,
 @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 212\hspace{1em}}\@s{36.79} \.{\land} comm
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 216\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 217\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 218\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 219\hspace{1em}}\@s{31.61} \.{\IN}
 ServerPerform ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 220\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, cseq ,\, c2ss {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 221\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 222\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 223\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 224\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 226\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 227\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 229\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} Fairness
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 230\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 235\hspace{1em}} CSSync \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 236\hspace{1em}}\@s{16.4} \forall\, c
 \.{\in} Client \.{:} ( cur [ c ] \.{=} cur [ Server ] ) \.{\implies} c2ss [
 c ] \.{=} s2ss [ c ]}%
\@x{\makebox[0pt][r]{\scriptsize 237\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 19:34:37 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
