...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} xForm ( cop ,\, ss ,\, cur )
 \.{\defeq}}%
 ...
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{36.79} xFormHelper ( uh
 ,\, vh ,\, coph ,\, xss ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{53.19} {\IF} uh \.{=} cur
 \.{\THEN} [ xss \.{\mapsto} xss ,\, xcop \.{\mapsto} coph ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{53.19} \.{\ELSE} \.{\LET}
 e \.{\defeq} {\CHOOSE} e \.{\in} ss . edge \.{:} e . from \.{=} uh \.{\land}
 ClientOf ( e . cop ) \.{\neq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{104.91} copprime
 \.{\defeq} e . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{104.91} uprime \.{\defeq}
 e . to}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{104.91} vprime\@s{0.76}
 \.{\defeq} vh \.{\cup} \{ copprime . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{104.91}
 coph2copprime\@s{4.10} \.{\defeq} COT ( coph ,\, copprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{109.01} copprime2coph
 \.{\defeq} COT ( copprime ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{88.61} \.{\IN}
 xFormHelper ( uprime ,\, vprime ,\, coph2copprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{121.31} xss \.{\oplus} [
 node \.{\mapsto} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{149.94} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\, cop
 \.{\mapsto} copprime2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{191.18} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto}
 coph2copprime ] \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\IN} xFormHelper
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} ClientPerform ( cop ,\, c )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, c2ss [ c ] ,\, ds [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xss}, \ensuremath{xcop}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xform .
 xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{46.46} \.{\IN} \.{\land}
 ClientPerform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{66.86} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{66.86} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} s2ss}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{20.94} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( cincoming [ c ] )}%
\@y{\@s{0}%
 the received (transformed) operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{36.15} \.{\IN}
 ClientPerform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{20.94} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\LET}
 c\@s{0.41} \.{\defeq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{20.5} scur\@s{2.52}
 \.{\defeq} ds [ Server ]}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( cop ,\, s2ss [ c ] ,\, scur )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xss}, \ensuremath{xcop}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform . xcop}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{20.5} xcur\@s{1.97}
 \.{\defeq} scur \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{89.83} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{89.83} \.{\THEN} s2ss [
 cl ] \.{\oplus} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{89.83} \.{\ELSE} s2ss [
 cl ] \.{\oplus} [ node \.{\mapsto} \{ xcur \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{102.13} edge \.{\mapsto}
 \{ [ from \.{\mapsto} scur ,\, to \.{\mapsto} xcur ,\, cop \.{\mapsto} xcop
 ] \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{82.95} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{36.79} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ Server ] \.{=} Apply ( xcop . op ,\,
 @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{36.79} \.{\land} Comm (
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{31.61} \.{\IN}
 ServerPerform ( cop )}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, c2ss {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}} CSSync \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{16.4} \forall\, c
 \.{\in} Client \.{:} ( ds [ c ] \.{=} ds [ Server ] ) \.{\implies} c2ss [ c
 ] \.{=} s2ss [ c ]}%
\@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 24 11:38:04 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
