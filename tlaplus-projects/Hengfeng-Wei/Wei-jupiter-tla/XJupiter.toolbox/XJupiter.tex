...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} c2ss ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{c2ss[c]}: the \ensuremath{2D} state space (\ensuremath{2ss}, for
 short) at client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} s2ss\@s{10.46}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
\@y{\@s{0}%
 Return the (unique) outgoing edge from \ensuremath{u} in \ensuremath{2D}
 state space \ensuremath{ss}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} {\CHOOSE} e \.{\in}
 ss . edge \.{:} e . from \.{=} u}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} xForm ( r ,\, cop ,\, ss )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\LET} u
 \.{\defeq} Locate ( cop ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{20.5} cops\@s{3.21}
 \.{\defeq} ExtractCopSeq ( NextEdge ,\, r ,\, u ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.1}
 xFormCopCopsSS ( cop ,\, cops )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( c ,\, cop ,\, c2ss [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xform .
 xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( c ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\LET} c\@s{0.41}
 \.{\defeq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( Server ,\, cop ,\, s2ss [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform . xcop}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.1}
 \.{\land} s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{154.18} \.{\THEN} s2ss [
 cl ] \.{\oplus} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{154.18} \.{\ELSE} s2ss [
 cl ] \.{\oplus} xform . lss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xcop . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{40.89} \.{\land} Comm
 {\bang} SSendSame ( c ,\, xcop )\@s{4.1}}%
\@y{\@s{0}%
 broadcast the transformed \ensuremath{xcop
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{26.06} \.{\IN} \.{\land}
 ClientPerform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{46.46} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} s2ss}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 ClientPerform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} s2ss}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
...
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} Spec \.{\defeq} Init
...
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} CSSync \.{\defeq}}%
\@y{\@s{0}%
 Each client \ensuremath{c \.{\in} Client} is synchonized with the
 \ensuremath{Server}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \forall\, c \.{\in}
 Client \.{:} ( ds [ c ] \.{=} ds [ Server ] ) \.{\implies} c2ss [ c ] \.{=}
 s2ss [ c ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} CSSync}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 08 14:28:48 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
