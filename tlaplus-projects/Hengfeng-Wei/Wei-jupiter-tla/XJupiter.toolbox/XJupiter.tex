...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} GraphStateSpace}%
...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}}%
\@y{\@s{0}%
 Return the unique outgoing edge from \ensuremath{u} in \ensuremath{2D} state
 space \ensuremath{ss
}}%
\@xx{}%
 ...
 ss . edge \.{:} e . from \.{=} u}%
\@y{\@s{0}%
 before a transformation at \ensuremath{u} (\ensuremath{r} is not used).
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( NextEdge ,\, c ,\, cop ,\, c2ss [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xform .
 xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( c ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\LET} c\@s{0.41}
 \.{\defeq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( NextEdge ,\, Server ,\, cop ,\, s2ss [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform . xcop}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.1}
 \.{\land} s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{154.18} \.{\THEN} s2ss [
 cl ] \.{\oplus} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{154.18} \.{\ELSE} s2ss [
 cl ] \.{\oplus} xform . lss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xcop . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{40.89} \.{\land} Comm
...
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} Do ( c ) \.{\defeq}}%
 ...
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} s2ss}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} CSSync \.{\defeq}}%
\@y{\@s{0}%
 Each client \ensuremath{c \.{\in} Client} is synchonized with the
 \ensuremath{Server}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \forall\, c \.{\in}
 Client \.{:} ( ds [ c ] \.{=} ds [ Server ] ) \.{\implies} c2ss [ c ] \.{=}
 s2ss [ c ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} CSSync}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 15:12:07 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
