...
The \ensuremath{2D} state spaces (\ensuremath{2ss}, for short).
 ...
 The server maintains n \ensuremath{2D} state spaces, one for each client.
\end{cpar}%
\end{lcom}%
...
\@xx{}%
 ...
 coph2copprime ] \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\IN} xFormHelper
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} ClientPerform ( cop ,\, c )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, c2ss [ c ] ,\, ds [ c ] )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{44.99} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{40.89} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} DoOp ( c ,\, op )\@s{5.43}
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{26.06} \.{\LET} cop
 \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\, seq
 \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{46.46} \.{\IN} \.{\land}
 ClientPerform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{66.86} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{66.86} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} s2ss}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{20.94} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( cincoming [ c ] )}%
\@y{\@s{0}%
 the received (transformed) operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{36.15} \.{\IN}
 ClientPerform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{20.94} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\LET}
 c\@s{0.41} \.{\defeq} ClientOf ( cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{20.5} scur\@s{2.52}
 \.{\defeq} ds [ Server ]}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( cop ,\, s2ss [ c ] ,\, scur )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{24.59} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{20.5} xcur\@s{1.97}
 \.{\defeq} scur \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{89.83} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{89.83} \.{\THEN} s2ss [
 cl ] \.{\oplus} xss}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{89.83} \.{\ELSE} s2ss [
 cl ] \.{\oplus} [ node \.{\mapsto} \{ xcur \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{102.13} edge \.{\mapsto}
 \{ [ from \.{\mapsto} scur ,\, to \.{\mapsto} xcur ,\, cop \.{\mapsto} xcop
 ] \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{82.95} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{36.79} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ Server ] \.{=} Apply ( xcop . op ,\,
 @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{36.79} \.{\land} Comm (
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{31.61} \.{\IN}
 ServerPerform ( cop )}%
\@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
...
\@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}} CSSync \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{16.4} \forall\, c
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 24 10:27:03 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
