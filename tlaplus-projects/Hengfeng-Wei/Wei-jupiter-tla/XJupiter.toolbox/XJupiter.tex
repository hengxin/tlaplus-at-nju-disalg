...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS} JupiterCtx}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} vars \.{\defeq} {\langle}
 intVars ,\, ctxVars ,\, cur ,\, c2ss ,\, s2ss {\rangle}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} IsSS ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{20.38} \.{\land} G \.{=}
 [ node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{20.38} \.{\land} G . node
 \.{\subseteq} ( {\SUBSET} Oid )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{20.38} \.{\land} G .
 edge\@s{1.53} \.{\subseteq} [ from \.{:} G . node ,\, to \.{:} G . node ,\,
 cop \.{:} Cop ,\, lr \.{:} \{ Local ,\, Remote \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} EmptySS \.{\defeq} [ node
 \.{\mapsto} \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} ss1 \.{\oplus} ss2
 \.{\defeq} [ node \.{\mapsto} ss1 . node \.{\cup} ss2 . node ,\, edge
 \.{\mapsto} ss1 . edge \.{\cup} ss2 . edge ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 \A\, c \.{\in} Client \.{:} IsSS ( c2ss [ c ] ) \.{\land} IsSS ( s2ss [ c ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 cur \.{\in} [ Replica \.{\rightarrow} {\SUBSET} Oid ]}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} Init \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} c2ss
 \.{=} [ c\@s{0.12} \.{\in} Client \.{\mapsto} EmptySS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} Locate ( cop ,\, ss )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} xForm ( cop ,\, ss ,\,
 current ,\, d ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\LET} u
 \.{\defeq} Locate ( cop ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{36.79}}%
\@y{\@s{0}%
 \mbox{'}h\mbox{'} stands for ``helper''; \ensuremath{xss}:
 \ensuremath{eXtra} \ensuremath{ss} created during transformation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{36.79} xFormHelper ( uh
 ,\, vh ,\, coph ,\, xss ,\, xcoph ,\, xcurh ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{53.19} {\IF} uh \.{=}
 current}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{53.19} \.{\THEN}
 {\langle} xss ,\, xcoph ,\, xcurh {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{53.19} \.{\ELSE} \.{\LET}
 e \.{\defeq} {\CHOOSE} e \.{\in} ss . edge \.{:} e . from \.{=} uh \.{\land}
 e . lr \.{=} d}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{104.91} uprime \.{\defeq}
 e . to}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{104.91} copprime
 \.{\defeq} e . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{104.91} coph2copprime
 \.{\defeq} COT ( coph ,\, copprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{104.91} copprime2coph
 \.{\defeq} COT ( copprime ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{109.01} vprime \.{\defeq}
 vh \.{\cup} \{ copprime . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{88.61} \.{\IN}
 xFormHelper ( uprime ,\, vprime ,\, coph2copprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{121.31} [ node
 \.{\mapsto} xss . node \.{\cup} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{124.08} edge\@s{1.53}
 \.{\mapsto} xss . edge\@s{1.53} \.{\cup} \{ [ from \.{\mapsto} vh ,\, to
 \.{\mapsto} vprime ,\, cop \.{\mapsto} copprime2coph ,\, lr \.{\mapsto} d ]
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{168.52} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto}
 coph2copprime ,\, lr \.{\mapsto} 1 \.{-} d ] \} ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{157.07} coph2copprime ,\,
 vprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\IN} xFormHelper
 ( u ,\, v ,\, cop ,\, [ node \.{\mapsto} \{ v \} ,\, edge \.{\mapsto} \{ [
 from \.{\mapsto} u ,\, to \.{\mapsto} v ,\, cop \.{\mapsto} cop ,\, lr
 \.{\mapsto} 1 \.{-} d ] \} ] ,\, cop ,\, v )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} ClientPerform ( cop ,\, c
 ,\, d ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, c2ss [ c ] ,\, cur [ c ] ,\, d )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop,\, xcur{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{44.99} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{40.89} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{40.89} xcur\@s{1.97}
 \.{\defeq} xform [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 c2ss \.{'} \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{36.79} \.{\land} cur
 \.{'} \.{=} [ cur {\EXCEPT} {\bang} [ c ] \.{=} xcur ]}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{26.06} \.{\land}
 \.{\LET} cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c
 \.{\mapsto} c ,\, seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} cur
 [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{41.28} \.{\IN} \.{\land}
 ClientPerform ( cop ,\, c ,\, Remote )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{61.68} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 \{ op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 \{ op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] )
 \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{22.34} \.{\land}
 \.{\lor} DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{33.45} \.{\lor} DoDel (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} s2ss}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
\@y{\@s{0}%
 the received (transformed) operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{36.15} \.{\IN}
 ClientPerform ( cop ,\, c ,\, Local )}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{20.94} \.{\land} RevCtx
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, s2ss {\rangle}}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} \.{\LET}
 c\@s{0.41} \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{20.5} scur\@s{2.52}
 \.{\defeq} cur [ Server ]}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{16.4} xform \.{\defeq}
 xForm ( cop ,\, s2ss [ c ] ,\, scur ,\, Remote )}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xss,\, xcop,\, xcur{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{24.59} xss\@s{4.14}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{20.5} xcop\@s{2.29}
 \.{\defeq} xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{20.5} xcur\@s{1.97}
 \.{\defeq} xform [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{89.83} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{89.83} \.{\THEN} s2ss [
 cl ] \.{\oplus} xss}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{89.83} \.{\ELSE} s2ss [
 cl ] \.{\oplus} [ node \.{\mapsto} \{ xcur \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{168.79} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} scur ,\, to \.{\mapsto} xcur ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{216.91} cop\@s{1.78}
 \.{\mapsto} xcop ,\, lr\@s{0.98} \.{\mapsto} Remote ] \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{82.95} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{36.79} \.{\land} cur
 \.{'} \.{=} [ cur {\EXCEPT} {\bang} [ Server ] \.{=} xcur ]}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{36.79} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ Server ] \.{=} Apply ( xcop . op ,\,
 @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{36.79} \.{\land} Comm (
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{31.61} \.{\IN}
 ServerPerform ( cop )}%
\@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} chins ,\, c2ss {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} Fairness
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}} CSSync \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}}\@s{16.4} \forall\, c
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:39:52 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
