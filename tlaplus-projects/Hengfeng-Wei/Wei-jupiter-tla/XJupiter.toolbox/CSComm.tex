...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} CSend ( msg ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Append ( sincoming ,\, msg )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cincoming}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Client \ensuremath{c} receives a message from the \ensuremath{Server}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} CRev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{24.21} \.{\land}
 cincoming [ c ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{24.21} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{24.21} \.{\land}
 {\UNCHANGED} sincoming}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{SRev}/\ensuremath{SSend} below is often used as a subaction.
 No \ensuremath{{\UNCHANGED}} in their definitions.
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@y{\@s{0}%
 consume a message
}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} SSend ( c ,\, cmsg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{99.45} \.{\ELSE} Append (
 cincoming [ cl ] ,\, cmsg [ cl ] ) ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The \ensuremath{Server} broadcasts the same message \ensuremath{msg} to all
 Clients other than \ensuremath{c \.{\in} Client}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} SSendSame ( c ,\, msg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} SSend ( c
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} EmptyChannel \.{\defeq}
 Init}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 16 15:09:12 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
