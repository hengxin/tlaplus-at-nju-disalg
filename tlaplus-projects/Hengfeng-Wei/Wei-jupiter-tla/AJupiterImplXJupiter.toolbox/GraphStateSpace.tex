...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormCopCopsSSHelper ( cop ,\, cops ,\, EmptySS )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} xFormCopCopsShift ( cop ,\,
 cops ,\, shift ) \.{\defeq}}%
\@y{\@s{0}%
 shifting the first shift elements out of cops
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} xFormCopCops ( cop
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:49:59 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
