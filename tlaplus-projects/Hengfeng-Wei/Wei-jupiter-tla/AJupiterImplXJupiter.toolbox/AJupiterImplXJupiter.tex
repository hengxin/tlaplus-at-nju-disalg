...
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
 ...
 {\UNCHANGED} s2ss}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} ClientPerformImpl ( c ,\, m
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 xform \.{\defeq} xFormCopCopsShift ( m . cop ,\, cbuf [ c ] ,\, m . ack
 )\@s{3.58}}%
\@y{\@s{0}%
 [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{27.51} \.{\IN} c2ss \.{'}
 \.{=} [ c2ss {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} xform . xss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} s2ss}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} ServerPerformImpl ( m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 c \.{\defeq} ClientOf ( m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{52.01} xform \.{\defeq}
 xFormCopCopsShift ( m . cop ,\, sbuf [ c ] ,\, m . ack )}%
\@y{\@s{0}%
 [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{27.51} \.{\IN}\@s{4.09}
 s2ss \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl \.{=} c \.{\THEN}
 s2ss [ cl ] \.{\oplus} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{193.02} \.{\ELSE} s2ss [
 cl ] \.{\oplus} xform . lss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} c2ss}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} DoCtx ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} DoInt (
 DoOpImpl ,\, c )}%
\@y{\@s{0}%
 \ensuremath{TODO}: refactor to use \ensuremath{DoEx(c)}; cannot use two
 \ensuremath{DoInt
}}%
\@xx{}%
...
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} SRevEx}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerformImpl )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:54:42 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
