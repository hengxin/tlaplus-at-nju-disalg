...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{61.39} \.{\IN} {\IF}
 copsh \.{=} {\langle} {\rangle} \.{\THEN} [ lss \.{\mapsto} uvSS ,\, xss
 \.{\mapsto} xss \.{\oplus} uvSS ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{81.79} \.{\ELSE} \.{\LET}
 copprimeh \.{\defeq} Head ( copsh )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{145.81} uprime\@s{1.77}
 \.{\defeq} u \.{\cup} \{ copprimeh . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{145.81} vprime\@s{2.53}
 \.{\defeq} u \.{\cup} \{ coph . oid ,\, copprimeh . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{133.51}
 coph2copprimeh\@s{4.10} \.{\defeq} COT ( coph ,\, copprimeh )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{137.61} copprimeh2coph
 \.{\defeq} COT ( copprimeh ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{117.21} \.{\IN}
 xFormCopCopsSSHelper ( coph2copprimeh ,\, Tail ( copsh ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{149.91} xss \.{\oplus} [
 node \.{\mapsto} \{ u ,\, v \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{178.54} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} u ,\, to \.{\mapsto} v ,\, cop \.{\mapsto}
 coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{219.78} [ from
 \.{\mapsto} u ,\, to \.{\mapsto} uprime ,\, cop \.{\mapsto} copprimeh ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{219.78} [ from
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:18:32 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
