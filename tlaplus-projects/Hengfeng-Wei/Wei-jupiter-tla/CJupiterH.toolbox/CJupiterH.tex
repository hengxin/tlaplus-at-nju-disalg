...
\ensuremath{CJupiter} with a history of all list states across the system.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} CJupiter}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\VARIABLE} list}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} varsH \.{\defeq} {\langle}
 vars ,\, list {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} TypeOKH \.{\defeq} TypeOK
 \.{\land} ( list \.{\subseteq} List )}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} InitH \.{\defeq} Init
 \.{\land} list \.{=} \{ InitState \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} DoH ( c ) \.{\defeq} Do ( c
 ) \.{\land} list \.{'} \.{=} list \.{\cup} \{ state \.{'} [ c ] \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} RevH ( c ) \.{\defeq} Rev (
 c ) \.{\land} list \.{'} \.{=} list \.{\cup} \{ state \.{'} [ c ] \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} SRevH \.{\defeq} SRev
 \.{\land} list \.{'} \.{=} list \.{\cup} \{ state \.{'} [ Server ] \}}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} NextH \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoH ( c ) \.{\lor} RevH ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\lor} SRevH}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} SpecH \.{\defeq} InitH
 \.{\land} {\Box} [ NextH ]_{ varsH} \.{\land} {\WF}_{ varsH} ( SRevH
 \.{\lor} \E\, c \.{\in} Client \.{:} RevH ( c ) )}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{WLSpec}: the weak list specification
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} WLSpec \.{\defeq} comm
 {\bang} EmptyChannel}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{62.82} \.{\implies} \A\,
 l1 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{82.48} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{82.48} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{82.48} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} {\THEOREM} SpecH
 \.{\implies} WLSpec}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{SLSpec}: the strong list specification
\end{cpar}%
\end{lcom}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 06 20:41:18 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Tue}
 \ensuremath{Oct} 09 09:28:48 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
