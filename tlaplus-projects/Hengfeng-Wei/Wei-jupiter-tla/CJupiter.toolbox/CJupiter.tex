...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} StateSpace ,\,
 JupiterSerial}%
...
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 ...
 Cop ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} css \.{=}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\LET} rcss
 \.{\defeq} css [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{36.79} u \.{\defeq}
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{36.79}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{53.19} {\IF} uh \.{=} ds
 [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{53.19} \.{\THEN}
 {\langle} xcss ,\, xcoph {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{53.19} \.{\ELSE} \.{\LET}
 fedge \.{\defeq} {\CHOOSE} e \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{154.21} \.{\land} e .
 from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{154.21} \.{\land} \A\,
 uhe\@s{5.90} \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{169.42} ( uhe . from
 \.{=} uh \.{\land} uhe \.{\neq} e ) \.{\implies} tb ( e . cop . oid ,\, uhe
 . cop . oid ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{104.91} uprime \.{\defeq}
 fedge . to}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{104.91} fcop \.{\defeq}
 fedge . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{104.91} coph2fcop
 \.{\defeq} COT ( coph ,\, fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{104.91} fcop2coph
 \.{\defeq} COT ( fcop ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{109.01} vprime \.{\defeq}
 vh \.{\cup} \{ fcop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{84.51} \.{\IN}\@s{4.09}
 xFormHelper ( uprime ,\, vprime ,\, coph2fcop ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{121.31} [ xcss {\EXCEPT}
 {\bang} . node \.{=} @ \.{\cup} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{128.18} {\bang} . edge
 \.{=} @ \.{\cup} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\, cop
 \.{\mapsto} fcop2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{191.90} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto} coph2fcop ]
 \} ] ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{135.53} coph2fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{12.29} \.{\IN}\@s{4.1}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Perform ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, r )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xcss,\, xcop{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{36.79} xcss\@s{1.34}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\oplus} xcss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{26.06} \.{\land} \.{\LET}
 cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{37.18} \.{\IN} \.{\land}
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{57.58} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} Do ( c ) \.{\defeq}}%
 ...
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} Rev ( c ) \.{\defeq}}%
 ...
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 Perform ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{47.91} \.{\land} Comm (
...
\@xx{}%
 ...
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Fairness: There is no requirement that the clients ever generate operations.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} Comm ( Cop )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( css ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} {\THEOREM} Spec
 \.{\implies} Compactness}%
\@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 19 18:38:03 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
