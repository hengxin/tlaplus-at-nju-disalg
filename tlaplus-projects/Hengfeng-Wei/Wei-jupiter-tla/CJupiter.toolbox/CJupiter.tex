...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}}\midbar\@xx{}%
 ...
 \.{\defeq}\@s{16.4}}%
\@y{\@s{0}%
 Return the first outgoing edge from \ensuremath{u
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} {\CHOOSE} e \.{\in}
 ss . edge \.{:}\@s{4.51}}%
\@y{\@s{0}%
 in \ensuremath{n}-ary ordered space \ensuremath{ss} at replica
 \ensuremath{r}.
}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 15:11:38 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
