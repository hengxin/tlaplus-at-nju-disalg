...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} cseq ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cseq[c]}: local sequence number at client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} cstate
 ,\,\@s{4.76}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} css ,\,\@s{13.96}}%
\@y{\@s{0}%
 \ensuremath{css[r]}: the \ensuremath{n}-ary ordered state space at replica
 \ensuremath{r
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} cur ,\,\@s{12.29}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} eVars \.{\defeq} {\langle}
 chins {\rangle}\@s{105.22}}%
\@y{\@s{0}%
 variables for the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} cVars \.{\defeq} {\langle}
 cseq ,\, cstate {\rangle}\@s{32.8}}%
\@y{\@s{0}%
 variables for the clients
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} ecVars \.{\defeq} {\langle}
 eVars ,\, cVars {\rangle}\@s{67.32}}%
\@y{\@s{0}%
 variables for the clients and the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} sVars \.{\defeq} {\langle}
 sstate {\rangle}\@s{32.8}}%
\@y{\@s{0}%
 variables for the server
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} commVars \.{\defeq}
 {\langle} cincoming ,\, sincoming {\rangle}\@s{12.29}}%
\@y{\@s{0}%
 variables for communication
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} vars \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} IsCSS ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} \.{\land} G \.{=} [
 node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{16.4} \.{\land} G . node
 \.{\subseteq} ( {\SUBSET} Oid )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\land} G .
 edge\@s{1.53} \.{\subseteq} [ from \.{:} G . node ,\, to \.{:} G . node ,\,
 cop \.{:} Cop ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} TypeOK \.{\defeq}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} List}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For all replicas: the \ensuremath{n}-ary ordered state space
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} \A\, r
 \.{\in} Replica \.{:} IsCSS ( r )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\land} cur
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{=} InitState}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For all replicas: the \ensuremath{n}-ary ordered state space
...
\end{lcom}%
 ...
 ,\, edge \.{\mapsto} \{ \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{16.4} \.{\land} cur
 \.{=} \{ \}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For communication between the server and the clients:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} Init}%
...
\end{lcom}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{26.06} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{26.06} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{26.06} \.{\land}
 \.{\LET} cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c
 \.{\mapsto} c ,\, seq \.{\mapsto} cseq \.{'} [ c ] ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{41.28} ctx \.{\mapsto}
 cur [ c ] ,\, sctx \.{\mapsto} \{ \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{55.04} v \.{\defeq} cur
 \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{41.28} \.{\IN} \.{\land}
 css \.{'}\@s{1.66} \.{=} [ css {\EXCEPT} {\bang} [ c ] . node \.{=} @
 \.{\cup} \{ v \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{162.58} {\bang} [ c ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} cur ,\, to \.{\mapsto}
 v ,\, cop \.{\mapsto} cop ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{61.68} \.{\land} cur
 \.{'} \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{61.68} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, op \.{\mapsto} cop ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( cstate [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{27.72} \.{\land} ins .
 ch \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{27.72} \.{\land} chins
 \.{'}\@s{0.73} \.{=} chins \.{\,\backslash\,} \{ ins . ch \}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} sVars}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{27.72} \.{\land} del .
 pos \.{\in} 1 \.{\dotdot} Len ( cstate [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{22.34} \.{\lor} DoIns (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{22.34} \.{\lor} DoDel (
 c )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}} Locate ( cop ,\, rcss )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}} xForm ( cop ,\, rcss )
 \.{\defeq} {\TRUE}\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{TODO
}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}}}%
\@y{\@s{20.0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 m \.{\defeq} Head ( sincoming )}%
\@y{\@s{0}%
 the message to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} sstate\.{'} \.{=} Apply(xop,\, sstate)
 \.{\,\backslash\,}}* apply the transformed operation
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}}%
\@y{\@s{20.0}%
...
\@xx{}%
 ...
 {\UNCHANGED} ecVars}%
\@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The next-state relation.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 210\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 211\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 212\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}. (\ensuremath{TODO}: Check the fairness condition.)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 216\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars} \.{\land} {\WF}_{ vars} ( Next )}%
\@x{\makebox[0pt][r]{\scriptsize 217\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Sep} 01
 16:48:56 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
