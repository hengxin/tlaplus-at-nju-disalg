...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 A \ensuremath{css} is a directed graph (defined in moudule
 \ensuremath{GraphsUtil}) with labeled edges,
 Each node is characterized by its context, a set of oids.
 Each edge is labeled with an operation.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} IsCSS ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} G \.{=} [
 node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} G . node
 \.{\subseteq} ( {\SUBSET} Oid )}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} G .
 edge\@s{1.53} \.{\subseteq} [ from \.{:} G . node ,\, to \.{:} G . node ,\,
 cop \.{:} Cop ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 TypeOKInt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 TypeOKCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 TypeOKSerial}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
...
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Init \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land}
 InitSerial}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} css \.{=}
 [ r \.{\in} Replica \.{\mapsto} EmptyGraph ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Locate ( cop ,\, rcss )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\LET} rcss
 \.{\defeq} css [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{36.79} u \.{\defeq}
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{36.79}}%
\@y{\@s{0}%
 \mbox{'}h\mbox{'} stands for ``helper''; \ensuremath{xcss}:
 \ensuremath{eXtra} \ensuremath{css} created during transformation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{36.79} xFormHelper ( uh
 ,\, vh ,\, coph ,\, xcss ,\, xcoph ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{53.19} {\IF} uh \.{=} ds
 [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{53.19} \.{\THEN}
 {\langle} xcss ,\, xcoph {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{53.19} \.{\ELSE} \.{\LET}
 fedge \.{\defeq} {\CHOOSE} e \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{154.21} \.{\land} e .
 from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{154.21} \.{\land} \A\,
 uhe\@s{5.90} \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{169.42} ( uhe . from
 \.{=} uh \.{\land} uhe \.{\neq} e ) \.{\implies} tb ( e . cop . oid ,\, uhe
 . cop . oid ,\, serial [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{104.91} uprime \.{\defeq}
 fedge . to}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{104.91} fcop \.{\defeq}
 fedge . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{104.91} coph2fcop
 \.{\defeq} COT ( coph ,\, fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{104.91} fcop2coph
 \.{\defeq} COT ( fcop ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{109.01} vprime \.{\defeq}
 vh \.{\cup} \{ fcop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{84.51} \.{\IN}\@s{4.09}
 xFormHelper ( uprime ,\, vprime ,\, coph2fcop ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{121.31} [ xcss {\EXCEPT}
 {\bang} . node \.{=} @ \.{\cup} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{128.18} {\bang} . edge
 \.{=} @ \.{\cup} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\, cop
 \.{\mapsto} fcop2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{191.90} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto} coph2fcop ]
 \} ] ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{135.53} coph2fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{12.29} \.{\IN}\@s{4.1}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} Perform ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, r )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: \ensuremath{{\langle}xcss,\, xcop{\rangle}
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{36.79} xcss\@s{1.34}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 xform [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\oplus} xcss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{36.79} \.{\land} state
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{26.06} \.{\land} \.{\LET}
 cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{37.18} \.{\IN} \.{\land}
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{57.58} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{16.4} \E\, ins \.{\in} \{
 op \.{\in} Ins \.{:} op . pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] )
 \.{+} 1 ) \.{\land} op . ch \.{\in} chins \.{\land} op . pr \.{=} Priority [
 c ] \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{22.34} \.{\land}
 \.{\lor} DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{33.45} \.{\lor} DoDel (
 c )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{20.94} \.{\land} RevCtx
 ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} chins}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 Perform ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{47.91} \.{\land} Comm (
 Cop ) {\bang} SSendSame ( cop . oid . c ,\, cop )\@s{4.1}}%
\@y{\@s{0}%
 broadcast the original operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Fairness: There is no requirement that the clients ever generate operations.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} Comm ( Cop )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( css ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}} {\THEOREM} Spec
 \.{\implies} Compactness}%
\@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 19 11:35:32 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
