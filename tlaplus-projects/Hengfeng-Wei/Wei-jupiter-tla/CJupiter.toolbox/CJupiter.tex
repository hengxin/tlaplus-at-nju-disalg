...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Iteratively transform cop with a path in the \ensuremath{css
} at replica \ensuremath{r \.{\in} Replica}, following the first edges.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} xForm ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\LET} rcss
 \.{\defeq} css [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{36.79} u \.{\defeq}
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{40.89} xFormHelper ( uh
 ,\, vh ,\, coph ,\, xcss ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{57.29} {\IF} uh \.{=} ds
 [ r ] \.{\THEN} [ xcop \.{\mapsto} coph ,\, xcss \.{\mapsto} xcss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 fedge \.{\defeq}}%
\@y{\@s{0}%
 the first outgoing edge from \ensuremath{uh
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{117.21} {\CHOOSE} e
 \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{125.41} \.{\land} e .
 from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{125.41} \.{\land} \A\,
 uhe\@s{5.90} \.{\in} rcss . edge \.{\,\backslash\,} \{ e \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{140.62} ( uhe . from
 \.{=} uh ) \.{\implies} tb ( e . cop . oid ,\, uhe . cop . oid ,\, serial [
 r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{109.01} uprime \.{\defeq}
 fedge . to}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{109.01} fcop \.{\defeq}
 fedge . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{109.01} coph2fcop
 \.{\defeq} COT ( coph ,\, fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{109.01} fcop2coph
 \.{\defeq} COT ( fcop ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{113.11} vprime \.{\defeq}
 vh \.{\cup} \{ fcop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{92.71} \.{\IN}
 xFormHelper ( uprime ,\, vprime ,\, coph2fcop ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{125.41} xcss \.{\oplus} [
 node \.{\mapsto} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{158.64} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\, cop
 \.{\mapsto} fcop2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{199.88} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto} coph2fcop ]
 \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{20.5} \.{\IN} xFormHelper
 ( u ,\, v ,\, cop ,\, [ node \.{\mapsto} \{ v \} ,\, edge \.{\mapsto} \{ [
 from \.{\mapsto} u ,\, to \.{\mapsto} v ,\, cop \.{\mapsto} cop ] \} ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( r ,\, cop )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xcss}]
}%
\@xx{}%
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq} Perform ( c ,\, cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
...
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Do ( c ) \.{\defeq}}%
 ...
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} Compactness \.{\defeq}}%
\@y{\@s{0}%
 Compactness of \ensuremath{CJupiter}: the \ensuremath{CSSes} at all replicas
 are the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} Comm {\bang}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 07 13:19:43 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
