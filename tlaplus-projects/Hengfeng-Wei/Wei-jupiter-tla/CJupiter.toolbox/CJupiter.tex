...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{121.31} {\CHOOSE} e
 \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{137.71}
 \.{\land}\@s{11.17} e . from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{137.71}
 \.{\land}\@s{11.17} \A\, uhe\@s{5.90} \.{\in} rcss . edge \.{\,\backslash\,}
 \{ e \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{164.09} ( uhe . from
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
...
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}}\midbar\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{30.16} \.{\IN} \.{\land}
 Perform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{50.56} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{22.34} \.{\land} DoInt (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{20.94} \.{\land} RevInt (
 Perform ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\land} SRevInt (
 ServerPerform )}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land}
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} Fairness \.{\defeq}}%
\@y{\@s{0}%
 There is no requirement that the clients ever generate operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} Spec \.{\defeq} Init
...
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} Compactness \.{\defeq}}%
\@y{\@s{0}%
 Compactness of \ensuremath{CJupiter}: the \ensuremath{CSSes} at all replicas
 are the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( css ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}} {\THEOREM} Spec \.{\implies}
 Compactness}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 21:01:46 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
