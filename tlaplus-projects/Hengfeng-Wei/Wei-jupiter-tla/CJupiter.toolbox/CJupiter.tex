...
\@xx{}%
 ...
 [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{53.19} \.{\THEN} [ xcss
 \.{\mapsto} xcss ,\, xcop \.{\mapsto} coph ]}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{121.31} xcss \.{\oplus} [
 node \.{\mapsto} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{154.54} edge\@s{1.53}
 \.{\mapsto} \{ [ from\@s{3.32} \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\,
 cop \.{\mapsto} fcop2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{195.78} [ from\@s{3.32}
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\, cop \.{\mapsto} coph2fcop ]
 \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{12.29} \.{\IN}\@s{4.1}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} Perform ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( cop ,\, r )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcss}, \ensuremath{xcop}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\oplus} xform .
 xcss ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{36.79} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ r ] \.{=} Apply ( xform . xcop . op
 ,\, @ ) ]}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{26.06} \.{\land} \.{\LET}
 cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c \.{\mapsto} c ,\,
 seq \.{\mapsto} cseq \.{'} [ c ] ] ,\, ctx \.{\mapsto} ds [ c ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{37.18} \.{\IN} \.{\land}
 Perform ( cop ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{57.58} \.{\land} UpdateDS
 ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{57.58} \.{\land} Comm (
 Cop ) {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \E\, del \.{\in} \{
 op \.{\in} Del \.{:} op . pos \.{\in} 1 \.{\dotdot} Len ( state [ c ] ) \}
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{20.94} \.{\land} Comm (
 Cop ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{20.94} \.{\land} Perform
 ( Head ( cincoming [ c ] ) ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{20.94} \.{\land}
 RevSerial ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} chins}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Cop ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 Perform ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{47.91} \.{\land} Comm (
...
\@xx{}%
 ...
 SRevSerial}%
\@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Fairness: There is no requirement that the clients ever generate operations.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}} Fairness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}} Compactness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} Comm ( Cop )
 {\bang} EmptyChannel \.{\implies} Cardinality ( Range ( css ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} {\THEOREM} Spec
 \.{\implies} Compactness}%
\@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 24 11:28:51 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
