...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{5.27}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} css ,\,\@s{13.96}}%
\@y{\@s{0}%
 \ensuremath{css[r]}: the \ensuremath{n}-ary ordered state space at replica
 \ensuremath{r
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} cur ,\,\@s{12.29}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} sincoming
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} chins\@s{8.2}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} eVars \.{\defeq} {\langle}
 chins {\rangle}\@s{105.22}}%
\@y{\@s{0}%
 variables for the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} cVars \.{\defeq} {\langle}
 cseq ,\, cstate {\rangle}\@s{32.8}}%
\@y{\@s{0}%
 variables for the clients
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} ecVars \.{\defeq} {\langle}
 eVars ,\, cVars {\rangle}\@s{67.32}}%
\@y{\@s{0}%
 variables for the clients and the environment
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} sVars \.{\defeq} {\langle}
 sstate {\rangle}\@s{32.8}}%
\@y{\@s{0}%
 variables for the server
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} commVars \.{\defeq}
 {\langle} cincoming ,\, sincoming {\rangle}\@s{12.29}}%
\@y{\@s{0}%
 variables for communication
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} vars \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} IsCSS ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\land} G \.{=} [
 node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land} G . node
 \.{\subseteq} ( {\SUBSET} Oid )}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\land} G .
 edge\@s{1.53} \.{\subseteq} [ from \.{:} G . node ,\, to \.{:} G . node ,\,
 cop \.{:} Cop ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} TypeOK \.{\defeq}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\land} cseq
 \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{16.4} \.{\land} \A\, r
 \.{\in} Replica \.{:} IsCSS ( r )}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{16.4} \.{\land} cur
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For model checking:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{=} Char}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
...
\end{lcom}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{=} InitState}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For all replicas: the \ensuremath{n}-ary ordered state space
...
\end{lcom}%
 ...
 css\@s{1.66} \.{=} [ c \.{\in} Client \.{\mapsto} [ node \.{\mapsto} \{ \}
 ,\, edge \.{\mapsto} \{ \} ] ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} Init}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}} DoOp ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{26.06} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{26.06} \.{\land} cseq
 \.{'} \.{=} [ cseq {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{26.06} \.{\land}
 \.{\LET} cop \.{\defeq} [ op \.{\mapsto} op ,\, oid \.{\mapsto} [ c
 \.{\mapsto} c ,\, seq \.{\mapsto} cseq \.{'} [ c ] ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{41.28} ctx \.{\mapsto}
 cur [ c ] ,\, sctx \.{\mapsto} \{ \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{55.04} v \.{\defeq} cur
 \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{41.28} \.{\IN} \.{\land}
 css \.{'}\@s{1.66} \.{=} [ css {\EXCEPT} {\bang} [ c ] . node \.{=} @
 \.{\cup} \{ v \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{162.58} {\bang} [ c ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} cur ,\, to \.{\mapsto}
 v ,\, cop \.{\mapsto} cop ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{61.68} \.{\land} cur
 \.{'} \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{61.68} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, op \.{\mapsto} cop ] )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}} DoIns ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( cstate [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{27.72} \.{\land} ins .
 ch \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{27.72} \.{\land} chins
 \.{'}\@s{0.73} \.{=} chins \.{\,\backslash\,} \{ ins . ch \}}%
\@y{\@s{0}%
 We assume that all inserted elements are unique.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} sVars}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}}\@s{27.72} \.{\land} del .
 pos \.{\in} 1 \.{\dotdot} Len ( cstate [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 176\hspace{1em}}\@s{27.72} \.{\land} DoOp (
 c ,\, del )}%
 \@x{\makebox[0pt][r]{\scriptsize 177\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 180\hspace{1em}}\@s{22.34} \.{\lor} DoIns (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}}\@s{22.34} \.{\lor} DoDel (
 c )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}} Locate ( cop ,\, rcss )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}\@s{16.4} \.{\LET} rcss
 \.{\defeq} css [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 195\hspace{1em}}\@s{36.79} u \.{\defeq}
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}\@s{40.89} xFormHelper ( uh
 ,\, vh ,\, coph ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}}\@s{57.29} {\IF} uh \.{=}
 cur [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}}\@s{57.29} \.{\THEN} css
 \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] . node \.{=} @ \.{\cup} \{ vh \}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}}\@s{176.74} {\bang} [ r ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto}
 vh ,\, cop \.{\mapsto} coph ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} fedge \.{\defeq} {\CHOOSE} e \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}\@s{158.31} \.{\land} e .
 from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}\@s{158.31} \.{\land} \A\,
 ue \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 205\hspace{1em}}\@s{173.52} ( ue . from
 \.{=} uh \.{\land} ue \.{\neq} e ) \.{\implies} ( e . cop \.{\prec} ue . cop
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}\@s{109.01} uprime
 \.{\defeq} fedge . to}%
 \@x{\makebox[0pt][r]{\scriptsize 207\hspace{1em}}\@s{109.01} fcop\@s{4.1}
 \.{\defeq} fedge . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 208\hspace{1em}}\@s{109.01} cop2fcop
 \.{\defeq} COT ( cop ,\, fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 209\hspace{1em}}\@s{109.01} fcop2cop
 \.{\defeq} COT ( fcop ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 210\hspace{1em}}\@s{113.11} vprime
 \.{\defeq} v . oids \.{\cup} \{ fcop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 211\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.09}
 \.{\land} css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] . node \.{=} @
 \.{\cup} \{ vh \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 212\hspace{1em}}\@s{212.35} {\bang} [ r ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto}
 vh ,\, cop \.{\mapsto} coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 213\hspace{1em}}\@s{288.45} [ from
 \.{\mapsto} vh ,\, to\@s{0.76} \.{\mapsto} vprime ,\, cop \.{\mapsto}
 fcop2cop ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 214\hspace{1em}}\@s{113.11} \.{\land}
 xFormHelper ( uprime ,\, vprime ,\, cop2fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 215\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( u ,\, v ,\, cop )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 220\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 221\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 222\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 223\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 224\hspace{1em}}}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} cstate\.{'} \.{=}} [\ensuremath{cstate}
 \ensuremath{{\EXCEPT} {\bang}[c] \.{=} Apply(xop,\, @)}]
 \ensuremath{\.{\,\backslash\,}}* apply the transformed operation
 \ensuremath{xop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 225\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 226\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} receives a message.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 230\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 231\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 232\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 m \.{\defeq} Head ( sincoming )}%
\@y{\@s{0}%
 the message to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 233\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 {\TRUE}}%
\@x{\makebox[0pt][r]{\scriptsize 234\hspace{1em}}}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} sstate\.{'} \.{=} Apply(xop,\, sstate)
 \.{\,\backslash\,}}* apply the transformed operation
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 235\hspace{1em}}}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} comm{\bang}SSend(c,\, srec,\, xop)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 236\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} ecVars}%
\@x{\makebox[0pt][r]{\scriptsize 237\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The next-state relation.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 241\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 242\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 243\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}. (\ensuremath{TODO}: Check the fairness condition.)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 247\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars} \.{\land} {\WF}_{ vars} ( Next )}%
\@x{\makebox[0pt][r]{\scriptsize 248\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 02
 10:59:51 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
