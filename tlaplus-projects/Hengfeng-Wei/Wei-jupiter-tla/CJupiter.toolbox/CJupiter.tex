...
\@xx{}%
 ...
 ss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{32.8} \.{\land}\@s{11.17}
 e . from \.{=} u}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{32.8} \.{\land}\@s{11.17}
 \A\, ue \.{\in} ss . edge \.{\,\backslash\,} \{ e \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{59.18} ( ue . from \.{=}
 u ) \.{\implies} tb ( e . cop . oid ,\, ue . cop . oid ,\, serial [ r ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} xForm ( r ,\, cop )
 \.{\defeq}}%
\@y{\@s{0}%
 Iteratively transform cop with a path in the state space at replica
 \ensuremath{r},
}%
\@xx{}%
...
\@xx{}%
 ...
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{40.89} cops \.{\defeq}
 ExtractCopSeq ( NextEdge ,\, r ,\, u ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormCopCopsSS ( cop ,\, cops )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Perform ( r ,\, cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xForm ( r ,\, cop )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{xform}: [\ensuremath{xcop}, \ensuremath{xss}, \ensuremath{lss}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\oplus} xform . xss
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( r ,\, xform . xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} ClientPerform ( c ,\, cop )
 \.{\defeq} Perform ( c ,\, cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} ServerPerform ( cop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\land} Perform (
 Server ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} Comm
...
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\midbar\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{30.16} \.{\IN} \.{\land}
 ClientPerform ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{50.56} \.{\land} Comm
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} Do ( c ) \.{\defeq}}%
 ...
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{22.34} \.{\land} DoSerial
 ( c )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} Compactness \.{\defeq}}%
\@y{\@s{0}%
 Compactness of \ensuremath{CJupiter}: the \ensuremath{CSSes} at all replicas
 are the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} Comm {\bang}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 08 14:03:12 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
