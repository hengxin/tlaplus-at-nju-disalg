...
Model checking our own \ensuremath{CJupiter} protocol.
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} Server ,\,}%
\@y{\@s{0}%
 the server replica
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Client\@s{7.77}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} cin ,\,}%
\@y{\@s{0}%
 \ensuremath{cin[c]}: incoming channel of \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} sin\@s{6.62}}%
\@y{\@s{0}%
 \ensuremath{sin[c]}: incoming channel for \ensuremath{c \.{\in} Client} at
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jun} 09
 00:46:54 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 09 00:42:52
