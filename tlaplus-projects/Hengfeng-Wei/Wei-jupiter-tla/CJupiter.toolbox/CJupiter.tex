...
\@xx{}%
 ...
 ,\, oid \.{:} Oid ,\, ctx \.{:} {\SUBSET} Oid ,\, sctx \.{:} {\SUBSET} Oid
 ]}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 lcop . ctx \.{\cup} \{ rcop . oid \} ,\, sctx \.{\mapsto} lcop . stx ]}%
...
\@xx{}%
 ...
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} cur ,\, to \.{\mapsto}
 v ,\, cop \.{\mapsto} cop ] \} ]}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 195\hspace{1em}} {\RECURSIVE} xForm ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}} xForm ( cop ,\, r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{16.4} \.{\LET} rcss
 \.{\defeq} css [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}\@s{36.79} u \.{\defeq}
 Locate ( cop ,\, rcss )}%
 \@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}}\@s{36.79} v\@s{0.45}
 \.{\defeq} u \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}}\@s{36.79} {\RECURSIVE}
 xFormHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}}\@s{40.89} xFormHelper ( uh
 ,\, vh ,\, coph ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}}\@s{57.29} {\IF} uh \.{=}
 cur [ r ]}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}\@s{57.29} \.{\THEN} css
 \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] . node \.{=} @ \.{\cup} \{ vh \}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}\@s{176.74} {\bang} [ r ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto}
 vh ,\, cop \.{\mapsto} coph ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 205\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} fedge \.{\defeq} {\CHOOSE} e \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}\@s{158.31} \.{\land} e .
 from \.{=} uh}%
 \@x{\makebox[0pt][r]{\scriptsize 207\hspace{1em}}\@s{158.31} \.{\land} \A\,
 ue \.{\in} rcss . edge \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 208\hspace{1em}}\@s{173.52} ( ue . from
 \.{=} uh \.{\land} ue \.{\neq} e ) \.{\implies} ( e . cop \.{\prec} ue . cop
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 209\hspace{1em}}\@s{109.01} uprime
 \.{\defeq} fedge . to}%
 \@x{\makebox[0pt][r]{\scriptsize 210\hspace{1em}}\@s{109.01} fcop\@s{4.1}
 \.{\defeq} fedge . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 211\hspace{1em}}\@s{109.01} cop2fcop
 \.{\defeq} COT ( cop ,\, fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 212\hspace{1em}}\@s{109.01} fcop2cop
 \.{\defeq} COT ( fcop ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 213\hspace{1em}}\@s{113.11} vprime
 \.{\defeq} v . oids \.{\cup} \{ fcop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 214\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.09}
 \.{\land} css \.{'} \.{=} [ css {\EXCEPT} {\bang} [ r ] . node \.{=} @
 \.{\cup} \{ vh \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 215\hspace{1em}}\@s{212.35} {\bang} [ r ] .
 edge\@s{1.53} \.{=} @ \.{\cup} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto}
 vh ,\, cop \.{\mapsto} coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 216\hspace{1em}}\@s{288.45} [ from
 \.{\mapsto} vh ,\, to\@s{0.76} \.{\mapsto} vprime ,\, cop \.{\mapsto}
 fcop2cop ] \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 217\hspace{1em}}\@s{113.11} \.{\land}
 xFormHelper ( uprime ,\, vprime ,\, cop2fcop )}%
 \@x{\makebox[0pt][r]{\scriptsize 218\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( u ,\, v ,\, cop )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 223\hspace{1em}} Rev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 224\hspace{1em}}\@s{20.94} \.{\land} comm
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 225\hspace{1em}}\@s{20.94} \.{\land}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
\@y{\@s{0}%
 the received original operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 226\hspace{1em}}\@s{56.55} xcop \.{\defeq}
 xForm ( cop ,\, c )\@s{14.70}}%
\@y{\@s{0}%
 the transformed operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 227\hspace{1em}}\@s{36.15} \.{\IN} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( xcop . op ,\, @ )
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 228\hspace{1em}}\@s{20.94} \.{\land}
 {\UNCHANGED} {\langle} sVars ,\, eVars {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 229\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Server} receives a message.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 233\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 234\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 235\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 org\@s{0.64} \.{\defeq} Head ( sincoming )}%
\@y{\@s{0}%
 the received operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 236\hspace{1em}}\@s{47.91} cop \.{\defeq} [
 org {\EXCEPT} {\bang} . sctx \.{=} soids ]\@s{21.97}}%
\@y{\@s{0}%
 set its \ensuremath{sctx} field
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 237\hspace{1em}}\@s{52.01} xcop \.{\defeq}
 xForm ( cop ,\, Server )}%
 \@x{\makebox[0pt][r]{\scriptsize 238\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 soids \.{'} \.{=} soids \.{\cup} \{ cop . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 239\hspace{1em}}\@s{52.01} \.{\land} sstate
 \.{'} \.{=} Apply ( xcop . op ,\, sstate )\@s{23.53}}%
\@y{\@s{0}%
 apply the transformed operation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 240\hspace{1em}}\@s{52.01} \.{\land} comm
 {\bang} SSendSame ( cop . oid . cid ,\, cop )\@s{4.10}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 {\UNCHANGED} ecVars}%
\@x{\makebox[0pt][r]{\scriptsize 242\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The next-state relation.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 246\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 247\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 248\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}. (\ensuremath{TODO}: Check the fairness condition.)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 252\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars} \.{\land} {\WF}_{ vars} ( Next )}%
\@x{\makebox[0pt][r]{\scriptsize 253\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 03 14:03:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
