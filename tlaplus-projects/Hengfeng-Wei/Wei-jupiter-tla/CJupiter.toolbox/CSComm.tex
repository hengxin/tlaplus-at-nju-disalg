...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} Integers ,\,
 Naturals ,\, OpOperators}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Op}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} {\VARIABLES}}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} vars \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} Msg \.{\defeq} [ c \.{:}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{37.42} [ ack \.{:} Int
 ,\, op \.{:} Op \.{\cup} \{ Nop \} ]}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} cincoming
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} CSend ( msg ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land} sincoming
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} CRev ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{24.21} \.{\land}
 cincoming [ c ] \.{\neq} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 there are messages to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{24.21} \.{\land}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{24.21} \.{\land}
 {\UNCHANGED} sincoming}%
...
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}\@s{12.29}}%
\@y{\@s{0}%
 there are messages for the \ensuremath{Server} to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@y{\@s{0}%
 consume a message
}%
...
The \ensuremath{Server} broadcasts messages to the Clients
 ...
 \ensuremath{Int}, \ensuremath{op}: \ensuremath{Op}] broadcast
 are determined by the parameter ``\ensuremath{acks}''.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} SSend ( c ,\, acks ,\, xop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{99.45} \.{\ELSE} Append (
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} EmptyChannel \.{\defeq}
 Init}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:52:57 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
