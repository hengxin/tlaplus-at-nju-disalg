...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} TypeOK \.{\defeq} incoming
 \.{\in} [ Replica \.{\rightarrow} Seq ( Msg ) ]}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} EmptyChannel \.{\defeq}
 incoming \.{=} [ r \.{\in} Replica \.{\mapsto} {\langle} {\rangle} ]}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A replica \ensuremath{r \.{\in} Replica} receives a message.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} Rev ( r ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{20.94} \.{\land} incoming
 [ r ] \.{\neq} {\langle} {\rangle}\@s{8.2}}%
\@y{\@s{0}%
 there are messages in the incoming channel
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{20.94} \.{\land} incoming
...
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} CSend ( msg ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} incoming
 \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [ Server ] \.{=} Append ( @ ,\, msg
 ) ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} SSend ( c ,\, cmsg )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} incoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{98.95} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{98.95} \.{\THEN} incoming
 [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{98.95} \.{\ELSE} Append (
 incoming [ cl ] ,\, cmsg [ cl ] ) ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} SSendSame ( c ,\, msg )
 \.{\defeq} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto} msg ] )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 08 15:23:15 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
