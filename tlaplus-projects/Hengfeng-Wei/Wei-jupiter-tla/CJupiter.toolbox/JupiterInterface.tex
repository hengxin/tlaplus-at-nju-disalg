...
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} Char ,\,\@s{24.59}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} intVars \.{\defeq} {\langle}
 aop ,\, state ,\, cincoming ,\, sincoming ,\, chins {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Comm ( Msg ) \.{\defeq}
 {\INSTANCE} CSComm}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Replica \.{\defeq} Client
 \.{\cup} \{ Server \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} List \.{\defeq} Seq ( Char
 \.{\cup} Range ( InitState ) )\@s{42.53}}%
\@y{\@s{0}%
 all possible lists
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} MaxLen \.{\defeq}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} ClientNum \.{\defeq}
 Cardinality ( Client )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Priority \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} Del \.{\defeq} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxLen ]}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} SetNewAop ( r ,\, aopr )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} aop \.{'} \.{=} [
 aop {\EXCEPT} {\bang} [ r ] \.{=} aopr ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} ApplyNewAop ( r )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} state \.{'} \.{=} [
 state {\EXCEPT} {\bang} [ r ] \.{=} Apply ( aop \.{'} [ r ] ,\, @ ) ]}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} TypeOKInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} aop
 \.{\in} [ Replica \.{\rightarrow} Op \.{\cup} \{ Nop \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} state
 \.{\in} [ Replica \.{\rightarrow} List ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{16.4} \.{\land} chins
 \.{\subseteq} Char}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} InitInt \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} aop \.{=}
 ...
 \.{=} Char}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} DoIns ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \E\, ins \.{\in}
 Ins \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{27.72} \.{\land} ins .
 pos \.{\in} 1 \.{\dotdot} ( Len ( state [ c ] ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{27.72} \.{\land} ins . ch
 \.{\in} chins}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{27.72} \.{\land} ins .
 pr\@s{0.07} \.{=} Priority [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{27.72} \.{\land} DoOp ( c
 ,\, ins )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{27.72} \.{\land} chins
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} DoDel ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \E\, del \.{\in}
 Del \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{27.72} \.{\land} del .
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} DoInt ( DoOp ( \_ ,\, \_ )
 ,\, c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c \.{\in} Client} issues an operation.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\land} \.{\lor}
 DoIns ( DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{27.51} \.{\lor} DoDel (
 DoOp ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land}
 ApplyNewAop ( c )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} RevInt ( c ) \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} SRevInt \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 ...
 {\UNCHANGED} chins}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 01 11:38:14 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
