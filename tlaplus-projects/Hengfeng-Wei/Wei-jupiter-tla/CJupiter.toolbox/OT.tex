...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} XformII ( lins ,\, rins )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} {\IF} lins . pos
 \.{<} rins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\THEN} lins}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 lins . pos \.{>} rins . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{47.71} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{47.71} \.{\ELSE} {\IF}
 lins . ch \.{=} rins . ch}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{79.02} \.{\THEN} Nop}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{79.02} \.{\ELSE} {\IF}
 lins . pr \.{>} rins . pr}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{110.33} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{110.33} \.{\ELSE} lins}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} XformID ( ins ,\, del )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} {\IF} ins . pos
 \.{\leq} del . pos}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\THEN} ins}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\ELSE} [ ins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} XformDI ( del ,\, ins )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} {\IF} del . pos
 \.{<} ins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\THEN} del}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\ELSE} [ del
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} XformDD ( ldel ,\, rdel )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} {\IF} ldel . pos
 \.{<} rdel . pos}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\THEN} ldel}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 ldel . pos \.{>} rdel . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{47.71} \.{\THEN} [ ldel
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{47.71} \.{\ELSE} Nop}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Xform ( lop ,\, rop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} {\CASE} lop \.{=}
 Nop \.{\lor} rop \.{=} Nop \.{\rightarrow} lop}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{28.69} {\Box}\@s{4.1} lop
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} {\RECURSIVE} XformOpOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} XformOpOps ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{32.65} \.{\THEN} op}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} {\RECURSIVE} XformOpOpsX (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} XformOpOpsX ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{32.65} \.{\THEN}
 {\langle} op {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}} XformOpsOp ( ops ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{16.4} \.{\LET} opX
 \.{\defeq} XformOpOpsX ( op ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\IN} [ i \.{\in}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}} {\RECURSIVE} XformOpsOps (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}} XformOpsOps ( ops1 ,\, ops2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} {\IF} ops2 \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{16.4} \.{\THEN} ops1}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \.{\ELSE}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 15:52:04 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
