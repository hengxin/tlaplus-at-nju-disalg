...
\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{148.99} xss \.{\mapsto}
 xss ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{148.99} lss\@s{2.08}
 \.{\mapsto} [ node \.{\mapsto} \{ vh \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{180.96} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} uh ,\, to \.{\mapsto} vh ,\, cop
 \.{\mapsto} coph ] \} ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 e \.{\defeq} NextEdge ( r ,\, uh ,\, ss )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{109.01} copprime
 \.{\defeq} e . cop}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{109.01} uprime \.{\defeq}
 e . to}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{109.01} vprime\@s{0.76}
 \.{\defeq} vh \.{\cup} \{ copprime . oid \}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{113.11} coph2copprime
 \.{\defeq} COT ( coph ,\, copprime )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{113.11} copprime2coph
 \.{\defeq} COT ( copprime ,\, coph )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.09}
 xFormHelper ( uprime ,\, vprime ,\, coph2copprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{125.41} xss \.{\oplus} [
 node \.{\mapsto} \{ vprime \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{154.04} edge\@s{1.53}
 \.{\mapsto} \{ [ from \.{\mapsto} vh ,\, to \.{\mapsto} vprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{202.16} cop\@s{1.78}
 \.{\mapsto} copprime2coph ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{195.28} [ from
 \.{\mapsto} uprime ,\, to \.{\mapsto} vprime ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{202.16} cop\@s{1.78}
 \.{\mapsto} coph2copprime ] \} ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 xFormHelper ( u ,\, v ,\, cop ,\, [ node \.{\mapsto} \{ v \} ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{149.63} edge\@s{1.53}
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 09 16:00:02 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
