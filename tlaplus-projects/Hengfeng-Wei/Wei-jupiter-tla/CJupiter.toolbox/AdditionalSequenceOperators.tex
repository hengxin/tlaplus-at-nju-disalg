...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} InsertElement ( seq ,\, elem
 ,\, index ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{8.2} [ i \.{\in} 1
 \.{\dotdot} ( Len ( seq ) \.{+} 1 ) \.{\mapsto} {\IF} i \.{<} index}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{124.92} \.{\THEN} {\IF} i
 \.{=} ( Len ( seq ) \.{+} 1 )}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{156.23} \.{\THEN} elem}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{156.23} \.{\ELSE} seq [ i
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{124.92} \.{\ELSE} {\IF} i
 \.{=} index}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{156.23} \.{\THEN} elem}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{156.23} \.{\ELSE} seq [ (
 i \.{-} 1 ) ] ]}%
\@y{\@s{0}%
 \ensuremath{i \.{>} index
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} IsSorted2Partition ( n ,\,
 seq1 ,\, seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{8.2} \.{\land} seq1
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{8.2} \.{\land} seq2
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{8.2} \.{\land} n \.{=}
 Len ( seq1 ) \.{+} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq1 ,\, j \.{\in} {\DOMAIN} seq1 \.{:} i \.{<} j
 \.{\implies} seq1 [ i ] \.{<} seq1 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq2 ,\, j \.{\in} {\DOMAIN} seq2 \.{:} i \.{<} j
 \.{\implies} seq2 [ i ] \.{<} seq2 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq1 ,\, j \.{\in} {\DOMAIN} seq2 \.{:} seq1 [ i ]
 \.{\neq} seq2 [ j ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} IsSequenceInterleaving ( seq
 ,\, subSeq1 ,\, subSeq2 ,\, indSeq1 ,\, indSeq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{8.2} \.{\land} indSeq1
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{8.2} \.{\land} indSeq2
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{8.2} \.{\land}
 IsSorted2Partition ( Len ( seq ) ,\, indSeq1 ,\, indSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq1 ) \.{=} Len ( subSeq1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq2 ) \.{=} Len ( subSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} SeqMaxLen ( S ,\, n )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}} SeqMap ( Op ( \_ ) ,\, seq
 ) \.{\defeq} [ x \.{\in} {\DOMAIN} seq \.{\mapsto} Op ( seq [ x ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} PermsWithin ( S )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} PermutationKey ( n
 )\@s{1.00} \.{\defeq} \{ key \.{\in} [ 1 \.{\dotdot} n \.{\rightarrow} 1
 \.{\dotdot} n ] \.{:} Range ( key ) \.{=} 1 \.{\dotdot} n \}}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}} PermutationsOf ( T )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}} {\RECURSIVE}
 FirstIndexOfElement ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} FirstIndexOfElement ( seq
 ,\, elem ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{16.4} {\IF} Head ( seq )
 \.{=} elem}%
\@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{16.4} \.{\THEN} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4} \.{\ELSE} 1 \.{+}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}} Compatible ( seq1 ,\, seq2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 144\hspace{1em}}\@s{16.4} \.{\lor} seq1
 \.{=} seq2}%
 \@x{\makebox[0pt][r]{\scriptsize 145\hspace{1em}}\@s{16.4} \.{\lor} \.{\LET}
 commonElements \.{\defeq} Range ( seq1 ) \.{\cap} Range ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 146\hspace{1em}}\@s{27.51} \.{\IN} \A\, e1
 ,\, e2 \.{\in} commonElements \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}}\@s{56.11} \.{\lor} e1 \.{=}
 e2}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}}\@s{56.11} \.{\lor}
 FirstIndexOfElement ( seq1 ,\, e1 ) \.{<} FirstIndexOfElement ( seq1 ,\, e2
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{67.22} \.{\equiv}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}} {\RECURSIVE} LCS ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}} LCS ( seq1 ,\, seq2 )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{24.13} {\IF} seq1 \.{=}
 {\langle} {\rangle} \.{\lor} seq2 \.{=} {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{24.13} \.{\THEN} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{24.13} \.{\ELSE} {\IF}
 Last ( seq1 ) \.{=} Last ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{55.44} \.{\THEN} 1 \.{+}
 LCS ( AllButLast ( seq1 ) ,\, AllButLast ( seq2 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{55.44} \.{\ELSE}
 MaxOfSet ( \{ LCS ( AllButLast ( seq1 ) ,\, seq2 ) ,\, LCS ( seq1 ,\,
 AllButLast ( seq2 ) ) \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}} LCSCompatible ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{16.4} Compatible ( seq1
 ,\, seq2 ) \.{\equiv} LCS ( seq1 ,\, seq2 ) \.{=} Cardinality ( Range ( seq1
 ) \.{\cap} Range ( seq2 ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}} LCSCompatibleTest ( S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{16.4} \A\, seq1 ,\, seq2
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 03 20:26:21 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
