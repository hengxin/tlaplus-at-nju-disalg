...
\ensuremath{AbsJupiter} with a history of all list states across the system.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} AbsJupiter}%
...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} FairnessH \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} {\WF}_{ varsH} (
 SRevH \.{\lor} \E\, c \.{\in} Client \.{:} RevH ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} SpecH \.{\defeq} InitH
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} WLSpec \.{\defeq} Comm ( Cop
 ) {\bang} EmptyChannel}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{62.82} \.{\implies} \A\,
 l1 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{82.48} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{82.48} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{82.48} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:08:53 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
