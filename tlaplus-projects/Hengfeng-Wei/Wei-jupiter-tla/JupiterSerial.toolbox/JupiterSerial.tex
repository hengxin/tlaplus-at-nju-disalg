...
\setboolean{shading}{true}
 ...
 {\MODULE} JupiterSerial}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This module contains definitions and operators for \ensuremath{Jupiter}
 protocols,
 \ensuremath{i.e}., \ensuremath{AbsJupiter} and \ensuremath{CJupiter},
 which utilizes the serialization order at the \ensuremath{Server} to guide
 \ensuremath{OTs}.
\end{cpar}%
\end{lcom}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} tb ( cop1 ,\, cop2 ,\, sv )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.54} \.{\LET}
 pos1\@s{4.09} \.{\defeq} FirstIndexOfElementSafe ( sv ,\, cop1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{41.04} pos2 \.{\defeq}
 FirstIndexOfElementSafe ( sv ,\, cop2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{20.64} \.{\IN} {\IF} pos1
 \.{\neq} 0 \.{\land} pos2 \.{\neq} 0}%
\@y{\@s{0}%
 at the server or both are remote operations
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{41.04} \.{\THEN} pos1
 \.{<} pos2}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{41.04} \.{\ELSE} {\IF}
 pos1 \.{=} 0 \.{\land} pos2 \.{=} 0}%
\@y{\@s{0}%
 at a client: both are local operations (not happen in \ensuremath{CJupiter})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{72.35} \.{\THEN} cop1 .
 seq \.{<} cop2 . seq}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{72.35} \.{\ELSE} pos1
 \.{\neq} 0\@s{29.90}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} serial ,\,}%
\@y{\@s{0}%
 \ensuremath{serial[r]}: the serial view of replica \ensuremath{r \.{\in}
 Replica} about the \ensuremath{Server
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} cincomingSerial ,\,
 sincomingSerial}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} serialVars\@s{7.21}
 \.{\defeq} {\langle} serial ,\, cincomingSerial ,\, sincomingSerial
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} commSerial \.{\defeq}
 {\INSTANCE} CSComm {\WITH} Msg \.{\leftarrow} Seq ( Oid ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{78.84} cincoming
 \.{\leftarrow} cincomingSerial ,\, sincoming \.{\leftarrow} sincomingSerial}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} TypeOKSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} serial
...
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} InitSerial \.{\defeq}}%
...
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} DoSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} {\UNCHANGED}
 {\langle} serialVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} RevSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ c ] \.{=} Head ( cincomingSerial [
 c ] ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} SRevSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 serial \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ Server ] \.{=} Append ( @
 ,\, cop . oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{47.91} \.{\land}
 commSerial {\bang} SSendSame ( cop . oid . c ,\, serial \.{'} [ Server ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sincomingSerial {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 12 21:04:36 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Dec} 05
 21:03:01 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
