...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{41.04} \.{\ELSE} pos1
 \.{\neq} 0}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} serial ,\,}%
\@y{\@s{0}%
 \ensuremath{serial[r]}: the serial view of replica \ensuremath{r \.{\in}
 Replica} about the server
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} cincomingSerial ,\,
 sincomingSerial}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} serialVars\@s{7.21}
 \.{\defeq} {\langle} serial ,\, cincomingSerial ,\, sincomingSerial
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} commSerial \.{\defeq}
 {\INSTANCE} CSComm {\WITH} Msg \.{\leftarrow} Seq ( Oid ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{78.84} cincoming
 \.{\leftarrow} cincomingSerial ,\, sincoming \.{\leftarrow} sincomingSerial}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} TypeOKSerial \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} InitSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{=} [ r \.{\in} Replica \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} Init}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} DoSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} {\UNCHANGED}
 {\langle} serialVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} RevSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ c ] \.{=} Head ( cincomingSerial [
 c ] ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} SRevSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 serial \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ Server ] \.{=} Append ( @
 ,\, cop . oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{47.91} \.{\land}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 06 10:26:06 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
