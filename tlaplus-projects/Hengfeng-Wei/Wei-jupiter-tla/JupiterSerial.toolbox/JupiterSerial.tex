...
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} tb ( oid1 ,\, oid2 ,\, sv )
 \.{\defeq}}%
\@y{\@s{0}%
 Is \ensuremath{oid1} totally ordered before \ensuremath{oid2} according to
 the serial view \ensuremath{sv} (of some replica)\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.54} \.{\LET}\@s{4.1}
 pos1 \.{\defeq} FirstIndexOfElementSafe ( sv ,\, oid1 )}%
\@y{\@s{0}%
 0 if \ensuremath{oid1} is not in \ensuremath{sv
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{41.04} pos2 \.{\defeq}
 FirstIndexOfElementSafe ( sv ,\, oid2 )}%
\@y{\@s{0}%
 0 if \ensuremath{oid2} is not in \ensuremath{sv
}}%
\@xx{}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{72.35} \.{\THEN} oid1 .
 seq \.{<} oid2 . seq}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 08 20:58:24 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
