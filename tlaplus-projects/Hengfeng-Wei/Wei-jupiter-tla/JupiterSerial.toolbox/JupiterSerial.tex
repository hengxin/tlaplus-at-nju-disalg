...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Specification of serial views used by \ensuremath{AbsJupiter} and
 \ensuremath{CJupiter}.
\end{cpar}%
\end{lcom}%
...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} serial ,\,}%
\@y{\@s{0}%
 \ensuremath{serial[r]}: the serial view of replica \ensuremath{r \.{\in}
 Replica} about the serialization order established at the \ensuremath{Server
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} cincomingSerial ,\,
 sincomingSerial}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} serialVars\@s{7.21}
 \.{\defeq} {\langle} serial ,\, cincomingSerial ,\, sincomingSerial
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} commSerial \.{\defeq}
 {\INSTANCE} CSComm {\WITH} Msg \.{\leftarrow} Seq ( Oid ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{78.84} cincoming
 \.{\leftarrow} cincomingSerial ,\, sincoming \.{\leftarrow} sincomingSerial}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} tb ( cop1 ,\, cop2 ,\, sv )
 \.{\defeq}}%
\@y{\@s{0}%
 Is \ensuremath{cop1} totally ordered before \ensuremath{cop2} according to
 the serial view \ensuremath{sv} (of some replica)\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.54} \.{\LET}
 pos1\@s{4.09} \.{\defeq} FirstIndexOfElementSafe ( sv ,\, cop1 )}%
\@y{\@s{0}%
 0 if \ensuremath{cop1} is not in \ensuremath{sv
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{41.04} pos2 \.{\defeq}
 FirstIndexOfElementSafe ( sv ,\, cop2 )}%
\@y{\@s{0}%
 0 if \ensuremath{cop2} is not in \ensuremath{sv
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.54} \.{\IN}\@s{4.09}
 {\IF} pos1 \.{\neq} 0 \.{\land} pos2 \.{\neq} 0}%
\@y{\@s{0}%
 at the server or at a client but both are remote operations
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{41.04} \.{\THEN} pos1
 \.{<} pos2}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{41.04} \.{\ELSE} {\IF}
 pos1 \.{=} 0 \.{\land} pos2 \.{=} 0}%
\@y{\@s{0}%
 at a client: both are local operations (may happen in
 \ensuremath{AbsJupiter})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{72.35} \.{\THEN} cop1 .
 seq \.{<} cop2 . seq}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{72.35} \.{\ELSE} pos1
 \.{\neq} 0\@s{29.90}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} TypeOKSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{\in} [ Replica \.{\rightarrow} Seq ( Oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} TypeOK}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} InitSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{=} [ r \.{\in} Replica \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} Init}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} DoSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} {\UNCHANGED}
 serialVars}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} RevSerial ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ c ] \.{=} Head ( cincomingSerial [
 c ] ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} SRevSerial \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{27.51} \.{\IN} \.{\land}
 serial \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ Server ] \.{=} Append ( @
 ,\, cop . oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{47.91} \.{\land}
 commSerial {\bang} SSendSame ( ClientOf ( cop ) ,\, serial \.{'} [ Server ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} sincomingSerial}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jan} 05
 16:27:57 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
