...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Transforms an operation sequence \ensuremath{ops1} against another operation
 sequence \ensuremath{ops2};
 see Definition 2.13 of the paper ``Imine@\ensuremath{TCS06}''.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} {\RECURSIVE} XformOpsOps (
 \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} XformOpsOps ( xform ( \_ ,\,
 \_ ) ,\, ops1 ,\, ops2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} {\IF} ops2 \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\THEN} ops1}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\ELSE}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 31 19:45:16 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
