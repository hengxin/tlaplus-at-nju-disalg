...
\@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} CP1 \.{\defeq}}%
 ...
 List \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{31.28} \A\, op1 \.{\in}
 OpOnList ( l ) ,\, op2 \.{\in} OpOnList ( l ) \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{42.60}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} PrintT(ToString(l) \.{\circ} \@w{, } \.{\circ}
 ToString(op1) \.{\circ} \@w{, } \.{\circ} ToString(op2))
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{42.60} \.{\land}}%
\@y{\@s{0}%
 Priorities of these two insertions cannot be the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{53.71} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op2 . type \.{=}\@w{Ins} \.{\land} op1 . pr
 \.{=} op2 . pr )}%
\@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{61.91}}%
\@y{\@s{0}%
 The \ensuremath{CP1} itself.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{53.71} \.{\lor} ApplyOps
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}} GCP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{16.4} \A\, l \.{\in}
 List ,\, ops1 \.{\in} SeqMaxLen ( Op ,\, 1 ) ,\, ops2 \.{\in} SeqMaxLen ( Op
 ,\, 1 ) \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{27.72}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor}} (\ensuremath{Head(ops1).type \.{=} \@w{Del} \.{\lor}
 Head(ops2).type \.{=} \@w{Del}})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{27.72} \.{\lor} ApplyOps
 ( ops1 \.{\circ} XformOpsOps ( ops2 ,\, ops1 ) ,\, l ) \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{38.83} ApplyOps ( ops2
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 06 16:18:49 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
