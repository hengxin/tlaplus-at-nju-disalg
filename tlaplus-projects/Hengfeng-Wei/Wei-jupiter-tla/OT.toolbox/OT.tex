...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} OpOperators ,\,
 SetUtils}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} xFormII ( lins ,\, rins )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{lins} is transformed against \ensuremath{rins
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} {\IF} lins . pos
 \.{<} rins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} \.{\THEN} lins}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 lins . pos \.{>} rins . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{47.71} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{47.71} \.{\ELSE} {\IF}
 lins . ch \.{=} rins . ch}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{79.02} \.{\THEN} Nop}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{79.02} \.{\ELSE} {\IF}
 lins . pr \.{>} rins . pr}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{110.33} \.{\THEN} [ lins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{110.33} \.{\ELSE} lins}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} xFormID ( ins ,\, del )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{ins} is transformed against \ensuremath{del
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} {\IF} ins . pos
 \.{\leq} del . pos}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\THEN} ins}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\ELSE} [ ins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} xFormDI ( del ,\, ins )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{del} is transformed against \ensuremath{ins
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} {\IF} del . pos
 \.{<} ins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\THEN} del}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\ELSE} [ del
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} xFormDD ( ldel ,\, rdel )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{ldel} is transformed against \ensuremath{rdel
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} {\IF} ldel . pos
 \.{<} rdel . pos}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\THEN} ldel}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 ldel . pos \.{>} rdel . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{47.71} \.{\THEN} [ ldel
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{47.71} \.{\ELSE} Nop}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} xForm ( lop ,\, rop )
 \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{lop} is transformed against \ensuremath{rop
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} {\CASE} lop \.{=}
 Nop \.{\lor} rop \.{=} Nop \.{\rightarrow} lop}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{28.69} {\Box}\@s{4.1} lop
 . type \.{=}\@w{Ins}\@s{2.27} \.{\land} rop . type \.{=}\@w{Ins}\@s{2.27}
 \.{\rightarrow} xFormII ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
 ...
 xFormDD ( lop ,\, rop )}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 20:14:40 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
