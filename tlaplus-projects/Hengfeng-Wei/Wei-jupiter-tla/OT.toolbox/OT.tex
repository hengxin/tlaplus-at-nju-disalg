...
Iteratively/recursively transforms the operation \ensuremath{op
 ...
 Different from \ensuremath{XformOpOps},
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{CP1} (Convergence) Property.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} CP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{19.96} \A\, l \.{\in}
 List ,\, op1 \.{\in} Op ,\, op2 \.{\in} Op \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{31.28}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} PrintT(ToString(l) \.{\circ} \@w{, } \.{\circ}
 ToString(op1) \.{\circ} \@w{, } \.{\circ} ToString(op2))
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{51.78}}%
\@y{\@s{0}%
 It is not allowed to delete elements from an empty list.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{31.28} \.{\land}
 \.{\lor} ( l \.{=} {\langle} {\rangle} \.{\land} ( op1 . type \.{=}\@w{Del}
 \.{\lor} op2 . type \.{=}\@w{Del} ) )}%
\@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Priorities of two Insertions cannot be the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op2 . type \.{=}\@w{Ins} \.{\land} op1 . pr
 \.{=} op2 . pr )}%
\@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Position of an insertion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op1 . pos \.{>} Len ( l ) \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@s{42.39} \.{\lor} ( op2 .
 type \.{=}\@w{Ins} \.{\land} op2 . pos \.{>} Len ( l ) \.{+} 1 )}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 Position of a deletion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{42.39} \.{\lor} ( op1 .
 type \.{=}\@w{Del} \.{\land} op1 . pos \.{>} Len ( l ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{42.39} \.{\lor} ( op2 .
 type \.{=}\@w{Del} \.{\land} op2 . pos \.{>} Len ( l ) )}%
\@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{50.59}}%
\@y{\@s{0}%
 The \ensuremath{CP1} itself.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{42.39} \.{\lor} ApplyOps
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 04 22:08:22 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
