...
\end{lcom}%
 ...
 Sequences ,\, AdditionalSequenceOperators}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\CONSTANTS}\@s{8.2} Char
 ,\,\@s{12.84}}%
\@y{\@s{0}%
 set of characters allowed
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{62.95} MaxPos ,\,}%
\@y{\@s{0}%
 max position to insert into or delete
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{62.95} MaxPr
 ,\,\@s{4.72}}%
\@y{\@s{0}%
 max priority
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{62.95} MaxLen\@s{6.16}}%
\@y{\@s{0}%
 max length of list
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\ASSUME} \.{\land} MaxPos
 \.{\in} Nat \.{\,\backslash\,} \{ 0 \}\@s{4.1}}%
\@y{\@s{0}%
 WARNING: index from 1
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{38.24} \.{\land} MaxPr
 \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{38.24} \.{\land} MaxLen
 \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{List \.{\defeq} Seq(Char) \.{\,\backslash\,}}* The set of all
 lists.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} List \.{\defeq} {\UNION} \{
 [ 1 \.{\dotdot} m \.{\rightarrow} Char ] \.{:} m \.{\in} 0 \.{\dotdot}
 MaxLen \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The set of all operations.
 In this specification, we will focus on \ensuremath{\@w{Ins}} and
 \ensuremath{\@w{Del}}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Op \.{\defeq}}%
\@y{\@s{0}%
 [type: \ensuremath{\{\@w{Rd}\}}] \ensuremath{\.{\cup} \.{\,\backslash\,}}* a
 read specifies no arguments
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{32.29} [ type \.{:}
 \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} MaxPos ] \.{\cup}}%
\@y{\@s{0}%
 a deletion specifies a position
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{32.29} [ type \.{:}
 \{\@w{Ins} \} ,\, pos\@s{2.27} \.{:} 1 \.{\dotdot} MaxPos ,\, ch \.{:} Char
 ,\, pr \.{:} 1 \.{\dotdot} MaxPr ]}%
\@y{\@s{0}%
 an insertion specifies a position, a character, and a priority
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Nop \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Op\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Del1 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Del2 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Del3 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Del4 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} Ins1\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 1 ,\, ch
 \.{\mapsto}\@w{a} ,\, pr\@s{0.36} \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} Ins2\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 2 ,\, ch
 \.{\mapsto}\@w{b} ,\, pr \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Ins3\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 3 ,\, ch
 \.{\mapsto}\@w{c} ,\, pr\@s{0.72} \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} Ops \.{\defeq} {\langle}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{l}.
 \ensuremath{Del}: If \ensuremath{pos \.{>} Len(l)}, the last element of
 \ensuremath{l} is deleted.
\end{cpar}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq} {\CASE} op \.{=} Nop \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
 op . type \.{=}\@w{Del} \.{\rightarrow} DeleteElement ( l ,\, op . pos )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} {\RECURSIVE} ApplyOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} ApplyOps ( ops ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\THEN} l}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\ELSE} Apply (
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 04 11:37:16 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
