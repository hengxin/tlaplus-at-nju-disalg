...
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{62.95} MaxLen}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\LET}
 len\@s{1.07} \.{\defeq} Len ( l )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{36.79} pos \.{\defeq} op
 . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\IN} {\CASE} op
 \.{=} Nop \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} {\Box}\@s{14.40}
 op . type \.{=}\@w{Del} \.{\rightarrow} DeleteElement ( l ,\, pos )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{40.89} {\Box}\@s{14.40}
 op . type \.{=}\@w{Ins}\@s{2.27} \.{\rightarrow} Append ( SubSeq ( l ,\, 1
 ,\, pos \.{-} 1 ) ,\, op . ch ) \.{\circ} SubSeq ( l ,\, pos ,\, len )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} {\RECURSIVE} ApplyOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} ApplyOps ( ops ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\THEN} l}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\ELSE} Apply (
 Last ( ops ) ,\, ApplyOps ( AllButLast ( ops ) ,\, l ) )}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 04 10:06:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
