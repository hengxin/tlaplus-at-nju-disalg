...
\end{lcom}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Ins1\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 1 ,\, ch
 \.{\mapsto}\@w{a} ,\, pr\@s{0.36} \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Ins2\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 2 ,\, ch
 \.{\mapsto}\@w{b} ,\, pr \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Ins3\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 3 ,\, ch
 \.{\mapsto}\@w{c} ,\, pr\@s{0.72} \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Ops \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\LET}
 len\@s{1.07} \.{\defeq} Len ( l )}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{36.79} pos \.{\defeq} op
 . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\IN} {\CASE} op
 . type \.{=}\@w{Del} \.{\rightarrow} SubSeq ( l ,\, 1 ,\, pos \.{-} 1 )
 \.{\circ} SubSeq ( l ,\, pos \.{+} 1 ,\, len )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{40.89} {\Box}\@s{14.40}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:16:55 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
