...
\setboolean{shading}{true}
 ...
 {\MODULE} AJupiterDo}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} Op ,\, TLC}%
...
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} cop ,\,\@s{20.5}}%
\@y{\@s{0}%
 \ensuremath{cop[c]}: operations issued by the client \ensuremath{c \.{\in}
 Client
}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer (of operations) at the client \ensuremath{c
 \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: the number of new messages have been received by the
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
 since the last time a message was sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} cstate ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} sbuf ,\,\@s{10.65}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} srec ,\,\@s{12.84}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: the number of new messages have been \.{\dots}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4}
 sincoming\@s{10.72}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} cVars \.{\defeq} {\langle}
 cop ,\, cbuf ,\, crec ,\, cstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} sVars\@s{0.51} \.{\defeq}
 {\langle} sbuf ,\, srec ,\, sstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} vars \.{\defeq} cVars
...
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 cop \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} comm
 {\bang} TypeOK}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} Init \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{22.34} \.{\land} Print
 (\@w{Do} ,\, {\TRUE} )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{22.34} \.{\land} cop [ c
 ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{22.34} \.{\land} \.{\LET}
 op \.{\defeq} Head ( cop [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{37.55} \.{\IN} \.{\land}
 Print ( op ,\, {\TRUE} )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{57.95} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{57.95} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{57.95} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{22.34} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{22.34} \.{\land} cop
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The \ensuremath{Spec}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jul} 01
 20:22:17 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Jul} 01 18:53:30
