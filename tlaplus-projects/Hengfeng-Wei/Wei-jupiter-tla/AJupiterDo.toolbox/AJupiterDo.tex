...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\ASSUME} \.{\land}
 InitState \.{\in} List}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{38.24} \.{\land} Cop
 \.{\in} [ Client \.{\rightarrow} Seq ( Op ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} cop ,\,\@s{20.5}}%
\@y{\@s{0}%
 \ensuremath{cop[c]}: operations issued by the client \ensuremath{c \.{\in}
 Client
}}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} cbuf ,\,\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{cbuf[c]}: buffer (of operations) at the client \ensuremath{c
 \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} crec ,\,\@s{14.49}}%
\@y{\@s{0}%
 \ensuremath{crec[c]}: the number of new messages have been received by the
 client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{83.26}}%
\@y{\@s{0}%
 since the last time a message was sent
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} cstate ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} sbuf ,\,\@s{10.65}}%
\@y{\@s{0}%
 \ensuremath{sbuf[c]}: buffer (of operations) at the \ensuremath{Server}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} srec ,\,\@s{12.84}}%
\@y{\@s{0}%
 \ensuremath{srec[c]}: the number of new messages have been \.{\dots}, one
 per client \ensuremath{c \.{\in} Client
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} sstate
 ,\,\@s{4.61}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} cincoming
 ,\,\@s{4.1}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4}
 sincoming\@s{10.72}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} comm \.{\defeq} {\INSTANCE}
 CSComm}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} cVars \.{\defeq} {\langle}
 cop ,\, cbuf ,\, crec ,\, cstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} sVars\@s{0.51} \.{\defeq}
 {\langle} sbuf ,\, srec ,\, sstate {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} vars \.{\defeq} cVars
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land} cbuf
 ...
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{\in} [ Client \.{\rightarrow} Seq ( Op \.{\cup} \{ Nop \} ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{\in} [ Client \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{\in} [ Client \.{\rightarrow} List ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land} cop \.{=}
 Cop}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For the client replicas:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\land} cbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\land} cstate
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land} sbuf
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} \.{\land} sstate
 \.{=} [ c \.{\in} Client \.{\mapsto} InitState ]}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For communication between the server and the clients:
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{22.34} \.{\land} Print
 (\@w{Do} ,\, {\TRUE} )}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{22.34} \.{\land} cop [ c
 ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{22.34} \.{\land} \.{\LET}
 op \.{\defeq} Head ( cop [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{37.55} \.{\IN} \.{\land}
 PrintT ( op )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{57.95} \.{\land} cstate
 \.{'} \.{=} [ cstate {\EXCEPT} {\bang} [ c ] \.{=} Apply ( op ,\, @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{57.95} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, op ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{57.95} \.{\land} comm
 {\bang} CSend ( [ c \.{\mapsto} c ,\, ack \.{\mapsto} crec [ c ] ,\, op
 \.{\mapsto} op ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{22.34} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{22.34} \.{\land} cop
 \.{'} \.{=} [ cop {\EXCEPT} {\bang} [ c ] \.{=} Tail ( @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{22.34} \.{\land}
 {\UNCHANGED} sVars}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}} Spec \.{\defeq} Init
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 07 14:21:06 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
