...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} ListUptoLen ( len )
 \.{\defeq} {\UNION} \{ [ 1 \.{\dotdot} m \.{\rightarrow} Char ] \.{:} m
 \.{\in} 0 \.{\dotdot} len \}\@s{12.29}}%
\@y{\@s{0}%
 including the empty list \ensuremath{{\langle}{\rangle}
}}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Rd \.{\defeq} [ type \.{:}
 \{\@w{Rd} \} ]}%
\@y{\@s{0}%
 a read specifies no arguments
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Ins\@s{1.35} \.{\defeq} [
 type \.{:} \{\@w{Del} \} ,\, pos \.{:} PosInt ]}%
\@y{\@s{0}%
 a deletion specifies a position, indexed from 1
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} Del \.{\defeq} [ type \.{:}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} Op \.{\defeq} Ins \.{\cup}
 Del\@s{4.1}}%
\@y{\@s{0}%
 Now we focus on \ensuremath{\@w{Ins}} and \ensuremath{\@w{Del}}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Nop \.{\defeq} PickNone ( Op
 )\@s{4.1}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Del1 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} Del2 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Del3 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Del4 \.{\defeq} [ type
 \.{\mapsto}\@w{Del} ,\, pos \.{\mapsto} 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} Ins1\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 1 ,\, ch
 \.{\mapsto}\@w{a} ,\, pr\@s{0.36} \.{\mapsto} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} Ins2\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 2 ,\, ch
 \.{\mapsto}\@w{b} ,\, pr \.{\mapsto} 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Ins3\@s{1.35} \.{\defeq} [
 type \.{\mapsto}\@w{Ins} ,\, pos\@s{2.27} \.{\mapsto} 3 ,\, ch
 \.{\mapsto}\@w{c} ,\, pr\@s{0.72} \.{\mapsto} 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Ops \.{\defeq} {\langle}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} Apply ( op ,\, l )
 ...
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} {\RECURSIVE} ApplyOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} ApplyOps ( ops ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\THEN} l}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\ELSE} Apply (
 Last ( ops ) ,\, ApplyOps ( AllButLast ( ops ) ,\, l ) )}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 07 14:20:05 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
