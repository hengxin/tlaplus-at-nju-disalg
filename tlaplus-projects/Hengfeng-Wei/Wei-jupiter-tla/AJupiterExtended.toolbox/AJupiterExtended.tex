...
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} TypeOK \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 cbuf \.{\in} [ Client \.{\rightarrow} Seq ( Cop ) ]}%
...
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} Init \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} InitInt}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} InitCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Msg ) {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land}
 crec\@s{2.19} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land}
 srec\@s{2.70} \.{=} [ c \.{\in} Client \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} cbuf
...
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} DoDel ( c ) \.{\defeq}}%
 ...
 {\UNCHANGED} chins}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} Do ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{22.34} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{22.34} \.{\land} \.{\lor}
 DoIns ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{33.45} \.{\lor} DoDel ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{22.34} \.{\land}
...
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Rev ( c ) \.{\defeq}}%
 ...
 Msg ) {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{20.94} \.{\land} crec
 \.{'} \.{=} [ crec {\EXCEPT} {\bang} [ c ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{20.94} \.{\land} \.{\LET}
 m \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{52.45} cBuf \.{\defeq}
 cbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{52.45} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{52.45} xcop \.{\defeq}
 XformOpOps ( COT ,\, m . cop ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{56.55} xcBuf \.{\defeq}
 XformOpsOp ( COT ,\, cShiftedBuf ,\, m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{36.15} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xcBuf ]}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{56.55} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ c ] \.{=} Apply ( xcop . op ,\, @ )
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{20.94} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{20.94} \.{\land}
...
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} SRev \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land} Comm (
 Msg ) {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 m \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{47.91} c\@s{3.77}
 \.{\defeq} ClientOf ( m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{47.91} cBuf \.{\defeq}
 sbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{47.91} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{47.91} xcop \.{\defeq}
 XformOpOps ( COT ,\, m . cop ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{52.01} xcBuf \.{\defeq}
 XformOpsOp ( COT ,\, cShiftedBuf ,\, m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{117.66} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{117.66} \.{\THEN} srec [
 cl ] \.{+} 1}%
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{117.66} \.{\ELSE} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{52.01} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{117.66} {\IF} cl \.{=} c}%
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{117.66} \.{\THEN} xcBuf}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{117.66} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xcop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{52.01} \.{\land} state
 \.{'} \.{=} [ state {\EXCEPT} {\bang} [ Server ] \.{=} Apply ( xcop . op ,\,
 @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{52.01} \.{\land} Comm (
 Msg ) {\bang} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto} [ ack
 \.{\mapsto} srec [ cl ] ,\, cop \.{\mapsto} xcop ,\, oid \.{\mapsto} xcop .
 oid ] ] )}%
\@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{16.4} \.{\land} SRevCtx}%
...
\@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} Do ( c ) \.{\lor} Rev ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\lor} SRev}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} Fairness \.{\defeq}}%
\@y{\@s{0}%
 There is no requirement that the clients ever generate operations.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} {\WF}_{ vars} (
 SRev \.{\lor} \E\, c \.{\in} Client \.{:} Rev ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} Spec \.{\defeq} Init
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} {\THEOREM} Spec
 \.{\implies} {\Box} QC}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:43:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
