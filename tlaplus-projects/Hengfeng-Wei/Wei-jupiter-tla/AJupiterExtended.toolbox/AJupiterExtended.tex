...
\@pvspace{8.0pt}%
 ...
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\LET} xform
 \.{\defeq} xFormShift ( COT ,\, m . cop ,\, cbuf [ c ] ,\, m . ack )}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 cbuf \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} xform . xops ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{36.79} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} @ \.{+} 1
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( c ,\, xform . xop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} ServerPerformEx ( m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\LET}\@s{16.4}
 c\@s{8.51} \.{\defeq} ClientOf ( m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{40.89} xform \.{\defeq}
 xFormShift ( COT ,\, m . cop ,\, sbuf [ c ] ,\, m . ack )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{44.99} xcop\@s{2.29}
 \.{\defeq} xform . xop}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 \.{\land} srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl
 \.{=} c \.{\THEN} srec [ cl ] \.{+} 1 \.{\ELSE} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{40.89} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl \.{=} c \.{\THEN} xform
 . xops}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{193.35} \.{\ELSE} Append
 ( sbuf [ cl ] ,\, xcop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xcop . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} \.{\land} Comm
 {\bang} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{139.72} [ ack \.{\mapsto}
 srec [ cl ] ,\, cop \.{\mapsto} xcop ,\, oid \.{\mapsto} xcop . oid ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{40.89} \.{\land} commXJ
 {\bang} SSendSame ( c ,\, xcop )}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} DoEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{25.28} \.{\land} DoInt (
 DoOpEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{25.28} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{25.28} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} RevEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} RevInt (
 ClientPerformEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} commXJ
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} SRevEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 SRevInt ( ServerPerformEx )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 SRevCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 commXJ {\bang} SRev}%
...
\@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} NextEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 \E\, c \.{\in} Client \.{:} DoEx ( c ) \.{\lor} RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 SRevEx}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} FairnessEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} {\WF}_{ varsEx} (
 SRevEx \.{\lor} \E\, c \.{\in} Client \.{:} RevEx ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} SpecEx \.{\defeq} InitEx
...
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} QC \.{\defeq}}%
\@y{\@s{0}%
 Quiescent Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{20.37} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} {\THEOREM} SpecEx
 \.{\implies} {\Box} QC}%
\@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 17 10:38:50 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
