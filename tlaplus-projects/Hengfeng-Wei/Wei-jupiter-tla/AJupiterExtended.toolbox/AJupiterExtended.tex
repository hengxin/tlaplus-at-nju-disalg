...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} commXJ \.{\defeq} {\INSTANCE}
 CSComm {\WITH} Msg \.{\leftarrow} Seq ( Cop ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{83.13} cincoming
 \.{\leftarrow} cincomingXJ ,\, sincoming \.{\leftarrow} sincomingXJ}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} varsEx\@s{8.99} \.{\defeq}
 {\langle} intVars ,\, ctxVars ,\, cbuf ,\, crec ,\, sbuf ,\, srec ,\,
 cincomingXJ ,\, sincomingXJ {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} AJMsgEx \.{\defeq} [ ack
 \.{:} Nat ,\, cop \.{:} Cop ,\, oid \.{:} Oid ]}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} TypeOKEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land}
 TypeOKInt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land}
 TypeOKCtx}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} commXJ
 {\bang} TypeOK}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} cbuf
...
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} InitEx \.{\defeq}}%
...
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} DoOpEx ( c ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\LET} cop
 ...
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{36.79} \.{\land} cbuf
 \.{'} \.{=} [ cbuf {\EXCEPT} {\bang} [ c ] \.{=} Append ( @ ,\, cop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{36.79} \.{\land}
 SetNewAop ( c ,\, op )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{36.79} \.{\land} Comm
 {\bang} CSend ( [ ack \.{\mapsto} crec [ c ] ,\, cop \.{\mapsto} cop ,\, oid
 \.{\mapsto} cop . oid ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{36.79} \.{\land} commXJ
 {\bang} CSend ( cop )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} ClientPerformEx ( c ,\, m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\LET} cBuf
 \.{\defeq} cbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{36.79} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 XformOpOps ( COT ,\, m . cop ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{40.89} xcBuf \.{\defeq}
 ...
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{40.89} \.{\land} crec
 \.{'}\@s{2.19} \.{=} [ crec {\EXCEPT} {\bang} [ c ]\@s{2.19} \.{=} @ \.{+} 1
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( c ,\, xcop . op )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} ServerPerformEx ( m )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\LET} c
 \.{\defeq} ClientOf ( m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{36.79} cBuf \.{\defeq}
 sbuf [ c ]}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{36.79} cShiftedBuf
 \.{\defeq} SubSeq ( cBuf ,\, m . ack \.{+} 1 ,\, Len ( cBuf ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{36.79} xcop \.{\defeq}
 XformOpOps ( COT ,\, m . cop ,\, cShiftedBuf )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{40.89} xcBuf \.{\defeq}
 XformOpsOp ( COT ,\, cShiftedBuf ,\, m . cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 \.{\land} srec \.{'}\@s{2.19} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{102.45} {\IF} cl \.{=} c
 \.{\THEN} srec [ cl ] \.{+} 1 \.{\ELSE} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{40.89} \.{\land} sbuf
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{102.45} {\IF} cl \.{=} c
 \.{\THEN} xcBuf \.{\ELSE} Append ( sbuf [ cl ] ,\, xcop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xcop . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{40.89} \.{\land} Comm
 {\bang} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto} [ ack \.{\mapsto} srec
 [ cl ] ,\, cop \.{\mapsto} xcop ,\, oid \.{\mapsto} xcop . oid ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{40.89} \.{\land} commXJ
 {\bang} SSendSame ( c ,\, xcop )}%
\@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} DoEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{25.28} \.{\land} DoInt (
 DoOpEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{25.28} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{25.28} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} RevEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\land} RevInt (
 ClientPerformEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\land} commXJ
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} SRevEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 ...
 commXJ {\bang} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 {\UNCHANGED} {\langle} cbuf ,\, crec {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} NextEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 \E\, c \.{\in} Client \.{:} DoEx ( c ) \.{\lor} RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 SRevEx}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} FairnessEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{16.4} {\WF}_{ varsEx} (
 SRevEx \.{\lor} \E\, c \.{\in} Client \.{:} RevEx ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} SpecEx \.{\defeq} InitEx
...
\@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} QC \.{\defeq}}%
\@y{\@s{0}%
 Quiescent Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{20.37} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} {\THEOREM} SpecEx
 \.{\implies} {\Box} QC}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 21:50:37 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
