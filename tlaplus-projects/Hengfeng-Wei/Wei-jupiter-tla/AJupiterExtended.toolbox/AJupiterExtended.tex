...
\@pvspace{8.0pt}%
 ...
 \.{\defeq} xFormShift ( COT ,\, m . cop ,\, cbuf [ c ] ,\, m . ack \.{+} 1
 )}%
...
\@pvspace{8.0pt}%
 ...
 xFormShift ( COT ,\, m . cop ,\, sbuf [ c ] ,\, m . ack \.{+} 1 )}%
 ...
 . xops \.{\ELSE} Append ( sbuf [ cl ] ,\, xcop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{40.89} \.{\land}
 SetNewAop ( Server ,\, xcop . op )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{40.89} \.{\land} Comm
 {\bang} SSend ( c ,\, [ cl \.{\in} Client \.{\mapsto} [ ack \.{\mapsto} srec
 [ cl ] ,\, cop \.{\mapsto} xcop ,\, oid \.{\mapsto} xcop . oid ] ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} \.{\land} commXJ
 {\bang} SSendSame ( c ,\, xcop )}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} DoEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{25.28} \.{\land} DoInt (
 DoOpEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{25.28} \.{\land} DoCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{25.28} \.{\land}
...
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} RevEx ( c ) \.{\defeq}}%
 ...
 ClientPerformEx ,\, c )}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{16.4} \.{\land} RevCtx (
 c )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} commXJ
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} sbuf ,\, srec {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} SRevEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 SRevInt ( ServerPerformEx )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 SRevCtx}%
...
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} NextEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 \E\, c \.{\in} Client \.{:} DoEx ( c ) \.{\lor} RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 SRevEx}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} FairnessEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} {\WF}_{ varsEx} (
 SRevEx \.{\lor} \E\, c \.{\in} Client \.{:} RevEx ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} SpecEx \.{\defeq} InitEx
...
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} QC \.{\defeq}}%
\@y{\@s{0}%
 Quiescent Consistency
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{20.37} Comm {\bang}
 EmptyChannel \.{\implies} Cardinality ( Range ( state ) ) \.{=} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} {\THEOREM} SpecEx
 \.{\implies} {\Box} QC}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jan} 12
 21:09:03 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
