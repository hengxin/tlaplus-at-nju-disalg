...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} XformID ( ins ,\, del )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} {\IF} ins . pos
 \.{\leq} del . pos}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\THEN} ins}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\ELSE} [ ins
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} XformDI ( del ,\, ins )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} {\IF} del . pos
 \.{<} ins . pos}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\THEN} del}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\ELSE} [ del
 {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} XformDD ( ldel ,\, rdel )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} {\IF} ldel . pos
 \.{<} rdel . pos}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\THEN} ldel}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\ELSE} {\IF}
 ldel . pos \.{>} rdel . pos}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{47.71} \.{\THEN} [ ldel
 {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{47.71} \.{\ELSE} Nop}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} Xform ( lop ,\, rop )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} {\CASE} lop \.{=}
 Nop \.{\lor} rop \.{=} Nop \.{\rightarrow} lop}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{28.69} {\Box}\@s{4.1} lop
 . type \.{=}\@w{Ins}\@s{2.27} \.{\land} rop . type \.{=}\@w{Ins}\@s{2.27}
 \.{\rightarrow} XformII ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
 lop . type \.{=}\@w{Ins}\@s{2.27} \.{\land} rop . type \.{=}\@w{Del}
 \.{\rightarrow} XformID ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
 lop . type \.{=}\@w{Del} \.{\land} rop . type \.{=}\@w{Ins}\@s{2.27}
 \.{\rightarrow} XformDI ( lop ,\, rop )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{28.69} {\Box}\@s{4.10}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} {\RECURSIVE} XformOpOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} XformOpOps ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{32.65} \.{\THEN} op}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} {\RECURSIVE} XformOpOpsX (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} XformOpOpsX ( op ,\, ops )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{32.65} \.{\THEN}
 {\langle} op {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{32.65} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} XformOpsOp ( ops ,\, op )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{16.4} \.{\LET} opX
 \.{\defeq} XformOpOpsX ( op ,\, ops )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{16.4} \.{\IN} [ i \.{\in}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}} {\RECURSIVE} XformOpsOps (
 \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} XformOpsOps ( ops1 ,\, ops2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{16.4} {\IF} ops2 \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{16.4} \.{\THEN} ops1}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{16.4} \.{\ELSE}
 XformOpsOps ( XformOpsOp ( ops1 ,\, Head ( ops2 ) ) ,\, Tail ( ops2 ) )}%
\@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 28 10:37:02 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
