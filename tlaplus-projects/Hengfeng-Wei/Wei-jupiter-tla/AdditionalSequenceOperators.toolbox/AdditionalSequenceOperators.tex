...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} FiniteSets ,\,
 Sequences ,\, TLC ,\, AdditionalSetOperators ,\,
 AdditionalFunctionOperators}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} Prepend ( s ,\, e )
 \.{\defeq} {\langle} e {\rangle} \.{\circ} s}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} First ( seq ) \.{\defeq} seq
 [ 1 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Last ( seq ) \.{\defeq} seq
 [ Len ( seq ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} AllButFirst ( seq )
 \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} seq
 [ ( i \.{+} 1 ) ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} AllButLast ( seq )
 \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} seq
 [ i ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} DoesSeqPrefixSeq ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{8.2} \.{\land} Len ( seq1
 ) \.{\leq} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} 1 \.{\dotdot} Len ( seq1 ) \.{:} seq1 [ i ] \.{=} seq2 [ i ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} DoesSeqProperlyPrefixSeq (
 seq1 ,\, seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{8.2} \.{\land} Len ( seq1
 ) \.{<} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} 1 \.{\dotdot} Len ( seq1 ) \.{:} seq1 [ i ] \.{=} seq2 [ i ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} IsElementInSeq ( el ,\, seq
 ) \.{\defeq} \E\, i \.{\in} {\DOMAIN} seq \.{:} seq [ i ] \.{=} el}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} IsSequenceOfSetElements (
 seq ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{8.2} \.{\land} Len ( seq
 ) \.{=} Cardinality ( set )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{8.2} \.{\land} ( \A\, el
 \.{\in} set \.{:} IsElementInSeq ( el ,\, seq ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}
 IsSortedSequenceOfSetElements ( seq ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{8.2} \.{\land}
 IsSequenceOfSetElements ( seq ,\, set )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq ,\, j \.{\in} {\DOMAIN} seq \.{:} i \.{<} j
 \.{\implies} seq [ i ] \.{<} seq [ j ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} DeleteElement ( seq ,\,
 index ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{8.2} [ i \.{\in} 1
 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} {\IF} i \.{<} index
 \.{\THEN} seq [ i ] \.{\ELSE} seq [ ( i \.{+} 1 ) ] ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Retain only the elements in \ensuremath{R} in their original order in
 \ensuremath{seq}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} {\RECURSIVE} Retain ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Retain ( seq ,\, R )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} {\IF} seq \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\THEN} {\langle}
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 h \.{\defeq} Head ( seq )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{51.81} \.{\IN} {\IF} h
 \.{\in} R}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{72.21} \.{\THEN}
 {\langle} h {\rangle} \.{\circ} Retain ( Tail ( seq ) ,\, R )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{72.21} \.{\ELSE} Retain (
 Tail ( seq ) ,\, R )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} InsertElement ( seq ,\, elem
 ,\, index ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{8.2} [ i \.{\in} 1
 \.{\dotdot} ( Len ( seq ) \.{+} 1 ) \.{\mapsto} {\IF} i \.{<} index}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{124.92} \.{\THEN} {\IF} i
 \.{=} ( Len ( seq ) \.{+} 1 )}%
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{156.23} \.{\THEN} elem}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{156.23} \.{\ELSE} seq [ i
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{124.92} \.{\ELSE} {\IF} i
 \.{=} index}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{156.23} \.{\THEN} elem}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{156.23} \.{\ELSE} seq [ (
 i \.{-} 1 ) ] ]}%
\@y{\@s{0}%
 \ensuremath{i \.{>} index
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} IsSorted2Partition ( n ,\,
 seq1 ,\, seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{8.2} \.{\land} seq1
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{8.2} \.{\land} seq2
 \.{\in} Seq ( 1 \.{\dotdot} n )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{8.2} \.{\land} n \.{=}
 Len ( seq1 ) \.{+} Len ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq1 ,\, j \.{\in} {\DOMAIN} seq1 \.{:} i \.{<} j
 \.{\implies} seq1 [ i ] \.{<} seq1 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq2 ,\, j \.{\in} {\DOMAIN} seq2 \.{:} i \.{<} j
 \.{\implies} seq2 [ i ] \.{<} seq2 [ j ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} seq1 ,\, j \.{\in} {\DOMAIN} seq2 \.{:} seq1 [ i ]
 \.{\neq} seq2 [ j ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} IsSequenceInterleaving ( seq
 ,\, subSeq1 ,\, subSeq2 ,\, indSeq1 ,\, indSeq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{8.2} \.{\land} indSeq1
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{8.2} \.{\land} indSeq2
 \.{\in} Seq ( Nat )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{8.2} \.{\land}
 IsSorted2Partition ( Len ( seq ) ,\, indSeq1 ,\, indSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq1 ) \.{=} Len ( subSeq1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{8.2} \.{\land} Len (
 indSeq2 ) \.{=} Len ( subSeq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
 \.{\in} {\DOMAIN} indSeq1 \.{:} seq [ ( indSeq1 [ i ] ) ] \.{=} subSeq1 [ i
 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{8.2} \.{\land} ( \A\, i
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}} SeqMaxLen ( S ,\, n )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}} SeqMap ( Op ( \_ ) ,\, seq
 ) \.{\defeq} [ x \.{\in} {\DOMAIN} seq \.{\mapsto} Op ( seq [ x ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}} PermsWithin ( S )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}} PermutationKey ( n
 )\@s{1.00} \.{\defeq} \{ key \.{\in} [ 1 \.{\dotdot} n \.{\rightarrow} 1
 \.{\dotdot} n ] \.{:} Range ( key ) \.{=} 1 \.{\dotdot} n \}}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}} PermutationsOf ( T )
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}} {\RECURSIVE}
 FirstIndexOfElement ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} FirstIndexOfElement ( seq
 ,\, elem ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} {\IF} Head ( seq )
 \.{=} elem}%
\@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{16.4} \.{\THEN} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{16.4} \.{\ELSE} 1 \.{+}
 FirstIndexOfElement ( Tail ( seq ) ,\, elem )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Get the index of the first occurence of \ensuremath{elem} in \ensuremath{seq}.
 It returns 0 if \ensuremath{elem} does not occur in \ensuremath{seq}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 147\hspace{1em}} {\RECURSIVE}
 FirstIndexOfElementSafe ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}} FirstIndexOfElementSafe (
 seq ,\, elem ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} FirstIndexOfElementSafeHelper ( \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{40.89}
 FirstIndexOfElementSafeHelper ( seqh ,\, elemh ,\, fail ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{57.29} {\IF} seqh \.{=}
 {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{57.29} \.{\THEN} 0 \.{-}
 fail}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{57.29} \.{\ELSE} {\IF}
 Head ( seqh ) \.{=} elemh}%
\@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{88.61} \.{\THEN} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{88.61} \.{\ELSE} 1 \.{+}
 FirstIndexOfElementSafeHelper ( Tail ( seqh ) ,\, elemh ,\, fail \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{20.5} \.{\IN}
 FirstIndexOfElementSafeHelper ( seq ,\, elem ,\, 0 )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}} Compatible ( seq1 ,\, seq2
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{16.4} \.{\lor} seq1
 \.{=} seq2}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{16.4} \.{\lor} \.{\LET}
 commonElements \.{\defeq} Range ( seq1 ) \.{\cap} Range ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{27.51} \.{\IN} \A\, e1
 ,\, e2 \.{\in} commonElements \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{56.11} \.{\lor} e1 \.{=}
 e2}%
 \@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@s{56.11} \.{\lor}
 FirstIndexOfElement ( seq1 ,\, e1 ) \.{<} FirstIndexOfElement ( seq1 ,\, e2
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{67.22} \.{\equiv}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}} {\RECURSIVE} LCS ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 182\hspace{1em}} LCS ( seq1 ,\, seq2 )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 183\hspace{1em}}\@s{24.13} {\IF} seq1 \.{=}
 {\langle} {\rangle} \.{\lor} seq2 \.{=} {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}}\@s{24.13} \.{\THEN} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 185\hspace{1em}}\@s{24.13} \.{\ELSE} {\IF}
 Last ( seq1 ) \.{=} Last ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 186\hspace{1em}}\@s{55.44} \.{\THEN} 1 \.{+}
 LCS ( AllButLast ( seq1 ) ,\, AllButLast ( seq2 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}}\@s{55.44} \.{\ELSE}
 MaxOfSet ( \{ LCS ( AllButLast ( seq1 ) ,\, seq2 ) ,\, LCS ( seq1 ,\,
 AllButLast ( seq2 ) ) \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 189\hspace{1em}} LCSCompatible ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}}\@s{16.4} Compatible ( seq1
 ,\, seq2 ) \.{\equiv} LCS ( seq1 ,\, seq2 ) \.{=} Cardinality ( Range ( seq1
 ) \.{\cap} Range ( seq2 ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 192\hspace{1em}} LCSCompatibleTest ( S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}}\@s{16.4} \A\, seq1 ,\, seq2
 \.{\in} PermsWithin ( S ) \.{:} LCSCompatible ( seq1 ,\, seq2 )}%
\@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 05 21:10:44 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
