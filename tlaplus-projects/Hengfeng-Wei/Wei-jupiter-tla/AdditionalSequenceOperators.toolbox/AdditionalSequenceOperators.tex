...
\end{lcom}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{16.4} \.{\IN} \A\, e1
 \.{\in} commonElements \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{40.89} \A\, e2 \.{\in}
 commonElements \.{\,\backslash\,} \{ e1 \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{52.22}
 FirstIndexOfElement ( seq1 ,\, e1 ) \.{<} FirstIndexOfElement ( seq1 ,\, e2
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{52.22} \.{\equiv}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}} {\RECURSIVE} LCS ( \_ ,\,
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}} LCS ( seq1 ,\, seq2 )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{24.13} {\IF} seq1 \.{=}
 {\langle} {\rangle} \.{\lor} seq2 \.{=} {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{24.13} \.{\THEN} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}\@s{24.13} \.{\ELSE} {\IF}
 Last ( seq1 ) \.{=} Last ( seq2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{55.44} \.{\THEN} 1 \.{+}
 LCS ( AllButLast ( seq1 ) ,\, AllButLast ( seq2 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{55.44} \.{\ELSE}
 MaxOfSet ( \{ LCS ( AllButLast ( seq1 ) ,\, seq2 ) ,\, LCS ( seq1 ,\,
 AllButLast ( seq2 ) ) \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}} LCSCompatible ( seq1 ,\,
 seq2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{16.4} Compatible ( seq1
 ,\, seq2 ) \.{\equiv} LCS ( seq1 ,\, seq2 ) \.{=} Cardinality ( Range ( seq1
 ) \.{\cap} Range ( seq2 ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}} LCSCompatibleTest ( S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{16.4} \A\, seq1 ,\, seq2
 \.{\in} PermsWithin ( S ) \.{:} LCSCompatible ( seq1 ,\, seq2 )}%
\@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 12 20:35:56 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
