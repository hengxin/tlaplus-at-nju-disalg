...
\@z{%
 ...
 \@xx{\@s{32.8} Prepend ( s ,\, e ) \.{\defeq} {\langle} e {\rangle} \.{\circ}
 s}%
\@pvspace{8.0pt}%
...
\@xx{\@s{32.8} First ( seq ) \.{\defeq} seq [ 1 ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}}%
\@z{%
 Defn
}%
\@xx{\@s{32.8} Last ( seq ) \.{\defeq} seq [ Len ( seq ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}}%
\@z{%
 Defn
}%
 \@xx{\@s{32.8} AllButFirst ( seq ) \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len
 ( seq ) \.{-} 1 ) \.{\mapsto} seq [ ( i \.{+} 1 ) ] ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}}%
\@z{%
 Defn
}%
 \@xx{\@s{32.8} AllButLast ( seq ) \.{\defeq} [ i \.{\in} 1 \.{\dotdot} ( Len
 ( seq ) \.{-} 1 ) \.{\mapsto} seq [ i ] ]}%
\@pvspace{8.0pt}%
...
\@xx{\@s{32.8} DoesSeqPrefixSeq ( seq1 ,\, seq2 ) \.{\defeq}}%
...
\@xx{\@s{27.29} DoesSeqProperlyPrefixSeq ( seq1 ,\, seq2 ) \.{\defeq}}%
...
\@z{%
 ...
 \@xx{\@s{27.29} IsElementInSeq ( el ,\, seq ) \.{\defeq} \E\, i \.{\in}
 {\DOMAIN} seq \.{:} seq [ i ] \.{=} el}%
\@pvspace{8.0pt}%
...
\@xx{\@s{27.29} IsSequenceOfSetElements ( seq ,\, set ) \.{\defeq}}%
...
\@xx{\@s{27.29} IsSortedSequenceOfSetElements ( seq ,\, set ) \.{\defeq}}%
...
\@xx{\@s{27.29} DeleteElement ( seq ,\, index ) \.{\defeq}}%
...
\@xx{\@s{32.8} InsertElement ( seq ,\, elem ,\, index ) \.{\defeq}}%
...
\@xx{\@s{27.36} IsSorted2Partition ( n ,\, seq1 ,\, seq2 ) \.{\defeq}}%
...
\@z{%
 ...
 \@xx{\@s{27.29} IsSequenceInterleaving ( seq ,\, subSeq1 ,\, subSeq2 ,\,
 indSeq1 ,\, indSeq2 ) \.{\defeq}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 04 11:21:54 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
