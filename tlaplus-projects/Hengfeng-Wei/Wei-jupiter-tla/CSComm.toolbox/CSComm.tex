...
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} SRev \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} receives and consumes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} SSend ( c ,\, cmsg )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{155.61} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{155.61} \.{\ELSE} Append
 ( cincoming [ cl ] ,\, cmsg [ cl ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} SSendSame ( c ,\, msg )
 \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} SSend ( c
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 03 09:46:24 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
