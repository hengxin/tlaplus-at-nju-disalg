...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} {\ASSUME} ( TLCSet ( 1 ,\,
 {\langle}\@w{EmptyChannel} ,\, 0 {\rangle} ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} WLSpec \.{\defeq} ( Comm (
 Cop ) {\bang} EmptyChannel \.{\land} TLCCnt ( 1 ,\, 100 ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{62.61}
 \.{\implies}\@s{9.73} \A\, l1 ,\, l2 \.{\in} list \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{92.00} \.{\land}
 Injective ( l1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{92.00} \.{\land}
 Injective ( l2 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{92.00} \.{\land}
 Compatible ( l1 ,\, l2 )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 04 21:15:55 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
