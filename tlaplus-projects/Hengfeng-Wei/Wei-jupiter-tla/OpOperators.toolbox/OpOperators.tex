...
\setboolean{shading}{true}
 ...
 {\MODULE} OpOperators}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Operators for \ensuremath{Op}.
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Apply ( op ,\, l )
 \.{\defeq} {\CASE} op . type \.{=}\@w{Rd} \.{\rightarrow} l}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
 op . type \.{=}\@w{Del} \.{\rightarrow} DeleteElement ( l ,\, op . pos )}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
 op . type \.{=}\@w{Ins}\@s{2.27} \.{\rightarrow} InsertElement ( l ,\, op .
 ch ,\, op . pos )}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{77.27} {\Box}\@s{14.40}
 {\OTHER} \.{\rightarrow} l}%
\@y{\@s{0}%
 maybe an \ensuremath{NOP
}}%
\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} {\RECURSIVE} ApplyOps ( \_
 ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} ApplyOps ( ops ,\, l )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} {\IF} ops \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\THEN} l}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\ELSE} Apply (
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} IsLegalOp ( op ,\, l )
 \.{\defeq} {\CASE} op . type \.{=}\@w{Del} \.{\rightarrow} op . pos \.{\leq}
 Len ( l )}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{94.78} {\Box}\@s{14.40}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 15:07:47 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 28
 14:58:54 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
