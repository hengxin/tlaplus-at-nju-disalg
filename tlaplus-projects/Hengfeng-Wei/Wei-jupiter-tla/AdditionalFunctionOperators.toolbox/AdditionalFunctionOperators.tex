...
\setboolean{shading}{true}
 ...
 {\MODULE} AdditionalFunctionOperators}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Range ( f ) \.{\defeq} \{ f [
 a ] \.{:} a \.{\in} {\DOMAIN} f \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Injective ( f ) \.{\defeq}
 \A\, a ,\, b \.{\in} {\DOMAIN} f \.{:} ( a \.{\neq} b ) \.{\implies} ( f [ a
 ] \.{\neq} f [ b ] )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Surjective ( f ,\, B )
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 28 10:42:46 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
