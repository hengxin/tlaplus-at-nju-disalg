...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} TLCCnt ( i ,\, multiplier )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\land} TLCSet (
 i ,\, [ TLCGet ( i ) {\EXCEPT} {\bang} [ 2 ] \.{=} @ \.{+} 1 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\land} ( TLCGet
 ( i ) \.{\%} multiplier \.{=} 0 ) \.{\implies} PrintT ( TLCGet ( i ) )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 11 20:02:38 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
