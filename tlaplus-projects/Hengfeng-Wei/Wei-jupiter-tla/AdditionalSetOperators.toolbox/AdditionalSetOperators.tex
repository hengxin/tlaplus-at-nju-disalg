...
\setboolean{shading}{true}
 ...
 {\MODULE} AdditionalSetOperators}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Copyright: https:\ensuremath{\.{\slsl}www.learntla.com}/libraries/sets/
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\EXTENDS} Naturals ,\, TLC}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Pick an element from the set \ensuremath{S}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Pick ( S ) \.{\defeq}
 {\CHOOSE} s \.{\in} S \.{:} {\TRUE}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Pick an element that is not in the set \ensuremath{S}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} PickNone ( S ) \.{\defeq}
 {\CHOOSE} s \.{:} s \.{\notin} S}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\RECURSIVE} SetReduce ( \_
 ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} SetReduce ( Op ( \_ ,\, \_ )
 ,\, S ,\, value ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} {\IF} S \.{=} \{
 \}}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\THEN} value}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 s \.{\defeq} Pick ( S )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{47.71} \.{\IN} SetReduce
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} {\RECURSIVE} SetReduceSafe (
 \_ ,\, \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} SetReduceSafe ( Op ( \_ ,\,
 \_ ) ,\, S ,\, value ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} {\IF} S \.{=} \{
 \}}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\THEN} value}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 s \.{\defeq} Pick ( S )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{47.71} \.{\IN} {\IF} Op (
 s ,\, value ) \.{=} Op ( value ,\, s )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{68.11} \.{\THEN}
 SetReduceSafe ( Op ,\, S \.{\,\backslash\,} \{ s \} ,\, Op ( s ,\, value )
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{68.11} \.{\ELSE} Assert (
 {\FALSE} ,\,\@w{Op\ is\ not\ commutative.} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} Sum ( S ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{23.82} \.{\LET} sum ( a
 ,\, b ) \.{\defeq} a \.{+} b}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{23.82} \.{\IN} SetReduce
 ( sum ,\, S ,\, 0 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} IsMin ( set ,\, min )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land} min
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} ( \A\, x
 \.{\in} set \.{:} min \.{\leq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} IsMax ( set ,\, max )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} max
 \.{\in} set}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} ( \A\, x
 \.{\in} set \.{:} max \.{\geq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} Min ( set )\@s{1.49}
 \.{\defeq} {\CHOOSE} min\@s{1.49} \.{\in} set \.{:} ( \A\, x \.{\in} set
 \.{:} min \.{\leq} x )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} Max ( set ) \.{\defeq}
 {\CHOOSE} max \.{\in} set \.{:} ( \A\, x \.{\in} set \.{:} max \.{\geq} x )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 06 13:39:14 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jul} 06
 13:21:26 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
