...
vars == <<eVars, cVars, commVars, c2ssVars, s2ssVars, state>> \* all variables
-----------------------------------------------------------------------------
(* 
...
Rev(c) == 
    ...
    /\ UNCHANGED <<eVars, cVars, s2ssVars>>
-----------------------------------------------------------------------------
(*
...
CSSync == 
    \forall c \in Client: 
        (ccur[c] = scur[c] /\ TLCCnt(1, 100)) => c2ss[c] = s2ss[c]
=============================================================================
\* Modification History
\* Last modified Wed Nov 07 10:41:21 CST 2018 by hengxin
