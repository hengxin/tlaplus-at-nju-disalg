...
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} Client ,\,\@s{1.66}}%
\@y{\@s{0}%
 the set of clients
}%
\@xx{}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} Msg\@s{16.50}}%
\@y{\@s{0}%
 the set of messages
}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} {\VARIABLES}}%
 ...
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{cincoming[c]}: incoming channel at client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land}
 sincoming\@s{0.51} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} EmptyChannel \.{\defeq}
 Init}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} CSend ( msg ) \.{\defeq}}%
\@y{\@s{0}%
 A client sends a message \ensuremath{msg} to the \ensuremath{Server}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Append ( sincoming ,\, msg )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} cincoming}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} CRev ( c ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c} receives and consumes a message from the
 \ensuremath{Server}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{24.21} \.{\land}
 cincoming [ c ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{24.21} \.{\land}
 cincoming \.{'} \.{=} [ cincoming {\EXCEPT} {\bang} [ c ] \.{=} Tail ( @ )
 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{24.21} \.{\land}
 {\UNCHANGED} sincoming}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{SRev}/\ensuremath{SSend} below is often used as a subaction. No
 \ensuremath{{\UNCHANGED}} in their definitions.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} SRev \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} receives and consumes a message.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} sincoming
 \.{'} \.{=} Tail ( sincoming )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} SSend ( c ,\, cmsg )
 \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} sents a message \ensuremath{cmsg} to each client
 other than \ensuremath{c \.{\in} Client}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} cincoming
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{99.45} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{99.45} \.{\THEN}
 cincoming [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{99.45} \.{\ELSE} Append (
 cincoming [ cl ] ,\, cmsg [ cl ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} SSendSame ( c ,\, msg )
 \.{\defeq}}%
\@y{\@s{0}%
 The \ensuremath{Server} broadcasts the message \ensuremath{msg} to all
 clients other than \ensuremath{c \.{\in} Client}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land} SSend ( c
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 14:37:41 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
