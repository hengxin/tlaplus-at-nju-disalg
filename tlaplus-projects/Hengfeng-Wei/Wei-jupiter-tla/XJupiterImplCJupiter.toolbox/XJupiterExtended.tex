...
\ensuremath{XJupiter} extended with serial views.
 This is used to show that \ensuremath{XJupiter} implements
 \ensuremath{CJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\EXTENDS} XJupiter}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\VARIABLES}}%
\begin{lcom}{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Simulating the behavior of propagating original operations in
 \ensuremath{CJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} cincomingCJ ,\,}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} sincomingCJ
 ,\,\@s{0.51}}%
\@y{\@s{0}%
 (not used)
}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} serial ,\,}%
\@y{\@s{0}%
 \ensuremath{serial[r]}: the serial view of replica \ensuremath{r \.{\in}
 Replica} about the server
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} cincomingSerial
 ,\,}%
\@y{\@s{0}%
 \ensuremath{cincomingSerial[c]}: the serival view received by client
 \ensuremath{c \.{\in} Client
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{92.67}}%
\@y{\@s{0}%
 from the \ensuremath{Server
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4}
 sincomingSerial\@s{6.62}}%
\@y{\@s{0}%
 (not used)
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} commCJVars \.{\defeq}
 {\langle} cincomingCJ ,\, sincomingCJ {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} serialVars\@s{14.32}
 \.{\defeq} {\langle} serial ,\, cincomingSerial ,\, sincomingSerial
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} varsEx \.{\defeq} {\langle}
 commCJVars ,\, serialVars ,\, vars {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} commCJ \.{\defeq}
 {\INSTANCE} CSComm {\WITH} Msg \.{\leftarrow} Seq ( Cop ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{82.85} cincoming
 \.{\leftarrow} cincomingCJ ,\, sincoming \.{\leftarrow} sincomingCJ}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} commSerial \.{\defeq}
 {\INSTANCE} CSComm {\WITH} Msg \.{\leftarrow} Seq ( Oid ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{78.84} cincoming
 \.{\leftarrow} cincomingSerial ,\, sincoming \.{\leftarrow} sincomingSerial}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} TypeOKEx \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} commCJ
 {\bang} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{\in} [ Replica \.{\rightarrow} Seq ( Oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} TypeOK}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} InitEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land}\@s{0.98}
 Init}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}\@s{0.98}
 commCJ {\bang} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land}\@s{0.98}
 serial \.{=} [ r \.{\in} Replica \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land}\@s{0.98}
 commSerial {\bang} Init}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} DoEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{25.28} \.{\land} Do ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{25.28} \.{\land}
 {\UNCHANGED} {\langle} commCJVars ,\, serialVars {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} RevEx ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land} Rev ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land} commCJ
 {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land}
 commSerial {\bang} CRev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} serial
 \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ c ] \.{=} Head ( cincomingSerial [
 c ] ) ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} SRevEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 \.{\LET} cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{62.83} c\@s{1.57}
 \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{34.23} \.{\IN} \.{\land}
 commCJ {\bang} SSendSame ( c ,\, cop )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{54.63} \.{\land} serial
 \.{'} \.{=} [ serial {\EXCEPT} {\bang} [ Server ] \.{=} Append ( @ ,\, cop .
 oid ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{54.63} \.{\land}
 commSerial {\bang} SSendSame ( c ,\, serial \.{'} [ Server ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land}\@s{6.72}
 {\UNCHANGED} {\langle} sincomingCJ ,\, sincomingSerial {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} NextEx \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 \E\, c \.{\in} Client \.{:} DoEx ( c ) \.{\lor} RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\lor}\@s{5.10}
 SRevEx}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} SpecEx \.{\defeq} InitEx
 \.{\land} {\Box} [ NextEx ]_{ varsEx}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land}\@s{4.02}
 {\WF}_{ varsEx} ( SRevEx \.{\lor} \E\, c \.{\in} Client \.{:} RevEx ( c ) )}%
\@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 09 17:16:28 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
