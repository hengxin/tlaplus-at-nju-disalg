...
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} XJupiterExtended}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{48.01} ss\@s{5.84}
 \.{\defeq} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{27.51} \.{\IN} op2ss
...
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} FairnessImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} {\WF}_{
 varsImpl} ( SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} SpecImpl \.{\defeq} InitImpl
...
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{sincoming} needs no substitution
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{71.87} css \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{113.19} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{113.19} \.{\THEN}
 SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, EmptyGraph )}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{113.19} \.{\ELSE} c2ss [
 r ] \.{\oplus} c2ssX [ r ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} {\THEOREM} SpecImpl
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 02 21:15:54 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
