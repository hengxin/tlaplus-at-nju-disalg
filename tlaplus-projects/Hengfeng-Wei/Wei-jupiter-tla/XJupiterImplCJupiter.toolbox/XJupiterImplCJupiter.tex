...
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} SRevEx}%
 ...
 \.{\defeq} xForm ( cop ,\, s2ss [ c ] ,\, ds [ Server ] ,\, Remote
 )\@s{4.1}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} FairnessImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} {\WF}_{
 varsImpl} ( SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} SpecImpl \.{\defeq} InitImpl
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{sincoming} needs no substitution
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{71.87} css \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{113.19} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{113.19} \.{\THEN}
 IgnoreDir ( SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, EmptyGraph ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{113.19} \.{\ELSE}
 IgnoreDir ( c2ss [ r ] \.{\oplus} c2ssX [ r ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} {\THEOREM} SpecImpl
 \.{\implies} CJ {\bang} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 19 11:45:17 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
