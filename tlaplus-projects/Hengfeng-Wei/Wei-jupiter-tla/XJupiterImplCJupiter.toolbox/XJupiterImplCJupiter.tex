...
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} DoEx ( c
 )}%
...
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} RevImpl ( c ) \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{36.71} \.{\IN} c2ssX
 \.{'} \.{=} [ c2ssX {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} op2ss [ cop .
 oid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 {\UNCHANGED} op2ss}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} SRevEx}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{56.11} c\@s{1.57}
 \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{35.71} xform\@s{1.16}
 \.{\defeq} xForm ( cop ,\, s2ss [ c ] ,\, ds [ Server ] )\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{TODO}: performance\.{!!}!
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{48.01} ss\@s{5.84}
 \.{\defeq} xform . xss}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{27.51} \.{\IN} op2ss
...
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} FairnessImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} {\WF}_{
 varsImpl} ( SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} SpecImpl \.{\defeq} InitImpl
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{sincoming} needs no substitution
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{71.87} css \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{113.19} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{113.19} \.{\THEN}
 SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, EmptyGraph )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{113.19} \.{\ELSE} c2ss [
 r ] \.{\oplus} c2ssX [ r ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} {\THEOREM} SpecImpl
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 31 11:09:14 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
