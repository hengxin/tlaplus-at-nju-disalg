...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{CJupiter}.
 To this end, we first extends \ensuremath{XJupiter} by replace its
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} cxss}%
\@y{\@s{0}%
 \ensuremath{cxss[c]}: \ensuremath{eXtra} \ensuremath{ss} created during
 \ensuremath{OT} at the \ensuremath{Server} for client \ensuremath{c \.{\in}
 Client
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} varsImpl \.{\defeq}
 {\langle} vars ,\, cincomingCJ ,\, cxss {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} InitImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land}
 cincomingCJ \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} cxss
 \.{=} [ c \.{\in} Client \.{\mapsto} [ node \.{\mapsto} \{ \{ \} \} ,\, edge
 \.{\mapsto} \{ \} ] ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} Do ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} cincomingCJ ,\, cxss {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} RevImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 Rev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 cincomingCJ [ c ] \.{\neq} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 there are (original) operations to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 {\UNCHANGED} {\langle} cxss {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} [ Head ( sincoming ) {\EXCEPT} {\bang} . sctx \.{=} soids ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{56.11} c\@s{1.57}
 \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{52.01} ss\@s{1.84}
 \.{\defeq} xForm ( cop ,\, s2ss [ c ] ,\, scur [ c ] ,\, Remote )}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 cincomingCJ \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{152.09} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{152.09} \.{\THEN}
 cincomingCJ [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{152.09} \.{\ELSE} Append
 ( cincomingCJ [ cl ] ,\, cop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{52.01} \.{\land} cxss
 \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{104.37} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{104.37} \.{\THEN} cxss [
 cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{104.37} \.{\ELSE} [ cxss
 [ cl ] {\EXCEPT} {\bang} . node \.{=} @ \.{\cup} Range ( ss . node ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{212.46} {\bang} .
 edge\@s{1.53} \.{=} @ \.{\cup} Range ( ss . edge ) ] ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The specification.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} SpecImpl \.{\defeq} InitImpl
 \.{\land} {\Box} [ NextImpl ]_{ varsImpl} \.{\land} {\WF}_{ varsImpl} (
 NextImpl )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} ss1 \.{\oplus} ss2
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{13.99} [ ss1 {\EXCEPT}
 {\bang} . node \.{=} @ \.{\cup} ss2 . node ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{72.79} {\bang} .
 edge\@s{1.53} \.{=} @ \.{\cup} ss2 . edge ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} IgnoreDir ( ss ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} [ ss {\EXCEPT}
 {\bang} . edge \.{=}}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{28.17}}%
\@y{\@s{0}%
 \ensuremath{\{[field \.{\in} ({\DOMAIN} e \.{\,\backslash\,} \{\@w{lr}\})
 \.{\mapsto} e.field] \.{:} e \.{\in} @\}}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{28.17} \{ [ from
 \.{\mapsto} e . from ,\, to \.{\mapsto} e . to ,\, cop \.{\mapsto} e . cop ]
 \.{:} e \.{\in} @ \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{71.87} css\@s{1.66}
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{114.86} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{114.86} \.{\THEN}
 IgnoreDir ( SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, [ node \.{\mapsto}
 \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{114.86} \.{\ELSE}
 IgnoreDir ( c2ss [ r ] \.{\oplus} cxss [ r ] ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{71.87} cur \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{114.86} {\IF} r \.{=}
 Server}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{114.86}}%
\@y{\@s{0}%
 It SHOULD be that \ensuremath{Cardinality(Range(scur)) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{114.86} \.{\THEN}
 {\CHOOSE} n \.{\in} Range ( scur ) \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{114.86} \.{\ELSE} ccur [
 r ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} {\THEOREM} SpecImpl
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 31 19:18:02 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
