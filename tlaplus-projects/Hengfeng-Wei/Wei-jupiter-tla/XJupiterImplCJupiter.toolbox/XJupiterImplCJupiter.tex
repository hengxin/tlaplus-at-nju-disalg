...
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} \.{\land} Init}%
...
\@y{\@s{0}%
 \ensuremath{SpecImpl \.{\defeq} InitImpl \.{\land}
 {\Box}[NextImpl]\_varsImpl \.{\,\backslash\,}}* +liveness
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{CJ \.{\defeq} {\INSTANCE}} \ensuremath{CJupiter}
 \ensuremath{{\WITH}} \ensuremath{soids \.{\leftarrow} soids
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{{\THEOREM}} \ensuremath{SpecImpl \.{\implies} CJ{\bang}Spec
}}%
\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 31 10:58:49 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
