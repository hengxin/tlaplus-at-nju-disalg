...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Variables for defining refinement mapping from \ensuremath{XJupiter} to
 \ensuremath{CJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} op2ss ,\,\@s{4.1}}%
\@y{\@s{0}%
 a function from an operation (represented by its \ensuremath{Oid})
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{51.95}}%
\@y{\@s{0}%
 to the part of \ensuremath{2D} state space produced while the operation is
 transformed
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} c2ssX\@s{7.70}}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} TypeOKImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} TypeOKEx}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} \A\, oid
 \.{\in} {\DOMAIN} op2ss \.{:} oid \.{\in} Oid \.{\land} IsSS ( op2ss [ oid ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} \A\, c
 \.{\in} Client \.{:} IsSS ( c2ssX [ c ] )}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} InitImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} InitEx}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land}
 op2ss\@s{2.50} \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} c2ssX
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} IgnoreDir ( ss ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} [ ss {\EXCEPT}
 {\bang} . edge \.{=} \{ [ from \.{\mapsto} e . from ,\, to \.{\mapsto} e .
 to ,\, cop \.{\mapsto} e . cop ] \.{:} e \.{\in} @ \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} DoEx ( c
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} op2ss ,\, c2ssX {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} RevImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 RevEx ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{36.71} \.{\IN} c2ssX
 \.{'} \.{=} [ c2ssX {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} op2ss [ cop .
 oid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 {\UNCHANGED} {\langle} op2ss {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} SRevEx}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} Head ( sincoming )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{56.11} c\@s{1.57}
 \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{35.71} xform\@s{1.16}
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{48.01} ss\@s{5.84}
 \.{\defeq} xform [ 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{27.51} \.{\IN} op2ss
 \.{'} \.{=} op2ss \.{\,@@\,} ( cop . oid \.{\colongt} [ node \.{\mapsto} ss
 . node ,\, edge \.{\mapsto} ss . edge ] )}%
...
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} SpecImpl \.{\defeq} InitImpl
 \.{\land} {\Box} [ NextImpl ]_{ varsImpl}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} {\WF}_{
 varsImpl} ( SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{sincoming} needs no substitution
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{71.87} css \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{113.19} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{113.19} \.{\THEN}
 IgnoreDir ( SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{156.81} [ node
 \.{\mapsto} \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{113.19} \.{\ELSE}
 IgnoreDir ( c2ss [ r ] \.{\oplus} c2ssX [ r ] ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}} {\THEOREM} SpecImpl
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 16 14:15:59 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
