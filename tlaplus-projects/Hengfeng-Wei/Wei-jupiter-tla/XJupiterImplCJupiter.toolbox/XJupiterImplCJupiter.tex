...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 In this module, we show that \ensuremath{XJupiter} implements
 \ensuremath{CJupiter}.
 To this end, we first extends \ensuremath{XJupiter} by replacing its
 \ensuremath{Cop} with that used in \ensuremath{CJupiter}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\EXTENDS} XJupiterExtended}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} cincomingCJ ,\,}%
\@y{\@s{0}%
 \ensuremath{cincoming} for \ensuremath{CJupiter} which contains original
 operations
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{80.27}}%
\@y{\@s{0}%
 instead of transformed ones in \ensuremath{XJupiter
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} op2ss
 ,\,\@s{32.91}}%
\@y{\@s{0}%
 a function from an operation (represented by its \ensuremath{Oid})
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{80.27}}%
\@y{\@s{0}%
 to the part of \ensuremath{2D} state space produced while the operation is
 transformed
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} c2ssX\@s{36.51}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} varsImpl \.{\defeq}
 {\langle} vars ,\, cincomingCJ ,\, op2ss ,\, c2ssX {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} TypeOKImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{16.4} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} \.{\land}
 cincomingCJ \.{\in} [ Client \.{\rightarrow} Seq ( Cop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} \A\, oid
 \.{\in} {\DOMAIN} op2ss \.{:} oid \.{\in} Oid \.{\land} IsSS ( op2ss [ oid ]
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} \A\, c
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} InitImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} Init}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}
 cincomingCJ \.{=} [ c \.{\in} Client \.{\mapsto} {\langle} {\rangle} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land}
 op2ss\@s{2.50} \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} c2ssX
 \.{=} [ c \.{\in} Client \.{\mapsto} [ node \.{\mapsto} \{ \{ \} \} ,\, edge
 \.{\mapsto} \{ \} ] ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Client \ensuremath{c \.{\in} Client} generates an operation and performs it
 locally.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} DoImpl ( c ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land} Do ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} cincomingCJ ,\, op2ss ,\, c2ssX {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} ss1 \.{\oplus} ss2
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{13.99} [ ss1 {\EXCEPT}
 {\bang} . node \.{=} @ \.{\cup} ss2 . node ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{72.79} {\bang} .
 edge\@s{1.53} \.{=} @ \.{\cup} ss2 . edge ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Client \ensuremath{c \.{\in} Client} receives a message and processes it.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} RevImpl ( c ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 Rev ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 cincomingCJ [ c ] \.{\neq} {\langle} {\rangle}\@s{4.1}}%
\@y{\@s{0}%
 there are (original) operations to handle with
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 cincomingCJ \.{'} \.{=} [ cincomingCJ {\EXCEPT} {\bang} [ c ] \.{=} Tail ( @
 ) ]}%
\@y{\@s{0}%
 also consume a message
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 \.{\LET} cop \.{\defeq} Head ( cincoming [ c ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{40.81} \.{\IN} c2ssX
 \.{'} \.{=} [ c2ssX {\EXCEPT} {\bang} [ c ] \.{=} @ \.{\oplus} op2ss [ cop .
 oid ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land}\@s{9.20}
 {\UNCHANGED} {\langle} op2ss {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Also broadcast the original operation to clients (using the
 \ensuremath{cincomingCJ} channels)
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} SRevImpl \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4} \.{\land} SRev}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\land} \.{\LET}
 cop \.{\defeq} [ Head ( sincoming ) {\EXCEPT} {\bang} . sctx \.{=} soids ]}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{56.11} c\@s{1.57}
 \.{\defeq} cop . oid . c}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{52.01} ss\@s{1.84}
 \.{\defeq} xForm ( cop ,\, s2ss [ c ] ,\, scur [ c ] ,\, Remote )}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{31.61} \.{\IN} \.{\land}
 cincomingCJ \.{'} \.{=} [ cl \.{\in} Client \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{152.09} {\IF} cl \.{=} c}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{152.09} \.{\THEN}
 cincomingCJ [ cl ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{152.09} \.{\ELSE} Append
 ( cincomingCJ [ cl ] ,\, cop ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{52.01} \.{\land} op2ss
 \.{'} \.{=} op2ss \.{\,@@\,} ( cop . oid \.{\colongt} [ node \.{\mapsto}
 Range ( ss . node ) ,\, edge \.{\mapsto} Range ( ss . edge ) ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} c2ssX {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} NextImpl \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\lor} \E\, c
 \.{\in} Client \.{:} DoImpl ( c ) \.{\lor} RevImpl ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\lor} SRevImpl}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The specification.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}} SpecImpl \.{\defeq} InitImpl
 \.{\land} {\Box} [ NextImpl ]_{ varsImpl} \.{\land} {\WF}_{ varsImpl} (
 SRevImpl \.{\lor} \E\, c \.{\in} Client \.{:} RevImpl ( c ) )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Ignore the lr field in edges of \ensuremath{2D} state space.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} IgnoreDir ( ss ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} [ ss {\EXCEPT}
 {\bang} . edge \.{=}}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{28.17}}%
\@y{\@s{0}%
 \ensuremath{\{[field \.{\in} ({\DOMAIN} e \.{\,\backslash\,}
 \{\mbox{``}lr\mbox{''}\}) \.{\mapsto} e.field] \.{:} e \.{\in} @\}}]
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{28.17} \{ [ from
 \.{\mapsto} e . from ,\, to \.{\mapsto} e . to ,\, cop \.{\mapsto} e . cop ]
 \.{:} e \.{\in} @ \} ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} CJ \.{\defeq} {\INSTANCE}
 CJupiter}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{40.89} {\WITH} cincoming
 \.{\leftarrow} cincomingCJ ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{71.87} css\@s{1.66}
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{114.86} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{114.86} \.{\THEN}
 IgnoreDir ( SetReduce ( \.{\oplus} ,\, Range ( s2ss ) ,\, [ node \.{\mapsto}
 \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{114.86} \.{\ELSE}
 IgnoreDir ( c2ss [ r ] \.{\oplus} c2ssX [ r ] ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{71.87} cur \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{114.86} {\IF} r \.{=}
 Server}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{114.86}}%
\@y{\@s{0}%
 It SHOULD be that \ensuremath{Cardinality(Range(scur)) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{114.86} \.{\THEN}
 {\CHOOSE} n \.{\in} Range ( scur ) \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{114.86} \.{\ELSE} ccur [
 r ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} {\THEOREM} SpecImpl
 \.{\implies} CJ {\bang} Spec}%
\@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Nov} 01 13:51:35 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
