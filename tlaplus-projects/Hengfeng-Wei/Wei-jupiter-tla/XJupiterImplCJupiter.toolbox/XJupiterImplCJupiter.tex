...
\@y{\@s{0}%
 [\ensuremath{field \.{\in}} (\ensuremath{{\DOMAIN} e \.{\,\backslash\,}
 \{\@w{lr}\}}) \ensuremath{\.{\mapsto} e.field}]
}%
\@xx{}%
...
\@pvspace{8.0pt}%
 ...
 CJupiter {\WITH} cincoming \.{\leftarrow} cincomingCJ ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{40.89} css\@s{1.66}
 \.{\leftarrow} [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{87.98} {\IF} r \.{=}
 Server}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{87.98} \.{\THEN}
 IgnoreDir ( SetReduce ( \.{\oplus} ,\, Range ( sss ) ,\, [ node \.{\mapsto}
 \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ] ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{87.98} \.{\ELSE}
 IgnoreDir ( css [ r ] \.{\oplus} cxss [ r ] ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{40.89} cur \.{\leftarrow}
 [ r \.{\in} Replica \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{87.98} {\IF} r \.{=}
 Server}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{87.98}}%
\@y{\@s{0}%
 It SHOULD be that \ensuremath{Cardinality(Range(scur)) \.{=} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{87.98} \.{\THEN}
 {\CHOOSE} n \.{\in} Range ( scur ) \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{87.98} \.{\ELSE} ccur [ r
 ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} {\THEOREM} SpecImpl
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 31 17:24:39 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
