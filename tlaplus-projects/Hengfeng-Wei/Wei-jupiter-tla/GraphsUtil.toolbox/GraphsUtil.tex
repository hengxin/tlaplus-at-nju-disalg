...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} IsDirectedGraph ( G )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\land} G \.{=} [
 node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} EmptyGraph \.{\defeq} [ node
 \.{\mapsto} \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} g \.{\oplus} h \.{\defeq}}%
\@y{\@s{0}%
 A union (in terms of set) of two graphs \ensuremath{g} and \ensuremath{h}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{13.68} [ node \.{\mapsto}
 g . node \.{\cup} h . node ,\, edge \.{\mapsto} g . edge \.{\cup} h . node
 ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 19 11:34:58 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
