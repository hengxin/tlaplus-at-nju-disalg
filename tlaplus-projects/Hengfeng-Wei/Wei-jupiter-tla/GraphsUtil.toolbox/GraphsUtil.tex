...
\setboolean{shading}{true}
 ...
 {\MODULE} GraphsUtil}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} IsGraph ( G ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} \.{\land}\@s{7.97} G
 \.{=} [ node \.{\mapsto} G . node ,\, edge \.{\mapsto} G . edge ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} EmptyGraph \.{\defeq} [ node
 \.{\mapsto} \{ \{ \} \} ,\, edge \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} g \.{\oplus} h \.{\defeq}}%
\@y{\@s{0}%
 A union (in terms of set) of two graphs \ensuremath{g} and \ensuremath{h}.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{13.68} [ node \.{\mapsto}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 31 19:47:39 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Wed}
 \ensuremath{Dec} 19 11:11:25 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
