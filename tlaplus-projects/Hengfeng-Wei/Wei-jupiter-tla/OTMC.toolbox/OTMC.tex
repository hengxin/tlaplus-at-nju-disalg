...
\setboolean{shading}{true}
 ...
 {\MODULE} OTMC}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Model checking the \ensuremath{OT} functions defined in the \ensuremath{OT}
 module.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The \ensuremath{OT} functions are expected to satisfy both the
 \ensuremath{CP1} property and the
 generalized \ensuremath{CP1} property.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} OT ,\, TLC ,\,
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\CONSTANTS}\@s{4.1} MaxPr
 ,\,\@s{4.1}}%
\@y{\@s{0}%
 max priority
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{58.85} MaxLen\@s{5.53}}%
\@y{\@s{0}%
 max length of list
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\ASSUME} \.{\land} MaxPr
 \.{\in} PosInt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{38.24} \.{\land} MaxLen
 \.{\in} Nat}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} ListMaxLen \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} InsOp ( l )
 \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 Position of an insertion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} [ type \.{:}
 \{\@w{Ins} \} ,\, pos \.{:} 1 \.{\dotdot} Len ( l ) \.{+} 1 ,\, ch \.{:}
 Char ,\, pr \.{:} 1 \.{\dotdot} MaxPr ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} DelOp ( l ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} {\IF} l \.{=}
 {\langle} {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\THEN} \{ \}}%
\@y{\@s{0}%
 Not allowed to delete elements from an empty list.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\ELSE}\@s{4.1} [
 type \.{:} \{\@w{Del} \} ,\, pos \.{:} 1 \.{\dotdot} Len ( l ) ]}%
\@y{\@s{0}%
 Position of a deletion cannot be too large.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} OpOnList ( l ) \.{\defeq}
 InsOp ( l ) \.{\cup} DelOp ( l )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} CP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{19.96} \A\, l \.{\in}
 ListMaxLen \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{31.28} \A\, op1 \.{\in}
 OpOnList ( l ) ,\, op2 \.{\in} OpOnList ( l ) \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{42.60}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{42.60} \.{\land}}%
\@y{\@s{0}%
 Priorities of these two insertions cannot be the same.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{53.71} \.{\lor} ( op1 .
 type \.{=}\@w{Ins} \.{\land} op2 . type \.{=}\@w{Ins} \.{\land} op1 . pr
 \.{=} op2 . pr )}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{61.91}}%
\@y{\@s{0}%
 The \ensuremath{CP1} itself.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{53.71} \.{\lor} ApplyOps
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} GCP1 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \A\, l \.{\in}
 ListMaxLen ,\, ops1 \.{\in} SeqMaxLen ( Op ,\, 1 ) ,\, ops2 \.{\in}
 SeqMaxLen ( Op ,\, 1 ) \.{:}}%
\@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{27.72}}%
\@y{\@s{0}%
 \ensuremath{\.{\lor}} (\ensuremath{Head(ops1).type \.{=} \@w{Del} \.{\lor}
 Head(ops2).type \.{=} \@w{Del}})
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{27.72} \.{\lor} ApplyOps
 ( ops1 \.{\circ} XformOpsOps ( ops2 ,\, ops1 ) ,\, l ) \.{=}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{38.83} ApplyOps ( ops2
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 07 13:36:50 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jul} 07 13:31:57
