...
The correctness of counter:
 eventual convergence (\ensuremath{EC}) and strong eventual convergence
 (\ensuremath{SEC}).
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}} Convergence \.{\defeq} \A\,
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}} EC \.{\defeq} {\Diamond}
 Convergence}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}} AccBroadcast \.{\defeq}
 \A\, r \.{\in} Replica \.{:} acc [ r ] \.{=} 0\@s{12.29}}%
\@y{\@s{0}%
 all accumulated increments have been broadcast
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}} MessageDelivery \.{\defeq}
 \A\, r \.{\in} Replica \.{:} incoming [ r ] \.{=} {\langle} {\rangle}}%
\@y{\@s{0}%
 all messages have been delivered
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} SConvergence \.{\defeq}
 \A\, r ,\, s\@s{1.28} \.{\in} Replica \.{:} counter [ r ] \.{=} counter [ s
 ]}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}} SEC \.{\defeq} {\Box} ( (
 AccBroadcast \.{\land} MessageDelivery ) \.{\implies} SConvergence )}%
\@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 19:52:43 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
