...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} Replica ,\,}%
\@y{\@s{0}%
 the set of replicas
}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4} Max\@s{18.27}}%
\@y{\@s{0}%
 \ensuremath{Max[r]}: the maximum number of the \ensuremath{Inc()} event
 replica \ensuremath{r \.{\in} Replica} can issue; for finite-state model
 checking
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} {\VARIABLES}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Protocol variables.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{16.4} counter
 ,\,\@s{15.03}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} acc ,\,\@s{34.07}}%
\@y{\@s{0}%
 \ensuremath{acc[r]}: the number of increments performed since the last
 broadcast at replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} incoming
 ,\,\@s{8.2}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} inc\@s{40.69}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 counter \.{\in} [ Replica \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{56.14} \.{\land} acc
 \.{\in} [ Replica \.{\rightarrow} Nat ]}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{56.14}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{56.14} \.{\land} inc
 \.{\in} [ Replica \.{\rightarrow} Nat ]}%
\@pvspace{8.0pt}%
...
\end{lcom}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{35.70} \.{\land} acc
 \.{=} [ r\@s{4.47} \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{35.70} \.{\land} incoming
 \.{=} [ r \.{\in} Replica \.{\mapsto} EmptyBag ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{35.70} \.{\land} inc
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Inc ( r ) \.{\defeq}
 \.{\land} {\TRUE}\@s{8.2}}%
\@y{\@s{0}%
 no pre-condition
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{46.60} \.{\land} counter
 \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} 1 ]\@s{12.29}}%
\@y{\@s{0}%
 current \ensuremath{counter \.{+} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{46.60} \.{\land} acc
 \.{'} \.{=} [ acc {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} 1 ]\@s{8.2}}%
\@y{\@s{0}%
 \# of accumulated increments \ensuremath{\.{+} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{46.60} \.{\land} inc
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{46.60} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} Broadcast ( s ,\, m )
 \.{\defeq} [ r \.{\in} Replica \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{106.02} {\IF} s \.{=} r}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{106.02} \.{\THEN}
 incoming [ s ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{106.02} \.{\ELSE}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} Send ( r ) \.{\defeq}
 \.{\land} acc [ r ] \.{\neq} 0\@s{12.29}}%
\@y{\@s{0}%
 there are accumulated increments
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{53.94} \.{\land} acc
 \.{'} \.{=} [ acc {\EXCEPT} {\bang} [ r ] \.{=} 0 ]\@s{4.1}}%
\@y{\@s{0}%
 reset \ensuremath{acc[r]
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{53.94} \.{\land} incoming
 \.{'} \.{=} Broadcast ( r ,\, acc [ r ] )\@s{4.1}}%
\@y{\@s{0}%
 broadcast \ensuremath{acc[r]} to other replicas
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{53.94} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}} Receive ( r ) \.{\defeq}
 \.{\land} incoming [ r ] \.{\neq} EmptyBag}%
\@y{\@s{0}%
 there are accumulated increments from other replicas
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{64.53} \.{\land} \E\, m
 \.{\in} BagToSet ( incoming [ r ] ) \.{:}}%
\@y{\@s{0}%
 message reordering can be tolerant
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{82.87} ( \.{\land}
 counter \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} m ]}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{86.97} \.{\land} incoming
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{64.53} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} Next \.{\defeq} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}} vars\@s{0.63} \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}} IncConstraint \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}} Convergence \.{\defeq} \A\,
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}} EC \.{\defeq} {\Diamond}
 Convergence}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}} AccBroadcast \.{\defeq}
 \A\, r \.{\in} Replica \.{:} acc [ r ] \.{=} 0\@s{12.29}}%
\@y{\@s{0}%
 all accumulated increments have been broadcast
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} MessageDelivery \.{\defeq}
 \A\, r\@s{0.75} \.{\in} Replica \.{:} incoming [ r ] \.{=} EmptyBag}%
\@y{\@s{0}%
 all messages have been delivered
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}} QConvergence \.{\defeq}
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}} QC \.{\defeq} {\Box} ( (
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 08 13:47:57 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
