...
TypeOK == /\ counter \in [Replica -> Nat]
          /\ acc \in [Replica -> Nat]
          /\ incoming \in [Replica -> Seq(Nat)] \* FIXME: message ordering is not important; change to multiset
          /\ inc \in [Replica -> Nat]
...
(**********************************************************************)
Receive(r) == /\ incoming[r] # <<>> \* there are accumulated increments from other replicas
...
\* Last modified Mon Jun 04 13:50:23 CST 2018 by hengxin
