...
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Replica}%
\@y{\@s{0}%
 the set of replicas
}%
\@xx{}%
...
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\VARIABLES}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} counter
 ,\,\@s{0.72}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} acc ,\,\@s{19.76}}%
\@y{\@s{0}%
 \ensuremath{acc[r]}: the number of increments performed since the last
 broadcast at replica \ensuremath{r \.{\in} Replica
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} incoming}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 counter \.{\in} [ Replica \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{56.14} \.{\land} acc
 \.{\in} [ Replica \.{\rightarrow} Nat ]}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{56.14} \.{\land} incoming
 \.{\in} [ Replica \.{\rightarrow} Seq ( Nat ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Init \.{\defeq} \.{\land}
 counter \.{=} [ r \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{35.70} \.{\land} acc
 \.{=} [ r\@s{4.47} \.{\in} Replica \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{35.70} \.{\land} incoming
 \.{=} [ r \.{\in} Replica \.{\mapsto} {\langle} {\rangle} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Inc()} at replica \ensuremath{r \.{\in} Replica
}%
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Inc ( r ) \.{\defeq}
 \.{\land} {\TRUE}\@s{8.2}}%
\@y{\@s{0}%
 no pre-cond
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{46.60} \.{\land} counter
 \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} 1 ]\@s{12.29}}%
\@y{\@s{0}%
 current \ensuremath{counter \.{+} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{46.60} \.{\land} acc
 \.{'} \.{=} [ acc {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} 1 ]\@s{8.2}}%
\@y{\@s{0}%
 \# of increments \ensuremath{\.{+} 1
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{46.60} \.{\land}
 {\UNCHANGED} {\langle} incoming {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}}%
\@y{\@s{0}%
 broadcast a message to all replicas except the sender \ensuremath{s
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Broadcast ( s ,\, m )
 \.{\defeq} [ r \.{\in} Replica \.{\mapsto}}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{106.02} {\IF} s \.{=} r}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{106.02} \.{\THEN}
 incoming [ s ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{106.02} \.{\ELSE} Append
 ( incoming [ r ] ,\, m ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} Send ( r ) \.{\defeq}
 \.{\land} acc [ r ] \.{\neq} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{53.94} \.{\land} acc
 \.{'} \.{=} [ acc {\EXCEPT} {\bang} [ r ] \.{=} 0 ]\@s{4.1}}%
\@y{\@s{0}%
 reset \ensuremath{acc[r]
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{53.94} \.{\land}
 Broadcast ( r ,\, acc [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{53.94} \.{\land}
 {\UNCHANGED} {\langle} counter {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Receive ( r ) \.{\defeq}
 \.{\land} incoming [ r ] \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{64.53} \.{\land} \.{\LET}
 m \.{=} Head ( incoming [ r ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{75.64} \.{\IN} counter
 \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ r ] \.{=} @ \.{+} m ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{64.53} \.{\land} incoming
 \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [ r ] \.{=} Tail ( @ ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{64.53} \.{\land}
 {\UNCHANGED} {\langle} acc {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} Next \.{\defeq} \E\, r
 \.{\in} Replica \.{:} Inc ( r ) \.{\lor} Send ( r ) \.{\lor} Receive ( r )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} vars \.{=} {\langle} counter
 ,\, acc ,\, incoming {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jun} 03
 21:55:15 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
 ...
 \ensuremath{oid},\@s{12.5}\ensuremath{\.{\,\backslash\,}}*
 \ensuremath{oid[r]}: the (local) \ensuremath{id} of the increment operation
 issued by the replica \ensuremath{r \.{\in} Replica
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{oids},
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{oids[r]}: the set of ids of the
 increment operations performed by the replica \ensuremath{r \.{\in} Replica
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Oid \.{\defeq}} [\ensuremath{r}:
 \ensuremath{Replica}, \ensuremath{id}: \ensuremath{Nat}]
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Msg \.{\defeq}} [a:
 \ensuremath{Nat}, \ensuremath{r}: \ensuremath{Replica}, \ensuremath{id}:
 \ensuremath{Nat}] \ensuremath{\.{\,\backslash\,}}* message to send
\end{cpar}%
\end{lcom}%
\end{document}
