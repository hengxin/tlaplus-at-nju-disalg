...
NoncoIntervals == {ints \in SUBSET Intervals : \A i,j \in ints: i[2]+i[1] <= j[1] \/ j[2]+j[1] <= i[1] \/ i=j} \{{}}
...
NoncoSeq == Seqset(NoncoIntervals)
...
OP_1_ins == [type: {"ins"}, pos: POS, ch: CH, pr:PR] 
OP_1_del == [type: {"del"}, pos: POS, pr:PR] 
OP_1 == OP_1_set \cup OP_1_ins \cup OP_1_del

OP_2_ins == [type: {"ins_r"}, pos: POS, pr:PR, str:STR] 
OP_2_del == [type: {"del_r"}, pos: POS, pr:PR, len:LEN]
OP_2 ==  OP_2_ins \cup OP_2_del

OP_3 == [type:{"del_m"},ints:NoncoSeq]
...
\* Last modified Tue Jun 05 21:34:30 CST 2018 by xhdn
