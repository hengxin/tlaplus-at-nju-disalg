...
\@x{}\moduleLeftDash\@xx{ {\MODULE} InsertTree}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\, Naturals ,\, TLC}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANT} Char ,\, Charnum}%
\@x{}\midbar\@xx{}%
 \@x{ node \.{\defeq} [ ch \.{:} Char ,\, time \.{:} Int ,\, father \.{:} Char
 \.{\cup} \{\@w{o} \} ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 \ensuremath{nodechar \.{\defeq} {\langle}\@w{o}{\rangle}
}}%
\@xx{}%
\@x{ {\RECURSIVE} Readtree2set ( \_ )}%
\@x{ Readtree2set ( T ) \.{\defeq} {\IF} T \.{=} \{ \} \.{\THEN} \{ \}}%
 \@x{\@s{94.77} \.{\ELSE} \.{\LET} t \.{\defeq} {\CHOOSE} x \.{\in} T \.{:}
 {\TRUE}}%
 \@x{\@s{94.77} \.{\IN} \{ t . ch \} \.{\cup} Readtree2set ( T
 \.{\,\backslash\,} \{ t \} )}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} Createtree ( \_ ,\, \_ )}%
\@x{ Createtree ( num ,\, tree ) \.{\defeq} {\IF} num \.{=} 0 \.{\THEN} tree}%
 \@x{\@s{113.63} \.{\ELSE} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} node
 \.{:} x . time \.{=} Charnum \.{-} num \.{+} 1 \.{\land} x . father \.{\in}
 Readtree2set ( tree ) \.{\cup} \{\@w{o} \} \.{\land} x . ch \.{\in} Char
 \.{\,\backslash\,} Readtree2set ( tree )}%
 \@x{\@s{173.52} \.{\IN}\@s{4.1} Createtree ( num \.{-} 1 ,\, tree \.{\cup} \{
 i \} )}%
\@pvspace{16.0pt}%
\@x{ {\RECURSIVE} max ( \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{ max ( T ,\, root ,\, curmax ,\, readchar ) \.{\defeq}}%
 \@x{\@s{23.02} {\CASE}\@s{4.1} \E\, i \.{\in} T \.{:} i . father \.{=} root
 \.{\land} i . time \.{>} curmax \.{\land} {\lnot} i . ch \.{\in} readchar
 \.{\rightarrow}}%
 \@x{\@s{39.42} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} T \.{:}\@s{4.1} x .
 father \.{=} root \.{\land} x . time \.{>} curmax \.{\land} {\lnot} x . ch
 \.{\in} readchar}%
 \@x{\@s{59.82} \.{\IN}\@s{4.1} max ( T \.{\,\backslash\,} \{ i \} ,\, root
 ,\, i . time ,\, readchar )}%
 \@x{\@s{23.02} {\Box}\@s{12.29} \E\, i \.{\in} T \.{:} i . father \.{=} root
 \.{\land} i . time \.{\leq} curmax \.{\land} {\lnot} i . ch \.{\in} readchar
 \.{\rightarrow}}%
 \@x{\@s{39.42} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} T \.{:}\@s{4.1} x .
 father \.{=} root \.{\land} x . time \.{\leq} curmax \.{\land} {\lnot} x .
 ch \.{\in} readchar}%
 \@x{\@s{59.82} \.{\IN}\@s{4.1} max ( T \.{\,\backslash\,} \{ i \} ,\, root
 ,\, curmax ,\, readchar )}%
\@x{\@s{23.02} {\Box} {\OTHER} \.{\rightarrow} curmax}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} Readtree2list ( \_ ,\, \_ ,\, \_ ,\, \_ )}%
\@x{ Readtree2list ( T ,\, root ,\, tomb ,\, readchar ) \.{\defeq}}%
 \@x{\@s{92.71} {\IF} \E\, x \.{\in} T \.{:} x . father \.{=} root \.{\land}
 {\lnot} x . ch \.{\in} tomb}%
 \@x{\@s{148.09} \.{\land} x . time \.{=} max ( T ,\, root ,\, 0 ,\, readchar
 )\@s{12.96} \.{\land} {\lnot} x . ch \.{\in} readchar}%
 \@x{\@s{113.07} \.{\THEN} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} T \.{:} x
 . father \.{=} root \.{\land} {\lnot} x . ch \.{\in} tomb}%
 \@x{\@s{168.86} \.{\land}\@s{4.1} x . time \.{=} max ( T ,\, root ,\, 0 ,\,
 readchar ) \.{\land} {\lnot} x . ch \.{\in} readchar}%
 \@x{\@s{125.37} \.{\IN} {\langle} i . ch {\rangle} \.{\circ} Readtree2list (
 T ,\, i . ch ,\, tomb ,\, readchar \.{\cup} \{ i . ch \} )}%
 \@x{\@s{92.71} \.{\ELSE} {\IF} \E\, x \.{\in} T \.{:} x . father \.{=} root
 \.{\land} x . ch \.{\in} tomb}%
 \@x{\@s{136.18} \.{\land} x . time \.{=} max ( T ,\, root ,\, 0 ,\, readchar
 ) \.{\land} {\lnot} x . ch \.{\in} readchar}%
 \@x{\@s{124.02} \.{\THEN}\@s{8.2} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} T
 \.{:} x . father \.{=} root \.{\land}\@s{4.1} x . ch \.{\in} tomb}%
 \@x{\@s{192.12} \.{\land} x . time \.{=} max ( T ,\, root ,\, 0 ,\, readchar
 ) \.{\land} {\lnot} x . ch \.{\in} readchar}%
 \@x{\@s{136.32} \.{\IN}\@s{6.81} Readtree2list ( T ,\, i . ch ,\, tomb ,\,
 readchar \.{\cup} \{ i . ch \} )}%
 \@x{\@s{92.71} \.{\ELSE}\@s{4.1} {\IF} \E\, x \.{\in} T \.{:} root \.{=} x .
 ch}%
 \@x{\@s{113.21} \.{\THEN}\@s{8.2} \.{\LET} i \.{\defeq} {\CHOOSE} x \.{\in} T
 \.{:} root \.{=} x . ch}%
 \@x{\@s{125.51} \.{\IN} Readtree2list ( T ,\, i . father ,\, tomb ,\,
 readchar )}%
\@x{\@s{92.71} \.{\ELSE}\@s{4.1} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{Readtree2list(Createtree(3,\,\{\}),\,\@w{o},\,\{\},\,\{\})
}}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 00:07:07 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 15
 21:06:31 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Dec} 05 20:31:29 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Dec} 05 20:28:53 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Dec} 04 13:37:50 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Nov} 30
 15:07:41 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
