...
\@x{}\moduleLeftDash\@xx{ {\MODULE} RGAH}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} RGA ,\, SequenceUtils}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLE} list}%
\@pvspace{8.0pt}%
\@x{ varsH \.{\defeq} {\langle} vars ,\, list {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeOKH \.{\defeq} TypeOK \.{\land} ( list \.{\in} {\SUBSET} List )}%
\@x{}\midbar\@xx{}%
\@x{ InitH \.{\defeq} Init \.{\land} list \.{=} \{ \}}%
\@pvspace{8.0pt}%
 \@x{ DoH ( r ) \.{\defeq} Do ( r ) \.{\land} list \.{'} \.{=} list
 \.{\cup}\@s{8.2} \{ Readtree2list ( rtree [ r ] \.{'} ,\,\@w{o} ,\, rtomb [
 r ] \.{'} ,\, \{ \} ) \}}%
\@pvspace{8.0pt}%
\@x{ SendH ( r ) \.{\defeq} Send ( r ) \.{\land} list \.{'} \.{=} list}%
\@pvspace{8.0pt}%
 \@x{ ReceiveH ( r ) \.{\defeq} Receive ( r ) \.{\land} list \.{'} \.{=} list
 \.{\cup}\@s{4.1} \{ Readtree2list ( rtree [ r ] \.{'} ,\,\@w{o} ,\, rtomb [
 r ] \.{'} ,\, \{ \} ) \}}%
\@x{}\midbar\@xx{}%
\@x{ NextH \.{\defeq}}%
 \@x{\@s{12.29} \E\, r \.{\in} Replica \.{:} DoH ( r ) \.{\lor} SendH ( r )
 \.{\lor} ReceiveH ( r )}%
\@x{}\midbar\@xx{}%
...
Weak \ensuremath{List} Consistency
\end{cpar}%
\end{lcom}%
\@x{ WLSpec \.{\defeq}\@s{4.1} \A\, l1 ,\, l2 \.{\in} list \.{:}}%
\@x{\@s{74.53} \.{\land} Injective ( l1 )}%
\@x{\@s{74.53} \.{\land} Injective ( l2 )}%
\@x{\@s{74.53} \.{\land} Compatible ( l1 ,\, l2 )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Strong \ensuremath{List} Consistency
\end{cpar}%
\end{lcom}%
\@x{ SLSpec \.{\defeq}\@s{8.2} \.{\land} WLSpec}%
\@x{\@s{58.45} \.{\land} \A\, l1 ,\, l2 ,\, l3 \.{\in} list \.{:}}%
\@x{\@s{77.77} nocylce ( l1 ,\, l2 ,\, l3 )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:10:45 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 15
 12:40:54 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu}
 \ensuremath{Dec} 13 17:02:14 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Dec} 05
 18:11:55 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
