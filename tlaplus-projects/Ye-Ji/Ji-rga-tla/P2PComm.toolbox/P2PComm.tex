...
\@x{}\moduleLeftDash\@xx{ {\MODULE} P2PComm}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Sequences}%
\@x{}\midbar\@xx{}%
\@x{ {\CONSTANTS} Replica}%
\@x{}\midbar\@xx{}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} incoming ,\, outbuf}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} incoming ,\, outbuf {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} incoming \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \}
 ]}%
\@x{\@s{16.4} \.{\land} outbuf \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{lcom}%
\@x{ Receive ( r ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} incoming [ r ] \.{\neq} \{ \}}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} incoming \.{'} \.{=} [ incoming {\EXCEPT}
 {\bang} [ r ] \.{=} \{ \} ]}%
\@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} outbuf {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
send transitions
...
\end{lcom}%
\@x{ Send ( r ) \.{\defeq}}%
\@x{\@s{21.98} \.{\land} outbuf [ r ]\@s{3.24} \.{\neq} \{ \}}%
 \@x{\@s{21.98} \.{\land} incoming \.{'} \.{=} [ x \.{\in} Replica
 \.{\mapsto}}%
\@x{\@s{106.29} {\IF} x \.{=} r}%
\@x{\@s{106.29} \.{\THEN} incoming [ x ]}%
\@x{\@s{106.29} \.{\ELSE} incoming [ x ] \.{\cup} outbuf [ r ] ]}%
 \@x{\@s{21.98} \.{\land} outbuf \.{'} \.{=} [ outbuf {\EXCEPT} {\bang} [ r ]
 \.{=} \{ \} ]}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 channel is empty iff incoming and \ensuremath{outbuf} are both empty for
 every replica.
\end{cpar}%
\end{lcom}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 00:33:30 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 15
 21:09:02 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu}
 \ensuremath{Dec} 13 22:46:54 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Nov} 30
 14:43:28 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\end{lcom}%
\end{document}
