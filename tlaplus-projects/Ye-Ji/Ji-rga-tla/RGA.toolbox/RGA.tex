...
\@x{ {\CONSTANTS} Replica}%
\@x{}\midbar\@xx{}%
 \@x{ {\VARIABLES} rtree ,\, rtomb ,\, rinsbuf ,\, rtombbuf ,\, rins\_incoming
 ,\, rtomb\_incoming ,\, chins ,\, tcurrent}%
 \@x{ vars \.{\defeq} {\langle} rtree ,\, rtomb ,\, rinsbuf ,\, rtombbuf ,\,
 rins\_incoming ,\, rtomb\_incoming ,\, chins ,\, tcurrent {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ List \.{\defeq} Seq ( Char )}%
\@pvspace{8.0pt}%
 \@x{ Inscomm \.{\defeq} {\INSTANCE} P2PComm {\WITH}\@s{4.1} incoming
 \.{\leftarrow} rins\_incoming ,\, outbuf \.{\leftarrow} rinsbuf}%
\@pvspace{8.0pt}%
 \@x{ Tombcomm \.{\defeq} {\INSTANCE} P2PComm {\WITH}\@s{4.1} incoming
 \.{\leftarrow} rtomb\_incoming ,\, outbuf \.{\leftarrow} rtombbuf}%
\@x{}\midbar\@xx{}%
 \@x{ TypeOK \.{\defeq} \.{\land} tcurrent \.{\in} 1 \.{\dotdot} Charnum \.{+}
 1}%
 \@x{\@s{56.14} \.{\land} rtomb \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 Char ]}%
 \@x{\@s{56.14} \.{\land} rtombbuf \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 Char ]}%
 \@x{\@s{56.14} \.{\land} rtomb\_incoming \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} Char ]}%
\@x{\@s{56.14} \.{\land} chins \.{\in} {\SUBSET} Char}%
 \@x{\@s{56.14} \.{\land} rtree\@s{2.62} \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} node ]}%
 \@x{\@s{56.14} \.{\land} rinsbuf \.{\in} [ Replica \.{\rightarrow} {\SUBSET}
 node ]}%
 \@x{\@s{56.14} \.{\land} rins\_incoming \.{\in} [ Replica \.{\rightarrow}
 {\SUBSET} node ]}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Inscomm {\bang} Init}%
\@x{\@s{16.4} \.{\land} Tombcomm {\bang} Init}%
 \@x{\@s{16.4} \.{\land} rtree\@s{5.37} \.{=} [ r \.{\in} Replica \.{\mapsto}
 \{ \} ]}%
\@x{\@s{16.4} \.{\land} rtomb \.{=} [ r \.{\in} Replica \.{\mapsto} \{ \} ]}%
\@x{\@s{16.4} \.{\land} chins\@s{2.74} \.{=} Char}%
\@x{\@s{16.4} \.{\land} tcurrent \.{=} 1}%
\@pvspace{16.0pt}%
\@x{ DoIns ( r ) \.{\defeq}}%
\@x{\@s{16.4} \E\, ins \.{\in} node \.{:}}%
 \@x{\@s{27.72} \.{\land} ins . father \.{\in} Readtree2set ( rtree [ r ] )
 \.{\cup} \{\@w{o} \}}%
\@x{\@s{27.72} \.{\land} ins . time\@s{4.1} \.{=} tcurrent}%
\@x{\@s{27.72} \.{\land} tcurrent \.{'}\@s{1.88} \.{=} tcurrent \.{+} 1}%
\@x{\@s{27.72} \.{\land} ins . ch \.{\in} chins}%
 \@x{\@s{27.72} \.{\land} chins \.{'}\@s{0.73} \.{=} chins \.{\,\backslash\,}
 \{ ins . ch \}}%
 \@x{\@s{27.72} \.{\land} rtree \.{'}\@s{3.36} \.{=}\@s{4.1} [ rtree\@s{4.1}
 {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} \{ ins \} ]}%
 \@x{\@s{27.72} \.{\land} rinsbuf \.{'} \.{=} [ rinsbuf {\EXCEPT} {\bang} [ r
 ] \.{=} @ \.{\cup} \{ ins \} ]}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} rtomb ,\, rtombbuf ,\,
 rins\_incoming ,\, rtomb\_incoming {\rangle}}%
\@pvspace{16.0pt}%
\@x{ DoDel ( r ) \.{\defeq}}%
\@x{\@s{16.4} \E\, del \.{\in} Char \.{:}}%
\@x{\@s{27.72} \.{\land} del \.{\in} Readtree2set ( rtree [ r ] )}%
\@x{\@s{27.72} \.{\land} {\lnot} del \.{\in} rtomb [ r ]}%
 \@x{\@s{27.72} \.{\land} rtomb \.{'} \.{=} [ rtomb {\EXCEPT} {\bang} [ r ]
 \.{=} @ \.{\cup} \{ del \} ]}%
 \@x{\@s{27.72} \.{\land} rtombbuf \.{'} \.{=} [ rtombbuf {\EXCEPT} {\bang} [
 r ] \.{=} @ \.{\cup} \{ del \} ]}%
 \@x{\@s{27.72} \.{\land} {\UNCHANGED} {\langle} chins ,\, tcurrent ,\, rtree
 ,\, rinsbuf ,\, rins\_incoming ,\, rtomb\_incoming {\rangle}}%
\begin{lcom}{0}%
...
\end{lcom}%
\@x{ Send ( r ) \.{\defeq}}%
\@x{\@s{21.98} \.{\lor} \.{\land} Inscomm {\bang} Send ( r )}%
 \@x{\@s{33.09} \.{\land} {\UNCHANGED} {\langle} chins ,\, tcurrent ,\, rtree
 ,\, rtomb ,\, rtombbuf ,\, rtomb\_incoming {\rangle}}%
\@x{\@s{21.98} \.{\lor} \.{\land} Tombcomm {\bang} Send ( r )}%
 \@x{\@s{33.09} \.{\land} {\UNCHANGED} {\langle} chins ,\, tcurrent ,\, rtree
 ,\, rtomb ,\, rinsbuf ,\, rins\_incoming {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
receive transitions
...
\end{lcom}%
\@x{ Receive ( r ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} \.{\lor} \.{\land} Inscomm {\bang} Receive (
 r )}%
 \@x{\@s{43.68} \.{\land} {\UNCHANGED} {\langle} rtomb\_incoming ,\, rtombbuf
 {\rangle}}%
\@x{\@s{32.57} \.{\lor} \.{\land} Tombcomm {\bang} Receive ( r )}%
 \@x{\@s{43.68} \.{\land} {\UNCHANGED} {\langle} rins\_incoming ,\, rinsbuf
 {\rangle}}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} rtree \.{'}\@s{5.37} \.{=}\@s{4.1} [
 rtree\@s{4.1} {\EXCEPT} {\bang} [ r ] \.{=} @ \.{\cup} rins\_incoming [ r ]
 ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} rtomb \.{'} \.{=} [ rtomb {\EXCEPT} {\bang}
 [ r ] \.{=} @ \.{\cup} rtomb\_incoming [ r ] ]}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} {\langle} chins ,\, tcurrent
 {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ Next \.{\defeq}}%
...
\end{cpar}%
\end{lcom}%
 \@x{ EC \.{\defeq}\@s{4.1} Inscomm {\bang} EmptyChannel \.{\land}\@s{4.1}
 Tombcomm {\bang} EmptyChannel \.{\implies}}%
\@x{\@s{58.88} \A\, r1 ,\, r2\@s{4.1} \.{\in} Replica \.{:}}%
 \@x{\@s{76.39} Readtree2list ( rtree [ r1 ] ,\,\@w{o} ,\, rtomb [ r1 ] ,\, \{
 \} ) \.{=} Readtree2list ( rtree [ r2 ] ,\,\@w{o} ,\, rtomb [ r2 ] ,\, \{ \}
 )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 18 00:47:48 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 15
 21:05:43 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Dec} 12 21:27:49 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Dec} 04 21:42:36 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon}
 \ensuremath{Dec} 03 15:01:06 \ensuremath{CST} 2018 by \ensuremath{xhdn
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Nov} 28 22:07:24 \ensuremath{CST} 2018 by \ensuremath{jywellin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
