...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AltImplHandshake}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} AltImplHandshake {\p@lbrace}}%
\@x{\@s{8.2} {\p@variable} p \.{=} 0 ,\, c \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@process} {\p@lparen} Producer \.{=} 0 {\p@rparen}}%
\@x{\@s{16.4} {\p@variable} tp \.{=} 0 {\p@semicolon}}%
 \@x{\@s{16.4} {\p@lbrace}\@s{4.1} pe\@s{.5}\textrm{:}\@s{3} {\p@while}
 {\p@lparen} {\TRUE} {\p@rparen}}%
\@x{\@s{54.51} {\p@lbrace}\@s{20.5}}%
\@y{\@s{0}%
 await \ensuremath{p \.{=} c};
}%
\@xx{}%
\@x{\@s{84.59} tp \.{:=} c {\p@semicolon}}%
 \@x{\@s{62.71} pe1\@s{.5}\textrm{:}\@s{3}\@s{0.65} {\p@if} {\p@lparen} p
 \.{\neq} tp {\p@rparen} {\p@lbrace} {\p@goto} pe {\p@rbrace} {\p@semicolon}}%
\@x{\@s{62.71} put\@s{.5}\textrm{:}\@s{3}\@s{0.85} {\p@skip} {\p@semicolon}}%
\@x{\@s{62.71} px\@s{.5}\textrm{:}\@s{3}\@s{4.65} p \.{:=} p \.{\oplus} 1}%
\@x{\@s{54.51} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@process} {\p@lparen} Consumer \.{=} 1 {\p@rparen}}%
\@x{\@s{16.4} {\p@variable} tc \.{=} 0 {\p@semicolon}}%
 \@x{\@s{16.4} {\p@lbrace}\@s{4.1} ce\@s{.5}\textrm{:}\@s{3} {\p@while}
 {\p@lparen} {\TRUE} {\p@rparen}}%
\@x{\@s{54.00} {\p@lbrace}\@s{20.5}}%
\@y{\@s{0}%
 await \ensuremath{p \.{\neq} c};
}%
\@xx{}%
\@x{\@s{84.08} tc \.{:=} p {\p@semicolon}}%
 \@x{\@s{62.20} ce1\@s{.5}\textrm{:}\@s{3}\@s{1.16} {\p@if} {\p@lparen} c
 \.{=} tc {\p@rparen} {\p@lbrace} {\p@goto} ce {\p@rbrace} {\p@semicolon}}%
\@x{\@s{62.20} get\@s{.5}\textrm{:}\@s{3}\@s{2.13} {\p@skip} {\p@semicolon}}%
\@x{\@s{62.20} cx\@s{.5}\textrm{:}\@s{3}\@s{5.16} c \.{:=} c \.{\oplus} 1}%
\@x{\@s{54.00} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@pvspace{8.0pt}%
 \@x{ A \.{\defeq} {\INSTANCE} AltSpec {\WITH} b \.{\leftarrow} p \.{\oplus} c
 ,\, pc \.{\leftarrow} pcBar}%
\@x{}\bottombar\@xx{}%
\end{document}
