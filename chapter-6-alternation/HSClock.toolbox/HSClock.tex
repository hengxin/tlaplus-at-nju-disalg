...
\@x{\@s{8.2} {\p@process} {\p@lparen} Proc0 \.{=} 0 {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace}\@s{4.1} t\@s{.5}\textrm{:}\@s{3} {\p@while}
 {\p@lparen} {\TRUE} {\p@rparen}}%
 \@x{\@s{48.83} {\p@lbrace}\@s{4.1} {\p@await} ca [ 0 ] \.{=} ca [ N \.{-} 1 ]
 {\p@semicolon}}%
\@x{\@s{62.51} ca [ 0 ] \.{:=} ca [ 0 ] \.{\oplus} 1}%
\@x{\@s{48.83} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 ...
 \@x{\@s{16.4} {\p@lbrace}\@s{4.1} t\@s{.5}\textrm{:}\@s{3} {\p@while}
 {\p@lparen} {\TRUE} {\p@rparen}}%
 \@x{\@s{48.83} {\p@lbrace}\@s{4.1} {\p@await} ca [ self ] \.{\neq} ca [ self
 \.{-} 1 ] {\p@semicolon}}%
\@x{\@s{62.51} ca [ self ] \.{:=} ca [ self ] \.{\oplus} 1}%
\@x{\@s{48.83} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 Label t of process \ensuremath{Proc0} at line 12 col 11 changed to
 \ensuremath{t\_
}}%
\@xx{}%
\@x{ {\VARIABLE} ca}%
...
\@pvspace{8.0pt}%
 ...
 ca [ i ] \.{\neq} ca [ i \.{-} 1 ]}%
 \@x{\@s{53.08} \.{\THEN} {\CHOOSE} i \.{\in} 1 \.{\dotdot} ( N \.{-} 1 )
 \.{:} ca [ i ] \.{\neq} ca [ i \.{-} 1 ]}%
\@x{\@s{53.08} \.{\ELSE} 0}%
\@pvspace{8.0pt}%
