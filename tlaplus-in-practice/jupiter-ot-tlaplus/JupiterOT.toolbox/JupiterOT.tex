...
\@x{ {\CONSTANTS} NumOfClients ,\, NumOfOps}%
\@x{ Clients \.{\defeq} ( 1 \.{\dotdot} NumOfClients )}%
\@x{ Ops \.{\defeq} ( 1 \.{\dotdot} NumOfOps )}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} op ,\,\@s{35.12}}%
\@y{\@s{0}%
 Operation in the original or transformed form
}%
\@xx{}%
\@x{\@s{16.4} vertex ,\,\@s{18.79}}%
\@y{\@s{0}%
 Vertex of the state space graph
}%
\@xx{}%
\@x{\@s{16.4} edge ,\,\@s{26.82}}%
\@y{\@s{0}%
 Edge of the state space graph
}%
\@xx{}%
\@x{\@s{16.4} stateGraph\@s{4.09}}%
\@y{\@s{0}%
...
\@x{}\midbar\@xx{}%
 ...
 ,\, priority \.{:} Clients ]}%
\@x{ Vertices \.{\defeq} {\SUBSET} Ops}%
\@x{ Edges \.{\defeq} [ elbl \.{:} OP ,\, dest \.{:} Vertices ]}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} op \.{\in} OP}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 A vertex in the state space graph represents the set of operations it has
 processed
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} vertex \.{\in} Vertices}%
\@x{\@s{16.4} \.{\land} edge \.{\in} Edges}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed} May 31
 12:08:53 \ensuremath{CST} 2017 by ics-ant
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
