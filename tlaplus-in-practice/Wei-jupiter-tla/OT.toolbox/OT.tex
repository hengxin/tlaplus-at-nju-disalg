...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ OP \.{\defeq} [ type \.{:} \{\@w{ins} ,\,\@w{del} \} ,\, pos \.{:} POS
 ,\, ch \.{:} CH ,\, pr \.{:} PR ]}%
\@x{ NOP \.{\defeq} {\CHOOSE} v \.{:} v \.{\notin} OP}%
\@pvspace{8.0pt}%
\@x{ XformII ( lins ,\, rins ) \.{\defeq}}%
\@y{\@s{0}%
 the left insertion transformed against the right insertion
}%
\@xx{}%
...
\@x{\@s{32.8} \.{\ELSE} {\IF} lins . ch \.{=} rins . ch}%
\@x{\@s{49.19} \.{\THEN} NOP}%
\@x{\@s{49.19} \.{\ELSE} {\IF} lins . pr \.{>} rins . pr}%
\@x{\@s{65.6} \.{\THEN} [ lins {\EXCEPT} {\bang} . pos \.{=} @ \.{+} 1 ]}%
\@x{\@s{65.6} \.{\ELSE} lins}%
\@pvspace{8.0pt}%
\@x{ XformID ( ins ,\, del ) \.{\defeq}}%
\@y{\@s{0}%
 the left insertion transformed against the right deletion
}%
\@xx{}%
\@x{\@s{16.4} {\IF} ins . pos \.{<} del . pos}%
\@x{\@s{16.4} \.{\THEN} ins}%
\@x{\@s{16.4} \.{\ELSE} [ ins {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@pvspace{8.0pt}%
\@x{ XformDI ( del ,\, ins ) \.{\defeq}}%
\@y{\@s{0}%
 the first deletion transformed against the right insertion
}%
\@xx{}%
...
\@pvspace{8.0pt}%
\@x{ XformDD ( ldel ,\, rdel ) \.{\defeq}}%
\@y{\@s{0}%
 the first deletion transformed against the right deletion
}%
\@xx{}%
\@x{\@s{16.4} {\IF} ldel . pos \.{<} rdel . pos}%
\@x{\@s{16.4} \.{\THEN} ldel}%
\@x{\@s{16.4} \.{\ELSE} {\IF} ldel . pos \.{>} rdel . pos}%
\@x{\@s{32.8} \.{\THEN} [ ldel {\EXCEPT} {\bang} . pos \.{=} @ \.{-} 1 ]}%
\@x{\@s{32.8} \.{\ELSE} NOP}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{16.4} {\CASE} lop . type \.{=}\@w{ins} \.{\land} rop . type
 \.{=}\@w{ins} \.{\rightarrow} XformII ( lop ,\, rop )}%
 \@x{\@s{16.4} {\Box}\@s{4.1} lop . type \.{=}\@w{ins}\@s{0.61} \.{\land} rop
 . type \.{=}\@w{del} \.{\rightarrow} XformID ( lop ,\, rop )}%
 \@x{\@s{16.4} {\Box}\@s{4.10} lop . type \.{=}\@w{del} \.{\land} rop . type
 \.{=}\@w{ins}\@s{0.61} \.{\rightarrow} XformDI ( lop ,\, rop )}%
 \@x{\@s{16.4} {\Box}\@s{4.10} lop . type \.{=}\@w{del} \.{\land} rop . type
 \.{=}\@w{del} \.{\rightarrow} XformDD ( lop ,\, rop )}%
\@pvspace{8.0pt}%
\@x{ XformOpOps ( op ,\, ops ) \.{\defeq}}%
\@y{\@s{0}%
 the left operation is transformed against the right operation sequence
}%
\@xx{}%
 \@x{\@s{16.4} \.{\LET} X [ j \.{\in} 1 \.{\dotdot} Len ( ops ) \.{+} 1 ]
 \.{\defeq}}%
\@x{\@s{36.79} {\IF} j \.{=} 1}%
\@x{\@s{36.79} \.{\THEN} {\langle} op {\rangle}}%
 \@x{\@s{36.79} \.{\ELSE} Append ( X [ j \.{-} 1 ] ,\, Xform ( X [ j \.{-} 1 ]
 [ j \.{-} 1 ] ,\, ops [ j \.{-} 1 ] ) )}%
\@x{\@s{16.4} \.{\IN} X [ Len ( ops ) \.{+} 1 ]}%
\@pvspace{8.0pt}%
\@x{ XformOpsOp ( ops ,\, op ) \.{\defeq}}%
\@y{\@s{0}%
 the left operation sequence is transformed against the right single operation
}%
\@xx{}%
\@x{\@s{16.4} \.{\LET} T [ i \.{\in} 0 \.{\dotdot} Len ( ops ) ] \.{\defeq}}%
\@x{\@s{36.79} {\IF} i \.{=} 0}%
\@x{\@s{36.79} \.{\THEN} {\langle} {\rangle}}%
\@x{\@s{36.79} \.{\ELSE} \.{\LET} X \.{\defeq} XformOpOps ( op ,\, ops )}%
 \@x{\@s{68.11} \.{\IN} Append ( T [ i \.{-} 1 ] ,\, Xform ( ops [ i ] ,\, X [
 i ] ) )}%
\@x{\@s{16.4} \.{\IN} T [ Len ( ops ) ]}%
\@x{}\bottombar\@xx{}%
\end{document}
