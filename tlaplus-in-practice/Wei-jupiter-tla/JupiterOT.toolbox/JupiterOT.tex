...
\@x{}\moduleLeftDash\@xx{ {\MODULE} JupiterOT}\moduleRightDash\@xx{}%
...
\@x{\@s{16.4} myMsgs ,\,}%
\@x{\@s{16.4} otherMsgs ,\,}%
\@x{\@s{16.4} outgoing ,\,\@s{2.55}}%
\@y{\@s{0}%
 \ensuremath{outgoing[c]} and \ensuremath{outgoing[s]
}}%
\@xx{}%
\@x{\@s{16.4} incoming ,\,}%
\@y{\@s{0}%
 \ensuremath{incoming[c]} and \ensuremath{incoming[s]
}}%
\@xx{}%
\@x{\@s{16.4} str\@s{33.64}}%
\@y{\@s{0}%
 \ensuremath{str[c]} and \ensuremath{str[s]}: the string (sequence of
 characters)
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ OP \.{\defeq} [ type \.{:} \{\@w{Ins} ,\,\@w{Del} \} ,\, pos \.{:} Nat
 ,\, ch \.{:} CH ]\@s{8.2}}%
\@y{\@s{0}%
 set of all possible operations; ignoring READ now
}%
\@xx{}%
 \@x{ MSG \.{\defeq} [ op \.{:} OP ,\, my \.{:} Nat ,\, other \.{:} Nat
 ]\@s{12.29}}%
\@y{\@s{0}%
...
\@x{ Apply ( o ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{TODO}: \ensuremath{pos}\.{?} (starting from 1 \.{??}\.{?})
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} \.{\lor} \.{\land} o . type \.{=}\@w{Ins}}%
 \@x{\@s{38.62} \.{\land} str \.{'} \.{=} Append ( SubSeq ( str ,\, 1 ,\, o .
 pos \.{-} 1 ) ,\, o . ch ) \.{\circ} SubSeq ( str ,\, o . pos ,\, Len ( str
 ) )}%
\@x{\@s{27.51} \.{\lor} \.{\land} o . type \.{=}\@w{Del}}%
 \@x{\@s{38.62} \.{\land} str \.{'} \.{=} SubSeq ( str ,\, 1 ,\, o . pos \.{-}
 1 ) \.{\circ} SubSeq ( str ,\, o . pos ,\, Len ( str ) )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} myMsgs ,\, otherMsgs ,\,
 outgoing ,\, incoming {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Xform ( o ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} {\FALSE}}%
\@pvspace{8.0pt}%
\@x{ Issue ( node ,\, o ) \.{\defeq}}%
\@y{\@s{0}%
 A node issues an operation
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} Apply ( o )}%
 \@x{\@s{16.4} \.{\land} incoming \.{'} \.{=} [ incoming {\EXCEPT} {\bang} [ 1
 \.{-} node ] \.{=} Append ( @ ,\, [ op \.{\mapsto} o ,\, my \.{\mapsto}
 myMsgs ,\, other \.{\mapsto} otherMsgs ] ) ]}%
 \@x{\@s{16.4} \.{\land} outgoing \.{'}\@s{2.55} \.{=} [ outgoing {\EXCEPT}
 {\bang} [ node ] \.{=} Append ( @ ,\, [ op \.{\mapsto} o ,\, my \.{\mapsto}
 myMsgs ,\, other \.{\mapsto} otherMsgs ] ) ]}%
\@x{\@s{16.4} \.{\land} myMsgs \.{'} \.{=} myMsgs \.{+} 1}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} otherMsgs}%
\@pvspace{8.0pt}%
\@x{ Receive ( node ,\, msg ) \.{\defeq}}%
\@y{\@s{0}%
 A node receives an message
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} incoming [ node ] \.{\neq} {\langle}
 {\rangle}}%
\@x{\@s{16.4} \.{\land}\@s{5.06} msg \.{=} Head ( incoming [ node ] )}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} incoming \.{'} \.{=} [ incoming {\EXCEPT}
 {\bang} [ node ] \.{=} Tail ( @ ) ]\@s{4.1}}%
\@y{\@s{0}%
 removing this \ensuremath{msg} from incoming; won\mbox{'}t receive it again
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{5.06} outgoing \.{'}\@s{2.55} \.{=} [ outgoing
 {\EXCEPT} {\bang} [ node ]\@s{2.55} \.{=} SelectSeq ( @ ,\, {\LAMBDA} m
 \.{:} m . my \.{<} msg . other ) ]}%
\@x{\@s{16.4} \.{\land}\@s{5.06} Xform ( msg . op )}%
\@x{\@s{16.4} \.{\land}\@s{5.06} otherMsgs \.{'} \.{=} otherMsgs \.{+} 1}%
\@x{\@s{16.4} \.{\land}\@s{5.06} {\UNCHANGED} myMsgs}%
\@x{\@s{16.4} \.{\land}\@s{5.06} {\FALSE}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, n \.{\in} NODE ,\, o \.{\in} OP ,\, m \.{\in} MSG \.{:}}%
\@x{\@s{16.4} \.{\lor} Issue ( n ,\, o )}%
\@x{\@s{16.4} \.{\lor} Receive ( n ,\, m )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 15 17:42:34 \ensuremath{CST} 2017 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jun} 03
 19:24:10 \ensuremath{CST} 2017 by ics-ant
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} May 31 11:13:18
 \ensuremath{CST} 2017 by ics-ant
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Specification of the \ensuremath{Jupiter}
 protocol described in the papers
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* ``High-Latency, Low-Bandwidth
 \ensuremath{Windowing} in the \ensuremath{Jupiter} Collaboration System''
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* (\ensuremath{UIST} 1995) and ``Achieving
 Convergence in Operational Transformation:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Conditions, Mechanisms, and Systems''
