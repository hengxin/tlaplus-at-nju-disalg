...
\@pvspace{8.0pt}%
 ...
 \.{\times} POS \.{:} a \.{\leq} b \}}%
\@pvspace{8.0pt}%
\@x{ IntervalPS \.{\defeq} {\SUBSET} Intervals}%
\@pvspace{8.0pt}%
 \@x{ NonOverlappingIntervals \.{\defeq} \{ ints \.{\in} {\SUBSET} Intervals
 \.{:} \A\, i ,\, j \.{\in} ints \.{:}}%
\@x{\@s{16.4} i [ 2 ] \.{<} j [ 1 ] \.{\lor} j [ 2 ] \.{<} i [ 1 ] \}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Apr} 28
 22:51:46 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Apr} 28 20:51:31
