...
\@x{}\moduleLeftDash\@xx{ {\MODULE} MemoryInterface}\moduleRightDash\@xx{}%
\@x{ {\VARIABLE} memInt}%
\@x{ {\CONSTANTS}\@s{4.1} Send ( \_ ,\, \_ ,\, \_ ,\, \_ ) ,\,}%
\@x{\@s{58.85} Reply ( \_ ,\, \_ ,\, \_ ,\, \_ ) ,\,}%
\@x{\@s{58.85} InitMemInt ,\,}%
\@x{\@s{58.85} Proc ,\,}%
\@x{\@s{58.85} Adr ,\,}%
\@x{\@s{58.85} Val}%
\@pvspace{8.0pt}%
...
We comment out the assumption because \ensuremath{TLC} cannot handle unbounded
 quantifiers.
\end{cpar}%
\end{lcom}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{{\ASSUME}} \ensuremath{\A\, p}, d, \ensuremath{miOld},
 \ensuremath{miNew} :
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} Send(p,\,d,\,miOld,\,miNew) \.{\in} {\BOOLEAN}
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} Reply(p,\,d,\,miOld,\,miNew) \.{\in} {\BOOLEAN}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ MReq \.{\defeq} [ op \.{:} \{\@w{Rd} \} ,\, adr \.{:} Adr ]}%
 \@x{\@s{51.08} \.{\cup} [ op \.{:} \{\@w{Wr} \} ,\, adr \.{:} Adr ,\, val
 \.{:} Val ]}%
\@pvspace{8.0pt}%
