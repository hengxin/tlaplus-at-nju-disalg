...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SimpleAllocator}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} FiniteSets}%
\@x{ {\CONSTANTS} Clients ,\, Resources}%
\@x{ {\ASSUME} IsFiniteSet ( Resources )}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} unsat ,\,\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{unsat[c]} denotes the outstanding requests of client
 \ensuremath{c
}}%
\@xx{}%
\@x{\@s{16.4} alloc\@s{14.17}}%
\@y{\@s{0}%
 \ensuremath{alloc[c]} denotes the resources allocated to client \ensuremath{c
}}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TypeInvariant \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} unsat \.{\in} [ Clients \.{\rightarrow} {\SUBSET}
 Resources ]}%
 \@x{\@s{16.4} \.{\land} alloc\@s{3.96} \.{\in} [ Clients \.{\rightarrow}
 {\SUBSET} Resources ]}%
\@pvspace{8.0pt}%
\@x{ available \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} Resources \.{\,\backslash\,} ( {\UNION} \{ alloc [ c ] \.{:} c
 \.{\in} Clients \} )}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} unsat \.{=} [ c \.{\in} Clients \.{\mapsto} \{ \} ]}%
 \@x{\@s{16.4} \.{\land} alloc\@s{3.96} \.{=} [ c \.{\in} Clients \.{\mapsto}
 \{ \} ]}%
\@x{ Request ( c ,\, S ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c} requests set \ensuremath{S} of resources
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land}\@s{6.28} S \.{\neq} \{ \} \.{\land} unsat [ c ] \.{=}
 \{ \} \.{\land} alloc [ c ] \.{=} \{ \}}%
 \@x{\@s{16.4} \.{\land}\@s{6.28} unsat \.{'} \.{=} [ unsat {\EXCEPT} {\bang}
 [ c ] \.{=} S ]}%
\@x{\@s{16.4} \.{\land}\@s{6.28} {\UNCHANGED} alloc}%
\@x{ Allocate ( c ,\, S ) \.{\defeq}}%
\@y{\@s{0}%
 Set \ensuremath{S} of available resources are allocated to client
 \ensuremath{c
}}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} S \.{\neq} \{ \} \.{\land} S \.{\subseteq} available
 \.{\cap} unsat [ c ]}%
 \@x{\@s{16.4} \.{\land} alloc \.{'}\@s{3.96} \.{=} [ alloc {\EXCEPT} {\bang}
 [ c ]\@s{3.96} \.{=} @ \.{\cup} S ]}%
 \@x{\@s{16.4} \.{\land} unsat \.{'} \.{=} [ unsat {\EXCEPT} {\bang} [ c ]
 \.{=} @ \.{\,\backslash\,} S ]}%
\@x{ Return ( c ,\, S ) \.{\defeq}}%
\@y{\@s{0}%
 Client \ensuremath{c} returns a set of resources that it holds
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} S \.{\neq} \{ \} \.{\land} S \.{\subseteq} alloc [ c
 ]}%
 \@x{\@s{16.4} \.{\land} alloc \.{'} \.{=} [ alloc {\EXCEPT} {\bang} [ c ]
 \.{=} @ \.{\,\backslash\,} S ]}%
\@x{\@s{16.4} \.{\land} {\UNCHANGED} unsat}%
\@x{ Next \.{\defeq}}%
\@y{\@s{0}%
 The system\mbox{'}s next-state relation
}%
\@xx{}%
\@x{\@s{16.4} \E\, c \.{\in} Clients ,\, S \.{\in} {\SUBSET} Resources \.{:}}%
 \@x{\@s{27.72} Request ( c ,\, S ) \.{\lor} Allocate ( c ,\, S ) \.{\lor}
 Return ( c ,\, S )}%
\@x{ vars \.{\defeq} {\langle} unsat ,\, alloc {\rangle}}%
\@x{}\midbar\@xx{}%
\@x{ SimpleAllocator \.{\defeq}}%
\@y{\@s{0}%
 The complete high-level specification
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} Init \.{\land} {\Box} [ Next ]_{ vars}}%
 \@x{\@s{16.4} \.{\land} \A\, c \.{\in} Clients \.{:} {\WF}_{ vars} ( Return (
 c ,\, alloc [ c ] ) )}%
 \@x{\@s{16.4} \.{\land} \A\, c \.{\in} Clients \.{:} {\SF}_{ vars} ( \E\, S
 \.{\in} {\SUBSET} Resources \.{:} Allocate ( c ,\, S ) )}%
\@x{}\midbar\@xx{}%
 \@x{ Safety \.{\defeq} \A\, c1 ,\, c2 \.{\in} Clients \.{:} c1 \.{\neq} c2
 \.{\implies} alloc [ c1 ] \.{\cap} alloc [ c2 ] \.{=} \{ \}}%
 \@x{ Liveness \.{\defeq} \A\, c \.{\in} Clients ,\, r \.{\in} Resources \.{:}
 r \.{\in} unsat [ c ] \.{\leadsto} r \.{\in} alloc [ c ]}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun May 28 20:16:09
 \ensuremath{CST} 2017 by ics-ant
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun May 28 19:44:57 \ensuremath{CST}
 2017 by ics-ant
\end{cpar}%
\end{lcom}%
\end{document}
