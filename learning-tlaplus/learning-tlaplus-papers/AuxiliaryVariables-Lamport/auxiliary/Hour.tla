...
(***************************************************************************)
(* This is the constant condition that is required for s to be an          *)
(* auxiliary variable.                                                     *)
(***************************************************************************)
ASSUME StutterConstantCondition(1..59, 59, LAMBDA j : j+1)

TypeOKS == /\ TypeOK 
           /\ s \in {top} \cup [id : {"Next"}, ctxt : {""}, val : 1..59]
...
(***************************************************************************)
(* The following INSTANCE statement and theorem show that SpecS implements *)
(* Spec of module HourMin under a suitable refinement mapping, showing     *)
(* that \EE s : SpecS is equivalent to Spec.                               *)
(***************************************************************************)
...
\* Last modified Thu Oct 20 05:46:14 PDT 2016 by lamport
