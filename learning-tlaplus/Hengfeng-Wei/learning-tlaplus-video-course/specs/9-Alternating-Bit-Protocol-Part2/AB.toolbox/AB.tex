...
\setboolean{shading}{true}
 ...
 {\MODULE} AB}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers ,\,
 Sequences}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANT} Data}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Remove ( i ,\, seq )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{8.2} [ j \.{\in} 1
 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto} {\IF} j \.{<} i \.{\THEN}
 seq [ j ]}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{159.43} \.{\ELSE} seq [ j
 \.{+} 1 ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\VARIABLES} AVar ,\, BVar
 ,\,\@s{8.2}}%
\@y{\@s{0}%
 The same as in module \ensuremath{ABSpec
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{51.42} AtoB ,\,\@s{4.1}}%
\@y{\@s{0}%
 The sequence of data messages in transit from sender to receiver.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{51.42} BtoA\@s{10.98}}%
\@y{\@s{0}%
 The sequence of \ensuremath{ack} messages in transit from receiver to sender.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{85.30}}%
\@y{\@s{0}%
 Messages are sent by appending them to the end of the sequence.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{85.30}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 AVar ,\, BVar ,\, AtoB ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 AVar\@s{0.62} \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{56.14} \.{\land} BVar
 \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{56.14} \.{\land}
 AtoB\@s{0.43} \.{\in} Seq ( Data \.{\times} \{ 0 ,\, 1 \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{56.14} \.{\land}
 BtoA\@s{1.20} \.{\in} Seq ( \{ 0 ,\, 1 \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Init \.{\defeq} \.{\land}
 AVar\@s{0.62} \.{\in} Data \.{\times} \{ 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{35.70} \.{\land} BVar
 \.{=} AVar}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{35.70} \.{\land}
 AtoB\@s{0.43} \.{=} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{35.70} \.{\land}
 BtoA\@s{1.20} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} ASnd \.{\defeq} \.{\land}
 AtoB \.{'} \.{=} Append ( AtoB ,\, AVar )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{43.71} \.{\land}
 {\UNCHANGED} {\langle} AVar ,\, BtoA ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The action of the sender receiving an \ensuremath{ack} message. If that
 \ensuremath{ack} is for
 the value it is sending, then it chooses another message to send and
 sets \ensuremath{AVar} to that message. If the \ensuremath{ack} is for the
 previous value it
 sent, it ignores the message. In either case, it removes the message
 from \ensuremath{BtoA}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} ARcv \.{\defeq} \.{\land}
 BtoA \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{43.38} \.{\land} {\IF}
 Head ( BtoA ) \.{=} AVar [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{62.69} \.{\THEN} \E\, d
 \.{\in} Data \.{:} AVar \.{'} \.{=} {\langle} d ,\, 1 \.{-} AVar [ 2 ]
 {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{62.69} \.{\ELSE} AVar
 \.{'} \.{=} AVar}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{43.38} \.{\land} BtoA
 \.{'} \.{=} Tail ( BtoA )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{43.38} \.{\land}
 {\UNCHANGED} {\langle} AtoB ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} BSnd \.{\defeq} \.{\land}
 BtoA \.{'} \.{=} Append ( BtoA ,\, BVar [ 2 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{43.31} \.{\land}
 {\UNCHANGED} {\langle} AVar ,\, BVar ,\, AtoB {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} BRcv \.{\defeq} \.{\land}
 AtoB \.{\neq} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{42.98} \.{\land} {\IF}
 Head ( AtoB ) [ 2 ] \.{\neq} BVar [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{62.29} \.{\THEN} BVar
 \.{'} \.{=} Head ( AtoB )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{62.29} \.{\ELSE} BVar
 \.{'} \.{=} BVar}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{42.98} \.{\land} AtoB
 \.{'} \.{=} Tail ( AtoB )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{42.98} \.{\land}
 {\UNCHANGED} {\langle} AVar ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} LoseMsg \.{\defeq} \.{\land}
 \.{\lor} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( AtoB ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{101.63} AtoB \.{'} \.{=}
 Remove ( i ,\, AtoB )}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{79.21} \.{\land} BtoA
 \.{'} \.{=} BtoA}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{68.10} \.{\lor} \.{\land}
 \E\, i \.{\in} 1 \.{\dotdot} Len ( BtoA ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{101.63} BtoA \.{'} \.{=}
 Remove ( i ,\, BtoA )}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{79.21} \.{\land} AtoB
 \.{'} \.{=} AtoB}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{56.98} \.{\land}
 {\UNCHANGED} {\langle} AVar ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} Next \.{\defeq} ASnd
 \.{\lor} ARcv \.{\lor} BSnd \.{\lor} BRcv \.{\lor} LoseMsg}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} ABS \.{\defeq} {\INSTANCE}
 ABSpec}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}} {\THEOREM} Spec \.{\implies}
 ABS {\bang} Spec}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}} FairSpec \.{\defeq}
 Spec\@s{4.1} \.{\land}\@s{4.1} {\SF}_{ vars} ( ARcv )\@s{5.05} \.{\land}
 {\SF}_{ vars} ( BRcv ) \.{\land}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{95.30} {\WF}_{ vars} (
 ASnd ) \.{\land} {\WF}_{ vars} ( BSnd )}%
