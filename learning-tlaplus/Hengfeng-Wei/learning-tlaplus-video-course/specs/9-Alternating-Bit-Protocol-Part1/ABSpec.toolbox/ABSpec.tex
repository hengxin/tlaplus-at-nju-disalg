...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} FairSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} FairABSpec \.{\defeq} Spec
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} FairBSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ vars} ( B )}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat May 12 20:55:59
