...
\setboolean{shading}{true}
 ...
 {\MODULE} ABSpec}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANT} Data\@s{4.1}}%
\@y{\@s{0}%
 The set of all possible data values.
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\VARIABLES} AVar
 ,\,\@s{8.2}}%
\@y{\@s{0}%
 The last \ensuremath{{\langle}value,\, bit{\rangle}} pair A decided to send.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{51.42} BVar\@s{13.68}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 AVar\@s{0.62} \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{56.14} \.{\land} BVar
 \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} A\@s{0.63} \.{\defeq}
 \.{\land} AVar \.{=} BVar}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{26.95} \.{\land} \E\,
 d\@s{10.11} \.{\in} Data \.{:} AVar \.{'} \.{=} {\langle} d ,\, 1 \.{-} AVar
 [ 2 ] {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{26.95} \.{\land} BVar
 \.{'} \.{=} BVar}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} B \.{\defeq} \.{\land} AVar
 \.{\neq} BVar}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{26.95} \.{\land} BVar
 \.{'} \.{=} AVar}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{26.95} \.{\land} AVar
 \.{'}\@s{0.62} \.{=} AVar}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}} Next \.{\defeq} A \.{\lor}
 B}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} Spec\@s{1.46} \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} Inv \.{\defeq} ( AVar [ 2 ]
 \.{=} BVar [ 2 ] ) \.{\implies} ( AVar \.{=} BVar )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} DeliveryLiveness \.{\defeq}
 \A\, v \.{\in} Data \.{\times} \{ 0 ,\, 1 \} \.{:} ( AVar \.{=} v )
 \.{\leadsto} ( BVar \.{=} v )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} FairSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{FairABSpec} is \ensuremath{Spec} with the additional requirement
 that both A and \ensuremath{B
} keep taking steps.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} FairABSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ vars} ( A ) \.{\land} {\WF}_{ vars} ( B )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{FairBSpec} is \ensuremath{Spec} with the additional requirement
 that every sent value
 to be received, but allows the sender to stop sending.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} FairBSpec \.{\defeq} Spec
 \.{\land} {\WF}_{ vars} ( B )}%
\@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Aug} 11
 22:07:13 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat May 12 20:51:26
