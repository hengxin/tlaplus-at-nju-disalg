...
DeliveryLiveness == \A v \in Data \X {0,1}: (AVar = v) ~> (BVar = v)
-----------------------------------------------------------------------------
(***************************************************************************)
...
(***************************************************************************)
(* FairABSpec is Spec with the additional requirement that both A and B    *)
(* keep taking steps.                                                                  *)
(***************************************************************************)
FairABSpec == Spec /\ WF_vars(A) /\ WF_vars(B)

(***************************************************************************)
(* FairBSpec is Spec with the additional requirement that every sent value *)
(* to be received, but allows the sender to stop sending.                  *)
(***************************************************************************)
FairBSpec == Spec /\ WF_vars(B)
=============================================================================
