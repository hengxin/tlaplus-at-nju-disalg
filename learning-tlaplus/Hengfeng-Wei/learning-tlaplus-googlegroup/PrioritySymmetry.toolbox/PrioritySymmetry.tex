...
\setboolean{shading}{true}
 \@x{\makebox[0pt][r]{\scriptsize 1\hspace{1em}} {\EXTENDS} Naturals
 ,\,}\moduleLeftDash\@xx{ {\MODULE} PrioritySymmetry}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Naturals ,\, Reals
 ,\, FiniteSets ,\, AdditionalFunctionOperators}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} Client
 ,\,\@s{12.29}}%
\@y{\@s{0}%
 the set of clients
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{54.75} N}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} Priority \.{\defeq} {\CHOOSE}
 f \.{\in} [ Client \.{\rightarrow} 1 \.{\dotdot} Cardinality ( Client ) ]
 \.{:} Injective ( f )}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\p@mmalgorithm} Foo
 {\p@lbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{12.29} {\p@variable} x
 \.{\in} Client {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{12.29} {\p@lbrace} x
 \.{:=} ( N \.{-} Priority [ x ] )}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{12.29} {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\VARIABLES} x ,\, pc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{37.72} \.{\land} x
 \.{\in} Client}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{37.72} \.{\land} pc
 \.{=}\@w{Lbl\_1}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Lbl\_1 \.{\defeq} \.{\land}
 pc \.{=}\@w{Lbl\_1}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{42.84} \.{\land} x
 \.{'}\@s{1.11} \.{=} ( N \.{-} Priority [ x ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{42.84} \.{\land} pc \.{'}
 \.{=}\@w{Done}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} Next \.{\defeq} Lbl\_1}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
 Disjunct to prevent deadlock on termination
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{63.24} ( pc
 \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Termination \.{\defeq}
 {\Diamond} ( pc \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 03 13:53:10 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Dec} 03
 10:49:05 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
