...
\setboolean{shading}{true}
 ...
 WrongWriteThroughCache}\moduleRightDash\@xx{}%
...
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq} \.{\land} M {\bang} IInit}%
 \@x{\@s{35.70} \.{\land} cache \.{=} [ p \.{\in} Proc \.{\mapsto} [ a \.{\in}
 Adr \.{\mapsto} NoVal ] ]}%
\@x{\@s{35.70} \.{\land} memQ \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq}}%
\@x{\@s{8.2} \.{\land} wmem\@s{4.1} \.{\in} [ Adr \.{\rightarrow} Val ]}%
 \@x{\@s{8.2} \.{\land} ctl\@s{20.95} \.{\in} [ Proc \.{\rightarrow}
 \{\@w{rdy} ,\,\@w{busy} ,\,\@w{waiting} ,\,\@w{done} \} ]}%
 \@x{\@s{8.2} \.{\land} buf\@s{17.31} \.{\in} [ Proc \.{\rightarrow} MReq
 \.{\cup} Val \.{\cup} \{ NoVal \} ]}%
 \@x{\@s{8.2} \.{\land} cache\@s{8.20} \.{\in} [ Proc \.{\rightarrow} [ Adr
 \.{\rightarrow} Val \.{\cup} \{ NoVal \} ] ]}%
\@x{\@s{8.2} \.{\land} memQ\@s{2.90} \.{\in} Seq ( Proc \.{\times} MReq )}%
\@pvspace{8.0pt}%
\@x{ Coherence \.{\defeq} \A\, p ,\, q \.{\in} Proc ,\, a \.{\in} Adr \.{:}}%
 \@x{\@s{71.45} ( NoVal \.{\notin} \{ cache [ p ] [ a ] ,\, cache [ q ] [ a ]
 \} )}%
\@x{\@s{95.84} \.{\implies} ( cache [ p ] [ a ] \.{=} cache [ q ] [ a ] )}%
\@x{}\midbar\@xx{}%
 \@x{ Req ( p )\@s{0.76} \.{\defeq} M {\bang} Req ( p )\@s{0.76} \.{\land}
 {\UNCHANGED} {\langle} cache ,\, memQ {\rangle}}%
 \@x{ Rsp ( p ) \.{\defeq} M {\bang} Rsp ( p ) \.{\land} {\UNCHANGED}
 {\langle} cache ,\, memQ {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ RdMiss ( p ) \.{\defeq}\@s{4.1} \.{\land} ( ctl [ p ] \.{=}\@w{busy} )
 \.{\land} ( buf [ p ] . op \.{=}\@w{Rd} )}%
\@x{\@s{69.43} \.{\land} cache [ p ] [ buf [ p ] . adr ] \.{=} NoVal}%
\@x{\@s{69.43} \.{\land} Len ( memQ ) \.{<} QLen}%
 \@x{\@s{69.43} \.{\land} memQ \.{'} \.{=} Append ( memQ ,\, {\langle} p ,\,
 buf [ p ] {\rangle} )}%
 \@x{\@s{69.43} \.{\land} ctl \.{'} \.{=} [ ctl {\EXCEPT} {\bang} [ p ]
 \.{=}\@w{waiting} ]}%
 \@x{\@s{69.43} \.{\land} {\UNCHANGED} {\langle} memInt ,\, wmem ,\, buf ,\,
 cache {\rangle}}%
\@pvspace{8.0pt}%
\@x{ DoRd ( p ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} ctl [ p ] \.{\in} \{\@w{busy} ,\,\@w{waiting} \}}%
\@x{\@s{8.2} \.{\land} buf [ p ] . op \.{=}\@w{Rd}}%
\@x{\@s{8.2} \.{\land} cache [ p ] [ buf [ p ] . adr ] \.{\neq} NoVal}%
 \@x{\@s{8.2} \.{\land} buf \.{'} \.{=} [ buf {\EXCEPT} {\bang} [ p ] \.{=}
 cache [ p ] [ buf [ p ] . adr ] ]}%
 \@x{\@s{8.2} \.{\land} ctl \.{'}\@s{3.64} \.{=} [ ctl {\EXCEPT} {\bang} [ p
 ]\@s{3.64} \.{=}\@w{done} ]}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} memInt ,\, wmem ,\, cache ,\,
 memQ {\rangle}}%
\@pvspace{8.0pt}%
\@x{ DoWr ( p ) \.{\defeq}}%
\@x{\@s{8.2} \.{\LET} r\@s{7.57} \.{\defeq} buf [ p ]}%
 \@x{\@s{8.2} \.{\IN} \.{\land} ( ctl [ p ] \.{=}\@w{busy} ) \.{\land} ( r .
 op \.{=}\@w{Wr} )}%
\@x{\@s{28.59} \.{\land} Len ( memQ ) \.{<} QLen}%
\@x{\@s{28.59} \.{\land} cache \.{'} \.{=} [ q \.{\in} Proc \.{\mapsto}}%
 \@x{\@s{86.98} {\IF} ( p \.{=} q )\@s{4.1} \.{\lor}\@s{4.1} ( cache [ q ] [ r
 . adr ] \.{\neq} NoVal )}%
 \@x{\@s{95.18} \.{\THEN} [ cache [ q ] {\EXCEPT} {\bang} [ r . adr ] \.{=} r
 . val ]}%
\@x{\@s{95.18} \.{\ELSE} cache [ q ] ]}%
 \@x{\@s{28.59} \.{\land} memQ \.{'} \.{=} Append ( memQ ,\, {\langle} p ,\, r
 {\rangle} )}%
 \@x{\@s{28.59} \.{\land} buf \.{'} \.{=} [ buf {\EXCEPT} {\bang} [ p ] \.{=}
 NoVal ]}%
 \@x{\@s{28.59} \.{\land} ctl \.{'}\@s{3.64} \.{=} [ ctl {\EXCEPT} {\bang} [ p
 ]\@s{3.64} \.{=}\@w{done} ]}%
\@x{\@s{28.59} \.{\land} {\UNCHANGED} {\langle} memInt ,\, wmem {\rangle}}%
\@pvspace{8.0pt}%
\@x{ vmem\@s{4.1} \.{\defeq}}%
 \@x{\@s{8.2} \.{\LET}\@s{1.82} f [ i \.{\in} 0 \.{\dotdot} Len ( memQ ) ]
 \.{\defeq}}%
\@x{\@s{38.38} {\IF} i \.{=} 0 \.{\THEN} wmem}%
\@x{\@s{72.96} \.{\ELSE} {\IF} memQ [ i ] [ 2 ] . op \.{=}\@w{Rd}}%
\@x{\@s{112.47} \.{\THEN} f [ i \.{-} 1 ]}%
 \@x{\@s{112.47} \.{\ELSE} [ f [ i \.{-} 1 ] {\EXCEPT} {\bang} [ memQ [ i ] [
 2 ] . adr ] \.{=}}%
\@x{\@s{236.17} memQ [ i ] [ 2 ] . val ]}%
\@x{\@s{8.2} \.{\IN} f [ Len ( memQ ) ]}%
\@pvspace{8.0pt}%
\@x{ MemQWr \.{\defeq} \.{\LET} r \.{\defeq} Head ( memQ ) [ 2 ]}%
 \@x{\@s{63.58} \.{\IN} \.{\land} ( memQ \.{\neq} {\langle} {\rangle}
 )\@s{4.1} \.{\land}\@s{8.2} ( r . op \.{=}\@w{Wr} )}%
 \@x{\@s{83.98} \.{\land} wmem \.{'}\@s{2.27} \.{=} [ wmem {\EXCEPT} {\bang} [
 r . adr ] \.{=} r . val ]}%
\@x{\@s{83.98} \.{\land} memQ \.{'}\@s{1.08} \.{=} Tail ( memQ )}%
 \@x{\@s{83.98} \.{\land} {\UNCHANGED} {\langle} memInt ,\, buf ,\, ctl ,\,
 cache {\rangle}}%
\@pvspace{8.0pt}%
\@x{ MemQRd\@s{2.35} \.{\defeq}}%
\@x{\@s{8.2} \.{\LET} p\@s{3.65} \.{\defeq} Head ( memQ ) [ 1 ]}%
\@x{\@s{32.69} r \.{\defeq} Head ( memQ ) [ 2 ]}%
 \@x{\@s{8.2} \.{\IN}\@s{4.09} \.{\land} ( memQ \.{\neq} {\langle} {\rangle} )
 \.{\land} ( r . op \.{=}\@w{Rd} )}%
\@x{\@s{32.69} \.{\land} memQ \.{'}\@s{1.08} \.{=} Tail ( memQ )}%
 \@x{\@s{32.69} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT} {\bang} [ p ] [
 r . adr ] \.{=} wmem [ r . adr ] ]}%
\@y{\@s{0}%
 Wrong: \mbox{'}vmen\mbox{'} has been deliberately replaced by
 \mbox{'}wmem\mbox{'}
}%
\@xx{}%
 \@x{\@s{32.69} \.{\land} {\UNCHANGED} {\langle} memInt ,\, wmem ,\, buf ,\,
 ctl {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Evict ( p ,\, a ) \.{\defeq} \.{\land} ( ctl [ p ] \.{=}\@w{waiting} )
 \.{\implies} ( buf [ p ] . adr \.{\neq} a )}%
 \@x{\@s{67.71} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT} {\bang} [ p ] [
 a ] \.{=} NoVal ]}%
 \@x{\@s{67.71} \.{\land} {\UNCHANGED} {\langle} memInt ,\, wmem ,\, buf ,\,
 ctl ,\, memQ {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} \.{\lor} \E\, p \.{\in} Proc \.{:} \.{\lor} Req ( p )
 \.{\lor} Rsp ( p )}%
 \@x{\@s{105.82} \.{\lor} RdMiss ( p ) \.{\lor} DoRd ( p ) \.{\lor} DoWr ( p
 )}%
\@x{\@s{105.82} \.{\lor} \E\, a \.{\in} Adr \.{:} Evict ( p ,\, a )}%
\@x{\@s{39.83} \.{\lor} MemQWr \.{\lor} MemQRd}%
\@pvspace{8.0pt}%
\@x{ Spec\@s{1.46} \.{\defeq}}%
 \@x{\@s{8.2} Init \.{\land} {\Box} [ Next ]_{ {\langle} memInt ,\, wmem ,\,
 buf ,\, ctl ,\, cache ,\, memQ {\rangle}}}%
\@x{}\midbar\@xx{}%
 \@x{ {\THEOREM} Spec \.{\implies} {\Box} ( TypeInvariant \.{\land} Coherence
 )}%
\@x{}\midbar\@xx{}%
\@x{ LM \.{\defeq} {\INSTANCE} Memory}%
\@x{ {\THEOREM} Spec \.{\implies} LM {\bang} Spec}%
\@x{}\bottombar\@xx{}%
\end{document}
