...
\@x{}\moduleLeftDash\@xx{ {\MODULE} HourMin}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This module specifies a 24-hour clock displaying the hour \ensuremath{h} and
 the
 minute \ensuremath{m}, initially showing the time 00:00.
\end{cpar}%
\end{lcom}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLES} h ,\, m}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} ( h \.{\in} 0 \.{\dotdot} 23 ) \.{\land} ( m \.{\in} 0
 \.{\dotdot} 59 )}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq} ( h \.{=} 0 ) \.{\land} ( m \.{=} 0 )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\land} m \.{'} \.{=} ( m \.{+} 1 ) \.{\%} 60}%
 \@x{\@s{39.83} \.{\land} h \.{'}\@s{3.06} \.{=} {\IF} m \.{'} \.{=} 0
 \.{\THEN} ( h \.{+} 1 ) \.{\%} 24}%
\@x{\@s{118.26} \.{\ELSE} h}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} h
 ,\, m {\rangle}}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 20 05:48:46 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Oct} 02 09:59:18
