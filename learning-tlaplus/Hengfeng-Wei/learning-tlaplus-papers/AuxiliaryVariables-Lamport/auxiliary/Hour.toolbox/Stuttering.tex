...
\@x{\@s{67.02} \.{\THEN} A \.{\land} ( s \.{'} \.{=} s )}%
 \@x{\@s{67.02} \.{\ELSE} s \.{'} \.{=} [ id \.{\mapsto} actionId ,\, ctxt
 \.{\mapsto} context ,\, val \.{\mapsto} initVal ]}%
\@x{\@s{16.4} \.{\ELSE} \.{\land} s . id \.{=} actionId}%
 \@x{\@s{47.71} \.{\land} {\IF} s . val \.{=} bot \.{\THEN} \.{\land} s . ctxt
 \.{=} context}%
...
\@x{}%
\@y{\@s{5.0}%
 \ensuremath{\.{\LET} InverseDecr(S) \.{\defeq} \{sig \.{\in} Sigma
 \.{\,\backslash\,} S \.{:} decr(sig) \.{\in} S\}
}}%
\@xx{}%
\@x{}%
\@y{\@s{15.0}%
 \ensuremath{ReachBot[S \.{\in} {\SUBSET} Sigma] \.{\defeq}
}}%
\@xx{}%
\@x{}%
\@y{\@s{22.5}%
 \ensuremath{{\IF}} \ensuremath{InverseDecr(S) \.{=} \{\} \.{\THEN} S
}}%
\@xx{}%
\@x{}%
\@y{\@s{80.0}%
 \ensuremath{\.{\ELSE} ReachBot[S \.{\cup} InverseDecr(S)]
}}%
\@xx{}%
\@x{}%
\@y{\@s{5.0}%
 \ensuremath{\.{\IN} ReachBot[\{bot\}] \.{=} Sigma
}}%
\@xx{}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 20 06:27:41 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
