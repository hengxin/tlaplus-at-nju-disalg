...
\end{cpar}%
\end{lcom}%
 \@x{ PartialFcns ( U ,\, V ) \.{\defeq} {\UNION} \{ [ D \.{\rightarrow} V ]
 \.{:} D \.{\in} {\SUBSET} U \}}%
\@x{ TypeOK \.{\defeq} \.{\land} imem \.{\in} IMemVals}%
 \@x{\@s{56.14} \.{\land} \.{\land} {\DOMAIN} interface \.{=} Readers \.{\cup}
 Writers}%
 \@x{\@s{67.25} \.{\land} \A\, i \.{\in} Readers \.{:} interface [ i ] \.{\in}
 MemVals \.{\cup} \{ NotMemVal \}}%
 \@x{\@s{67.25} \.{\land} \A\, i \.{\in} Writers\@s{0.49} \.{:} interface [ i
 ] \.{\in} RegVals\@s{6.27} \.{\cup} \{ NotRegVal \}}%
\@x{\@s{56.14} \.{\land} wrNum \.{\in} [ Writers \.{\rightarrow} Nat ]}%
 \@x{\@s{56.14} \.{\land} rdVal1 \.{\in} [ Readers \.{\rightarrow} PartialFcns
 ( Writers ,\, IRegVals ) ]}%
 \@x{\@s{56.14} \.{\land} rdVal2 \.{\in} [ Readers \.{\rightarrow} PartialFcns
 ( Writers ,\, IRegVals ) ]}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} imem \.{=} InitIMem}%
 \@x{\@s{35.70} \.{\land} interface \.{=} [ i \.{\in} Readers \.{\cup} Writers
 \.{\mapsto}}%
 \@x{\@s{105.45} {\IF} i \.{\in} Readers \.{\THEN} InitMem \.{\ELSE} NotRegVal
 ]}%
\@x{\@s{35.70} \.{\land} wrNum \.{=} [ i \.{\in} Writers \.{\mapsto} 0 ]}%
 \@x{\@s{35.70} \.{\land} rdVal1 \.{=} [ i \.{\in} Readers \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{35.70} \.{\land} rdVal2 \.{=} [ i \.{\in} Readers \.{\mapsto}
 {\langle} {\rangle} ]}%
\@pvspace{8.0pt}%
...
\@x{ AddToFcn ( f ,\, x ,\, v ) \.{\defeq}}%
 \@x{\@s{8.2} [ y \.{\in} ( {\DOMAIN} f ) \.{\cup} \{ x \} \.{\mapsto} {\IF} y
 \.{=} x \.{\THEN} v \.{\ELSE} f [ y ] ]}%
\@pvspace{8.0pt}%
\@x{ Rd1 ( i ) \.{\defeq} \.{\land} interface [ i ] \.{=} NotMemVal}%
 \@x{\@s{48.67} \.{\land} \E\, j \.{\in} Writers \.{\,\backslash\,} {\DOMAIN}
 rdVal1 [ i ] \.{:}}%
 \@x{\@s{67.01} rdVal1 \.{'} \.{=} [ rdVal1 {\EXCEPT} {\bang} [ i ] \.{=}
 AddToFcn ( rdVal1 [ i ] ,\, j ,\, imem [ j ] ) ]}%
...
\@x{\@s{48.67} \.{\land} {\DOMAIN} rdVal1 [ i ] \.{=} Writers}%
 \@x{\@s{48.67} \.{\land} \E\, j \.{\in} Writers \.{\,\backslash\,} {\DOMAIN}
 rdVal2 [ i ] \.{:}}%
 \@x{\@s{67.01} rdVal2 \.{'} \.{=} [ rdVal2 {\EXCEPT} {\bang} [ i ] \.{=}
 AddToFcn ( rdVal2 [ i ] ,\, j ,\, imem [ j ] ) ]}%
 \@x{\@s{48.67} \.{\land} {\UNCHANGED} {\langle} interface ,\, imem ,\, wrNum
 ,\, rdVal1 {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{95.96} \.{\THEN} \.{\land} interface \.{'} \.{=}}%
\@x{\@s{146.59} [ interface {\EXCEPT}}%
 \@x{\@s{153.46} {\bang} [ i ] \.{=} [ j \.{\in} Writers \.{\mapsto} rdVal1 [
 i ] [ j ] [ 1 ] ] ]}%
\@x{\@s{95.96} \.{\ELSE} \.{\land} interface \.{'} \.{=} interface}%
