...
\setboolean{shading}{true}
 ...
 {\MODULE} MinMax2H}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This module defines \ensuremath{SpecH} to be a specification obtained by
 adding a
 history variable \ensuremath{h} to the specification \ensuremath{Spec} of
 module \ensuremath{MinMax2}. It
 then shows that \ensuremath{SpecH} implements specification
 \ensuremath{Spec} of module \ensuremath{MinMax1
} under the refinment mapping \ensuremath{y \.{\leftarrow} h}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} MinMax2}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\VARIABLE} h}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} varsH \.{\defeq} {\langle}
 vars ,\, h {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{InitH} is the initial predicate of \ensuremath{SpecH} and
 \ensuremath{NextH} is its next-state
 action, obtained by adding the history variable \ensuremath{h} to the
 subactions
 \ensuremath{InputNum} and \ensuremath{Respond} of the obvious disjunctive
 representation of \ensuremath{Next}.
 (Disjunctive representations are explained in Section 3.2 of the paper
 ``Auxiliary Variables in TLA+''.)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} InitH \.{\defeq}
 Init\@s{11.57} \.{\land} ( h \.{=} \{ \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} InputNumH \.{\defeq}
 \.{\land} InputNum}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{72.21} \.{\land} h \.{'}
 \.{=} h}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} RespondH \.{\defeq}
 \.{\land} Respond}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{63.87} \.{\land} h \.{'}
 \.{=} h \.{\cup} \{ x \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} NextH \.{\defeq} InputNumH
 \.{\lor} RespondH}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} SpecH\@s{1.08} \.{\defeq}
 InitH \.{\land} {\Box} [ NextH ]_{ varsH}}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The following statement and theorem assert that \ensuremath{SpecH} implements
 specification \ensuremath{Spec} of module \ensuremath{MinMax1} under the
 refinement mapping \ensuremath{y \.{\leftarrow}
 h}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} M \.{\defeq} {\INSTANCE}
 MinMax1 {\WITH} y \.{\leftarrow} h}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} {\THEOREM} SpecH
 \.{\implies} M {\bang} Spec}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 21 23:59:25 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 26
 14:51:37 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
