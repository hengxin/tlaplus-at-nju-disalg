...
The equivalence of the two linearizable snapshot algorithms means that
 ...
 equivalent to \ensuremath{{\EE} mem}, \ensuremath{istate} :
 \ensuremath{Spec\_L}. We only show that the first
...
\@x{ {\VARIABLES} mem ,\, interface ,\, rstate ,\, wstate}%
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} mem \.{\in} MemVals}%
 ...
 \@x{\@s{56.14} \.{\land} \.{\land} rstate \.{\in} [ Readers \.{\rightarrow}
 Seq ( MemVals ) ]}%
\@x{\@s{67.25} \.{\land} \A\, i \.{\in} Readers \.{:}}%
 \@x{\@s{89.68} ( rstate [ i ] \.{=} {\langle} {\rangle} ) \.{\equiv} (
 interface [ i ] \.{\in} MemVals )}%
 \@x{\@s{56.14} \.{\land} wstate \.{\in} [ Writers \.{\rightarrow} RegVals
 \.{\cup} \{ NotRegVal \} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ EndRd ( i )\@s{2.35} \.{\defeq} \.{\land} interface [ i ] \.{=}
 NotMemVal}%
 \@x{\@s{63.55} \.{\land} \E\, j \.{\in} 1 \.{\dotdot} Len ( rstate [ i ] )
 \.{:}}%
 \@x{\@s{85.98} interface \.{'} \.{=} [ interface {\EXCEPT} {\bang} [ i ]
 \.{=} rstate [ i ] [ j ] ]}%
 \@x{\@s{63.55} \.{\land} rstate \.{'} \.{=} [ rstate {\EXCEPT} {\bang} [ i ]
 \.{=} {\langle} {\rangle} ]}%
\@x{\@s{63.55} \.{\land} {\UNCHANGED} {\langle} mem ,\, wstate {\rangle}}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
 \@x{ Fairness \.{\defeq} \.{\land} \A\, i \.{\in} Readers \.{:} {\WF}_{ vars}
 ( EndRd ( i ) )}%
 \@x{\@s{56.26} \.{\land} \A\, i \.{\in} Writers\@s{0.49} \.{:} {\WF}_{ vars}
