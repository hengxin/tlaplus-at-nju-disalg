...
\setboolean{shading}{true}
 ...
 {\MODULE} MinMax2}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
This module specifies a system with the same interaction between a user
 and a server as the one in module \ensuremath{MinMax1}, but instead of
 remembering
 the entire set of inputs, it uses two variables \ensuremath{min} and
 \ensuremath{max} to keep the
 largest and smallest values input thus far. Initially \ensuremath{min} equals
 Infinity and \ensuremath{max} equals \ensuremath{MinusInfinity}, where
 \ensuremath{Infinity} and \ensuremath{MinusInfinity
} are two values that are considered greater than and less than any
 integer, respectively.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\EXTENDS} Integers ,\,
 Sequences}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\CONSTANTS} Lo ,\, Hi ,\,
 Both ,\, None}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\ASSUME} \{ Lo ,\, Hi ,\,
 Both ,\, None \} \.{\cap} Int \.{=} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Infinity\@s{27.11}
 \.{\defeq} {\CHOOSE} n \.{:} n \.{\notin} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} MinusInfinity \.{\defeq}
 {\CHOOSE} n \.{:} n \.{\notin} ( Int \.{\cup} \{ Infinity \} )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The operators \ensuremath{IsLeq} and \ensuremath{IsGeq} extend
 \ensuremath{\.{\leq}} and \ensuremath{\.{\geq}}, respectively, to have
 the correct meaning when \ensuremath{Infinity} or \ensuremath{MinusInfinity}
 is one of the
 arguments.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} IsLeq ( i ,\, j )\@s{1.97}
 \.{\defeq} ( j \.{=} Infinity ) \.{\lor} ( i \.{\leq} j )}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} IsGeq ( i ,\, j ) \.{\defeq}
 ( j \.{=} MinusInfinity ) \.{\lor} ( i \.{\geq} j )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} {\VARIABLES} x ,\, turn ,\,
 min ,\, max}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, turn ,\, min ,\, max {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Init\@s{2.02}
 \.{\defeq}\@s{4.1} \.{\land} x \.{=} None}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{41.82} \.{\land} turn
 \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{41.82} \.{\land}
 min\@s{1.49} \.{=} Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{41.82} \.{\land} max
 \.{=} MinusInfinity}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} InputNum \.{\defeq}\@s{4.1}
 \.{\land} turn \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{68.01} \.{\land} turn
 \.{'} \.{=}\@w{output}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{68.01} \.{\land} x \.{'}
 \.{\in} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{68.01} \.{\land}
 {\UNCHANGED} {\langle} min ,\, max {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} Respond\@s{8.07}
 \.{\defeq}\@s{4.1} \.{\land} turn \.{=}\@w{output}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{68.01} \.{\land} turn
 \.{'} \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{68.01} \.{\land} min
 \.{'}\@s{1.49} \.{=} {\IF} IsLeq ( x ,\, min )\@s{3.47} \.{\THEN} x
 \.{\ELSE} min}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{68.01} \.{\land} max
 \.{'} \.{=} {\IF} IsGeq ( x ,\, max ) \.{\THEN} x \.{\ELSE} max}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{68.01} \.{\land} x \.{'}
 \.{=} {\IF} x \.{=} max \.{'} \.{\THEN} {\IF} x \.{=} min \.{'} \.{\THEN}
 Both \.{\ELSE} Hi}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{154.37} \.{\ELSE} {\IF} x
 \.{=} min \.{'} \.{\THEN} Lo\@s{9.84} \.{\ELSE} None}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} Next \.{\defeq} InputNum
 \.{\lor} Respond}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Spec\@s{1.46} \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} NoneProperty \.{\defeq}
 {\Box} [ \.{\land} x \.{\in} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{89.98} \.{\land} \{ min
 ,\, max \} \.{\neq} \{ Infinity ,\, MinusInfinity \}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{89.98} \.{\land} x \.{<}
 max}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{89.98} \.{\land} x \.{>}
 min}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{89.98} \.{\equiv} x \.{'}
 \.{=} None ]_{ vars}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 20:48:02 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Last} modified \ensuremath{Tue}
 \ensuremath{Jun} 26 20:02:15 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Last} modified \ensuremath{Fri}
 \ensuremath{Oct} 21 23:57:32 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 26
 14:32:23 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
