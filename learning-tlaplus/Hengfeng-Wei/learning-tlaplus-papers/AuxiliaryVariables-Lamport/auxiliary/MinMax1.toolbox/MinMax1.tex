...
\setboolean{shading}{true}
 ...
 {\MODULE} MinMax1}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This module and modules \ensuremath{MinMax2} and \ensuremath{MinMax2H} are
 used as examples in
...
This module specifies a tiny system in which a user presents a server
 ...
 input value i with with one of the following outputs: \ensuremath{Hi} if i
 is the
 largest number input so far, \ensuremath{Lo} if it\mbox{'}s the smallest
 number input so
 far, \ensuremath{Both} if it\mbox{'}s both, and \ensuremath{None} if
 it\mbox{'}s neither.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The module is part of an example illustrating the use of a history
 variable. The example includes this module, module \ensuremath{MinMax2}, and
 module
 \ensuremath{MinMax2H} which adds a history variable to the specification of
 \ensuremath{MinMax2
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We define \ensuremath{setMax(S)} and \ensuremath{setMin(S)} to be largest and
 smallest value in a
 nonempty finite set \ensuremath{S} of integers.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} setMax ( S ) \.{\defeq}
 {\CHOOSE} t \.{\in} S \.{:} \A\, s \.{\in} S \.{:} t \.{\geq} s}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} setMin ( S )\@s{1.49}
 \.{\defeq} {\CHOOSE} t \.{\in} S \.{:} \A\, s \.{\in} S \.{:} t \.{\leq} s}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} {\CONSTANTS} Lo ,\, Hi ,\,
 Both ,\, None}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} {\ASSUME} \{ Lo ,\, Hi ,\,
 Both ,\, None \} \.{\cap} Int \.{=} \{ \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The the value of the variable \ensuremath{x} is the value input by the user
 or the
 value output by the system, the variable \ensuremath{turn} indicating which.
 The
 variable \ensuremath{y} holds the set of all values input thus far. We
 consider \ensuremath{x
 } and \ensuremath{turn} to be externally visible and \ensuremath{y} to be
 internal.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} {\VARIABLES} x ,\, turn ,\,
 y}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, turn ,\, y {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The initial predicate \ensuremath{Init}:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} Init \.{\defeq}\@s{4.1}
 \.{\land} x \.{=} None}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{39.80} \.{\land} turn
 \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{39.80} \.{\land} y \.{=}
 \{ \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The user\mbox{'}s input action:
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} InputNum \.{\defeq}\@s{4.1}
 \.{\land} turn \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{68.01} \.{\land} turn
 \.{'} \.{=}\@w{output}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{68.01} \.{\land} x \.{'}
 \.{\in} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{68.01} \.{\land} y
 \.{'}\@s{0.10} \.{=} y}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} Respond \.{\defeq} \.{\land}
 turn \.{=}\@w{output}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{55.83} \.{\land} turn
 \.{'} \.{=}\@w{input}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{55.83} \.{\land} y
 \.{'}\@s{0.10} \.{=} y \.{\cup} \{ x \}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{55.83} \.{\land} x \.{'}
 \.{=} {\IF} x \.{=} setMax ( y \.{'} ) \.{\THEN} {\IF} x \.{=} setMin ( y
 \.{'} ) \.{\THEN} Both \.{\ELSE} Hi}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{168.51} \.{\ELSE} {\IF} x
 \.{=} setMin ( y \.{'} ) \.{\THEN} Lo\@s{9.84} \.{\ELSE} None}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} Next \.{\defeq} InputNum
 \.{\lor} Respond}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} Spec \.{\defeq} Init
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} NoneCertificate \.{\defeq}
 {\Box} [ \.{\land} x \.{\in} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{97.76} \.{\land} x \.{<}
 setMax ( y \.{\cup} \{ x \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{97.76} \.{\land} x \.{>}
 setMin ( y\@s{1.49} \.{\cup} \{ x \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{94.98} \.{\equiv} x \.{'}
 \.{=} None ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Below, we check that specification \ensuremath{Spec} implements specification
 \ensuremath{Spec
 } of module \ensuremath{MinMax2} under a suitable refinement mapping. The
 following
 definitions of \ensuremath{Infinity} and \ensuremath{MinusInfinity} are
 copied from module
 \ensuremath{MinMax2}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} Infinity\@s{27.11}
 \.{\defeq} {\CHOOSE} n \.{:} n \.{\notin} Int}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}} MinusInfinity \.{\defeq}
 {\CHOOSE} n \.{:} n \.{\notin} ( Int \.{\cup} \{ Infinity \} )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} M \.{\defeq} {\INSTANCE}
 MinMax2}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{41.79} {\WITH}
 min\@s{1.49} \.{\leftarrow} {\IF} y \.{=} \{ \} \.{\THEN} Infinity\@s{27.11}
 \.{\ELSE} setMin ( y ) \.{+} 1 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{72.77} max \.{\leftarrow}
 {\IF} y \.{=} \{ \} \.{\THEN} MinusInfinity \.{\ELSE} setMax ( y )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following theorem asserts that \ensuremath{Spec} implements the
 specification
 Spec of module \ensuremath{MinMax2} under the refinement mapping defined by
 the
 \ensuremath{{\INSTANCE}} statement. The theorem can be checked with
 \ensuremath{TLC} using a model
 having \ensuremath{M{\bang}Spec} as the temporal property to be checked.
\end{cpar}%
\end{lcom}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 31 19:44:20 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Last} modified \ensuremath{Tue}
 \ensuremath{Jun} 26 17:29:03 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{Last} modified \ensuremath{Fri}
 \ensuremath{Oct} 21 23:48:10 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 26
 14:28:26 \ensuremath{PDT} 2016 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
