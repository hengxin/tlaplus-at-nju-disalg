...
This module specifies a tiny system in which a user presents a server
 ...
 input value \ensuremath{i} with with one of the following outputs:
 \ensuremath{Hi} if \ensuremath{i} is the
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 26 17:51:08 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
