...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 value \ensuremath{InitVal} of the registers. Readers and writers should be
 thought
...
\@x{ Apply ( i ,\, cmd ,\, obj ) \.{\defeq} {\IF} i \.{\in} Readers}%
 \@x{\@s{118.32} \.{\THEN} [ newState \.{\mapsto} obj ,\, output \.{\mapsto}
 obj ]}%
 \@x{\@s{118.32} \.{\ELSE} [ newState \.{\mapsto} [ obj {\EXCEPT} {\bang} [ i
 ] \.{=} cmd ] ,\,}%
\@x{\@s{152.41} output\@s{11.04} \.{\mapsto} NotRegVal ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
