...
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
 \@x{ Divides ( p ,\, n )\@s{3.88} \.{\defeq} \E\, q \.{\in} 1 \.{\dotdot} n
 \.{:} n \.{=} q \.{*} p}%
\@pvspace{8.0pt}%
 \@x{ DivisorsOf ( n ) \.{\defeq} \{ p \.{\in} 1 \.{\dotdot} n \.{:} Divides (
 p ,\, n ) \}}%
\@pvspace{8.0pt}%
 \@x{ SetMax ( S )\@s{5.12} \.{\defeq} {\CHOOSE} i \.{\in} S \.{:} \A\, j
 \.{\in} S \.{:} i \.{\geq} j}%
\@pvspace{8.0pt}%
 \@x{ GCD ( m ,\, n )\@s{0.58} \.{\defeq} SetMax ( DivisorsOf ( m ) \.{\cap}
 DivisorsOf ( n ) )}%
\@pvspace{8.0pt}%
