...
\setboolean{shading}{true}
 ...
 {\MODULE} Euclid}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers ,\, GCD
 ,\, TLC}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} N}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\ASSUME} \.{\land} N \.{\in}
 Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\p@mmfair} {\p@algorithm}
 Euclid {\p@lbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{8.2} {\p@variables} x
 \.{\in} 1 \.{\dotdot} N ,\, y \.{\in} 1 \.{\dotdot} N ,\, x0 \.{=} x ,\, y0
 \.{=} y {\p@semicolon}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{8.2} {\p@lbrace}
 abc\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} x \.{\neq} y {\p@rparen}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{17.78} {\p@lbrace}
 d\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} x \.{<} y {\p@rparen}
 {\p@lbrace} y \.{:=} y\@s{0.10} \.{-} x {\p@semicolon} {\p@rbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{39.78}
 {\p@else}\@s{24.59} {\p@lbrace} x\@s{9.09} \.{:=} x \.{-} y\@s{0.10}
 {\p@semicolon} {\p@rbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{17.78} {\p@rbrace}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{17.78}
 at\@s{.5}\textrm{:}\@s{3}\@s{10.05} {\p@assert} ( x \.{=} y ) \.{\land} ( x
 \.{=} GCD ( x0 ,\, y0 ) ) {\p@semicolon}}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{8.2} {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} {\VARIABLES} x ,\, y ,\, x0
 ,\, y0 ,\, pc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, y ,\, x0 ,\, y0 ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{37.72} \.{\land} x
 \.{\in} 1 \.{\dotdot} N}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{37.72} \.{\land}
 y\@s{0.10} \.{\in} 1 \.{\dotdot} N}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{37.72} \.{\land} x0 \.{=}
 x}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{37.72} \.{\land}
 y0\@s{0.10} \.{=} y}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{37.72} \.{\land}
 pc\@s{1.07} \.{=}\@w{abc}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} abc \.{\defeq} \.{\land} pc
 \.{=}\@w{abc}}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{33.25} \.{\land} {\IF} x
 \.{\neq} y}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{56.52} \.{\THEN}
 \.{\land} pc \.{'} \.{=}\@w{d}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{56.52} \.{\ELSE}
 \.{\land} pc \.{'} \.{=}\@w{at}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{33.25} \.{\land}
 {\UNCHANGED} {\langle} x ,\, y ,\, x0 ,\, y0 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} d \.{\defeq} \.{\land} pc
 \.{=}\@w{d}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{25.03} \.{\land} {\IF} x
 \.{<} y}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{48.29} \.{\THEN}
 \.{\land} y \.{'}\@s{0.10} \.{=} y \.{-} x}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{79.61} \.{\land} x \.{'}
 \.{=} x}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{48.29} \.{\ELSE}
 \.{\land} x \.{'} \.{=} x \.{-} y}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{79.61} \.{\land} y
 \.{'}\@s{0.10} \.{=} y}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{25.03} \.{\land} pc \.{'}
 \.{=}\@w{abc}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{25.03} \.{\land}
 {\UNCHANGED} {\langle} x0 ,\, y0 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} at \.{\defeq} \.{\land} pc
 \.{=}\@w{at}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{28.27} \.{\land} Assert (
 ( x \.{=} y ) \.{\land} ( x \.{=} GCD ( x0 ,\, y0 ) ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{71.96}\@w{Failure\ of\
 assertion\ at\ line\ 16,\ column\ 9.} )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{28.27} \.{\land} pc \.{'}
 \.{=}\@w{Done}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{28.27} \.{\land}
 {\UNCHANGED} {\langle} x ,\, y ,\, x0 ,\, y0 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}} Next \.{\defeq} abc \.{\lor}
 d \.{\lor} at}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
 Disjunct to prevent deadlock on termination
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{63.24} ( pc
 \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 \.{\land} Init \.{\land} {\Box} [ Next ]_{ vars}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{39.83} \.{\land} {\WF}_{
 vars} ( Next )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Termination \.{\defeq}
 {\Diamond} ( pc \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
