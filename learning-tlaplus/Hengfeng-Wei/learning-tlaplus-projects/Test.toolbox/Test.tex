...
\setboolean{shading}{true}
 ...
 {\MODULE} Test}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} One \.{\defeq} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Six\@s{4.10} \.{\defeq}
 \.{\LET} Two \.{\defeq} 2}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{37.52} \.{\IN} \.{\LET}
 Three \.{\defeq} 3}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{57.92} \.{\IN} One \.{+}
 Two \.{+} Three}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Feb} 06 00:35:08 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Sep} 03
 20:00:20 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
