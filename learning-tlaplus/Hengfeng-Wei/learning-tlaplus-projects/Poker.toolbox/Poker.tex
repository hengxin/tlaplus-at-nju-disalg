...
\setboolean{shading}{true}
 ...
 {\MODULE} Poker}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}} {\EXTENDS} Naturals ,\, TLC}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}}%
\@y{\@s{0}%
 \ensuremath{TODO}: redefine \mbox{'}\ensuremath{\.{>}\.{'}
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} NonType \.{\defeq} 0}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Single\@s{3.71} \.{\defeq} 1}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} Double \.{\defeq} 2}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} MaxFace ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} MaxDuplicate ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} NumberOfPlayers
 ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} InitCard\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{InitCard[p]}: Initial cards at the hand of player \ensuremath{p
 \.{\in} Player
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Face\@s{3.99} \.{\defeq} 1
 \.{\dotdot} MaxFace}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Hand \.{\defeq} {\UNION} \{
 [ f \.{\rightarrow} 0 \.{\dotdot} MaxDuplicate ] \.{:} f \.{\in} {\SUBSET}
 Face \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Player \.{\defeq} 1
 \.{\dotdot} NumberOfPlayers}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} NextPlayer ( p ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} {\IF} p \.{<}
 NumberOfPlayers}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\THEN} p \.{+}
 1}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\ELSE} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} Type \.{\defeq} \{ NonType
 ,\, Single ,\, Double \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}
 NumberOfPlayers \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} InitCard
 \.{\in} [ Player \.{\rightarrow} Hand ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{12.29} card ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{12.29} type ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{12.29} turn ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{12.29} max ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{12.29} skipno}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} vars \.{\defeq} {\langle}
 card ,\, type ,\, turn ,\, max ,\, skipno {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 card\@s{0.24} \.{\in} [ Player \.{\rightarrow} Hand ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 type\@s{1.16} \.{\in} Type}%
 ...
 skipno \.{\in} 0 \.{\dotdot} ( NumberOfPlayers \.{-} 1 )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{16.4} \.{\land}
 card\@s{0.24} \.{=} InitCard}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\land}
 type\@s{1.16} \.{=} NonType}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} turn
 \.{\in} Player}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} max \.{=}
 0}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} skipno
 \.{=} NumberOfPlayers \.{-} 1}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} IsDealer ( p ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\land} turn
 \.{=} p}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\land} skipno
 \.{=} NumberOfPlayers \.{-} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} IsNotDealer ( p )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} turn
 \.{=} p}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} skipno
 \.{\neq} NumberOfPlayers \.{-} 1}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} DealType ( p ,\, t )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \.{\land} IsDealer
 ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land} \E\,
 f\@s{9.52} \.{\in} ( {\DOMAIN} card [ p ] ) \.{:} card [ p ] [ f ] \.{\geq}
 t}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} \.{\land} max \.{'}
 \.{\in} \{ f \.{\in} ( {\DOMAIN} card [ p ] ) \.{:} card [ p ] [ f ]
 \.{\geq} t \}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{16.4} \.{\land} card
 \.{'}\@s{0.24} \.{=} [ card {\EXCEPT} {\bang} [ p ] [ max \.{'} ] \.{=} @
 \.{-} t ]}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land} type
 \.{'}\@s{1.16} \.{=} t}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land} turn
 \.{'} \.{=} NextPlayer ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} \.{\land} PrintT (
 turn \.{'} )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \.{\land} skipno
 \.{'} \.{=} 0}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} Deal ( p )
 \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 \ensuremath{TODO}: Is this correct when used in \ensuremath{Next}\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{20.33} \.{\lor} DealType
 ( p ,\, Single )}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{20.33} \.{\lor} DealType
 ( p ,\, Double )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} CallType ( p ,\, t )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{16.4} \.{\land}
 IsNotDealer ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \.{\land} \E\, f
 \.{\in} ( {\DOMAIN} card [ p ] ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{31.61} \.{\land} card [ p
 ] [ f ] \.{\geq} t}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{31.61} \.{\land} f \.{>}
 max}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{16.4} \.{\land} max \.{'}
 \.{\in} \{ f \.{\in} ( {\DOMAIN} card [ p ] ) \.{:} card [ p ] [ f ]
 \.{\geq} t \.{\land} f \.{>} max \}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land} card
 \.{'}\@s{0.24} \.{=} [ card {\EXCEPT} {\bang} [ p ] [ max \.{'} ] \.{=} @
 \.{-} t ]}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land} turn
 \.{'} \.{=} NextPlayer ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} type ,\, skipno {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} Call ( p )\@s{1.97}
 \.{\defeq} CallType ( p ,\, type )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}} Pass ( p ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{20.89} \.{\land}
 IsNotDealer ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{20.89} \.{\land} turn
 \.{'} \.{=} NextPlayer ( p )}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{20.89} \.{\land} skipno
 \.{'} \.{=} skipno \.{+} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{20.89} \.{\land}
 {\UNCHANGED} {\langle} card ,\, type ,\, max {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}} Next \.{\defeq} \E\, p
 \.{\in} Player \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{51.15} \.{\lor} DealType
 ( p ,\, Single )}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{51.15} \.{\lor} DealType
 ( p ,\, Double )}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{51.15} \.{\lor} Call ( p
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{51.15} \.{\lor} Pass ( p
 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars} \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} Win \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{19.44} \E\, p \.{\in}
 Player \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{30.76} \.{\land} \A\,
 f\@s{0.29} \.{\in} ( {\DOMAIN} card [ p ] ) \.{:} card [ p ] [ f ] \.{=} 0}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{30.76} \.{\land} \A\, q
 \.{\in} Player \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{45.97} q \.{\neq} p
 \.{\implies} \E\, f \.{\in} ( {\DOMAIN} card [ q ] ) \.{:} card [ q ] [ f ]
 \.{>} 0}%
\@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Aug} 19
 15:45:07 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Aug} 18 14:38:31
